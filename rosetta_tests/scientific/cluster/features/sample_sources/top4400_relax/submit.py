...
class SampleSource:
    ...
    def setup_input_data(self):
        ...
        try:
            ...
            p = subprocess.Popen(["find", getcwd() + "/input/top4400pdbs", "-name", "*pdb"],
...
def main(argv):
    ...
    parser.add_option("--sample_source_id",
      default="top4400_relax_r%(svn_revision)s_%(date_code)s",
    ...
    parser.add_option("--sample_source_description",
      default="Top 4400 chains in PDB from the Richardson Lab",
