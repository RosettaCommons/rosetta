...
def main(argv):
    ...
    parser.add_option("--sample_source_id",
      default="abrelax_correct_r%(svn_revision)s_%(date_code)s",
    ...
    parser.add_option("--sample_source_description",
      default="Rosetta predictions using the ab initio relax protocol with the -correct flag and score12_w_corrections weight set.",
