...
id = "chi_BAH_eq_polar_density_HXLtoCXL2",
filename = "scripts/analysis/plots/hbonds/chi_BAH_eq_polar_density_HXLtoCXL2.R",
...
d_ply(f, .(sample_source), function(sub_f){
	...
	ss <- sample_sources[sample_sources$sample_source == ss,]
