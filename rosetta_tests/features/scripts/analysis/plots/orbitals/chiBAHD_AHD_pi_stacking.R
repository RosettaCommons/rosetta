...
plot_id = "chiBAHD_cosAHD_eqpoldens_pi_stacking_cpisp2_all_2.0A"
...
plot_id = "chiBAHD_cosAHD_eqpoldens_pi_stacking_cpisp2_all_3.5A"
...
plot_id = "chiBAHD_cosAHD_eqpoldens_pi_stacking_cpisp2_phe_phe_2.0A"
...
plot_id = "chiBAHD_cosAHD_eqpoldens_pi_stacking_cpisp2_phe_phe_3.5A"
