...
filename = "chiBDHO_cosDHO_eqpoldens_pi_stacking_cpisp2.R",
...
plot_id = "chiBDHO_cosDHO_eqpoldens_pi_stacking_cpisp2_all_2.0A"
...
plot_id = "chiBDHO_cosDHO_eqpoldens_pi_stacking_cpisp2_phe_phe_2.0A"
