...
ggplot(data=all_geom) +
 #geom_bar(aes(x=(acos(AOH_angle))*180/pi, fill=sample_source), binwidth=5, position="dodge") +
...
ggplot(data=all_geom) +
  geom_bar(aes(x=AOH_angle, fill=sample_source), binwidth=.1, position="dodge") +
