...
filename = "scripts/analysis/plots/rotamer_recovery/rotamer_recovery_salt_bridge.R",
author = "Matthew O'Meara",
brief_description = "",
feature_reporter_dependencies = c("RotamerRecoveryFeatures", "SaltBridgeFeatures"),
run=function(self){
