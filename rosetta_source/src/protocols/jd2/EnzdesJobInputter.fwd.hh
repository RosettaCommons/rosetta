...
/// @file   protocols/jd2/EnzdesJobInputter.fwd.hh
/// @brief
/// @author Sagar Khare (khares@uw.edu)

#ifndef INCLUDED_protocols_jd2_EnzdesJobInputter_fwd_hh
#define INCLUDED_protocols_jd2_EnzdesJobInputter_fwd_hh
