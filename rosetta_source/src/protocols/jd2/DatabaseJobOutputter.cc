...
/// @file   protocols/jd2/DatabaseJobOutputter.cc
...
bool DatabaseJobOutputter::job_has_completed( JobCOP job ) {
	using namespace basic::options;
	using namespace basic::options::OptionKeys;
...
std::string DatabaseJobOutputter::output_name( JobCOP job ) {
