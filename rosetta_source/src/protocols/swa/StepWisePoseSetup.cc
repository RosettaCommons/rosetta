...
namespace swa {
  ...
  //////////////////////////////////////////////////////////////////////////
  //constructor!
	StepWisePoseSetup::StepWisePoseSetup( std::string const & desired_sequence, utility::vector1< std::string > const & start_tags,
  ...
  //////////////////////////////////////////////////////////////////////////
	void
  StepWisePoseSetup::apply( Pose & pose )
	{
		...
		//			return;
		//		}
		core::pose::make_pose_from_sequence( pose, desired_sequence_, *rsd_set_, false /*auto_termini*/);
		...
		for ( Size i = 1; i <= start_tags_.size(); i++ ) {
			...
			if ( silent_files_in_.size() > 0 ) {
				...
				// Read in from PDB
				core::import_pose::pose_from_pdb( start_pose, *rsd_set_, start_tag );
			}
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	StepWisePoseSetup::add_end_variants( core::pose::Pose & pose ){

		if ( n_terminus_ ) {
			core::pose::add_variant_type_to_pose_residue( pose, "LOWER_TERMINUS", 1  );
		} else {
			if (add_peptide_plane_) core::pose::add_variant_type_to_pose_residue( pose, "N_ACETYLATION", 1  );
		}

		if ( c_terminus_ ) {
			core::pose::add_variant_type_to_pose_residue( pose, "UPPER_TERMINUS", pose.total_residue()  );
		} else {
			if (add_peptide_plane_) core::pose::add_variant_type_to_pose_residue( pose, "C_METHYLAMIDATION", pose.total_residue()  );
		}
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	void
	StepWisePoseSetup::match_specific_variants( pose::Pose const & pose, Size const & pose_res,
																							...
																							utility::vector1< chemical::VariantType > const & variant_types ) const
	{
		...
		for ( Size n = 1; n <= variant_types_to_remove.size(); n++ )  {
			core::pose::remove_variant_type_from_pose_residue( scratch_pose, variant_types_to_remove[n], scratch_pose_res   );
		...
		for ( Size n = 1; n <= variant_types_to_add.size(); n++ )  {
			core::pose::add_variant_type_to_pose_residue( scratch_pose, variant_types_to_add[n], scratch_pose_res  );
		}
	...
	///////////////////////////////////////////////////////////////////////////////////////////
	void
	StepWisePoseSetup::match_end_variants( pose::Pose const & pose, pose::Pose & scratch_pose, Size const & start_res, Size const & end_res ) const
	{
		using namespace core::chemical;
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	Size
	StepWisePoseSetup::figure_out_nested_positions(
   std::string const & inside_sequence,
	...
	StepWisePoseSetup::moving_residues() const
	{
...
// 	//////////////////////////////////////////////////////////////////////////////
// 	void
// 	StepWisePoseSetup::prepend_residues( pose::Pose & pose ) {
...
// 	//////////////////////////////////////////////////////////////////////////////
// 	void
// 	StepWisePoseSetup::append_residues( pose::Pose & pose, pose::Pose const & start_pose ) {
...
// 		core::pose::remove_upper_terminus_type_from_pose_residue( pose, pose.total_residue()   );
...
// 			moving_residues_.push_back( i );
// 		}
// 		//		core::pose::add_variant_type_to_pose_residue( pose, "VIRTUAL_CTERM_O", pose.total_residue() );
// 		pose.set_psi( end_res_, start_pose.psi( start_pose.total_residue() ) );
// 	}

// 	//////////////////////////////////////////////////////////////////////////////
// 	void
// 	StepWisePoseSetup::initialize_from_scratch( pose::Pose & pose )
// 	{
// 		core::pose::make_pose_from_sequence( pose, desired_sequence_, *rsd_set_, false /*auto_termini*/);
...
/////////////////////////////////////////////////////////////////
	...
	void
	StepWisePoseSetup::set_add_peptide_plane( bool const & setting ) {
