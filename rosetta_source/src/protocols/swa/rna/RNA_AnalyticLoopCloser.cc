...
RNA_AnalyticLoopCloser::close_at_cutpoint( core::pose::Pose & pose ){
	...
	if ( verbose_ ) TR << "Kinematic loop closure found this many solutions: " << nsol_ << std::endl;
...
RNA_AnalyticLoopCloser::figure_out_dof_ids_and_offsets( pose::Pose const & pose,
	...
	// pivot 1
	/////////////////////////////////////////
	id1 = named_atom_id_to_atom_id( NamedAtomID( " P  ", moving_suite_+1 ), pose );
	id2 = named_atom_id_to_atom_id( NamedAtomID( " O5*", moving_suite_+1 ), pose );
	id3 = named_atom_id_to_atom_id( NamedAtomID( " C5*", moving_suite_+1 ), pose );
	id4 = named_atom_id_to_atom_id( NamedAtomID( " C4*", moving_suite_+1 ), pose );
	dof_id = pose.atom_tree().torsion_angle_dof_id( id1, id2, id3, id4 );
	figure_out_offset( pose, dof_id, dt_ang[ 3 * 1 + 1 ], offset_save_ );

	id1 = named_atom_id_to_atom_id( NamedAtomID( " O5*", moving_suite_+1 ), pose );
	id2 = named_atom_id_to_atom_id( NamedAtomID( " C5*", moving_suite_+1 ), pose );
	id3 = named_atom_id_to_atom_id( NamedAtomID( " C4*", moving_suite_+1 ), pose );
	id4 = named_atom_id_to_atom_id( NamedAtomID( " C3*", moving_suite_+1 ), pose );
	dof_id = pose.atom_tree().torsion_angle_dof_id( id1, id2, id3, id4 );
	...
	// pivot 2
	/////////////////////////////////////////
	id1 = named_atom_id_to_atom_id( NamedAtomID( " C4*", chainbreak_suite_ ), pose );
	id2 = named_atom_id_to_atom_id( NamedAtomID( " C3*", chainbreak_suite_ ), pose );
	id3 = named_atom_id_to_atom_id( NamedAtomID( " O3*", chainbreak_suite_ ), pose );
	id4 = named_atom_id_to_atom_id( NamedAtomID( "OVL1", chainbreak_suite_ ), pose );
	dof_id = pose.atom_tree().torsion_angle_dof_id( id1, id2, id3, id4 );
	figure_out_offset( pose, dof_id, dt_ang[ 3 * 2 + 1 ], offset_save_ );

	id1 = named_atom_id_to_atom_id( NamedAtomID( " C3*", chainbreak_suite_ ), pose );
	id2 = named_atom_id_to_atom_id( NamedAtomID( " O3*", chainbreak_suite_ ), pose );
	id3 = named_atom_id_to_atom_id( NamedAtomID( "OVL1", chainbreak_suite_ ), pose );
	id4 = named_atom_id_to_atom_id( NamedAtomID( "OVL2", chainbreak_suite_ ), pose );
	dof_id = pose.atom_tree().torsion_angle_dof_id( id1, id2, id3, id4 );
	...
	// pivot 3
	/////////////////////////////////////////
	id1 = named_atom_id_to_atom_id( NamedAtomID( " P  ", chainbreak_suite_+1 ), pose );
	id2 = named_atom_id_to_atom_id( NamedAtomID( " O5*", chainbreak_suite_+1 ), pose );
	id3 = named_atom_id_to_atom_id( NamedAtomID( " C5*", chainbreak_suite_+1 ), pose );
	id4 = named_atom_id_to_atom_id( NamedAtomID( " C4*", chainbreak_suite_+1 ), pose );
	dof_id = pose.atom_tree().torsion_angle_dof_id( id1, id2, id3, id4 );
	figure_out_offset( pose, dof_id, dt_ang[ 3 * 3 + 1 ], offset_save_ );

	id1 = named_atom_id_to_atom_id( NamedAtomID( " O5*", chainbreak_suite_+1 ), pose );
	id2 = named_atom_id_to_atom_id( NamedAtomID( " C5*", chainbreak_suite_+1 ), pose );
	id3 = named_atom_id_to_atom_id( NamedAtomID( " C4*", chainbreak_suite_+1 ), pose );
	id4 = named_atom_id_to_atom_id( NamedAtomID( " C3*", chainbreak_suite_+1 ), pose );
	dof_id = pose.atom_tree().torsion_angle_dof_id( id1, id2, id3, id4 );
...
/////////////////////
std::string
RNA_AnalyticLoopCloser::get_name() const {
