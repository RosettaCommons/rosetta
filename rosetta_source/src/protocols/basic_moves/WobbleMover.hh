...
#ifndef protocols_basic_moves_WobbleMover_HH
#define protocols_basic_moves_WobbleMover_HH
...
class WobbleMover;
typedef utility::pointer::owning_ptr< WobbleMover > WobbleMoverOP;
...
class WobbleMover : public protocols::basic_moves::SmoothFragmentMover {
public:
	typedef protocols::basic_moves::SmoothFragmentMover Parent;
