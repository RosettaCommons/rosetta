...
/// @file protocols/loops/LoopRelaxThreadingMover.fwd.hh
/// @brief forward declaration for LoopRelaxThreadingMover class
/// @author James Thompson

#ifndef INCLUDED_protocols_loops_LoopRelaxThreadingMover_fwd_hh
#define INCLUDED_protocols_loops_LoopRelaxThreadingMover_fwd_hh
