...
/// @file protocols/loops/loop_closure/loophash/LoopHashLoopClosureMover.hh
...
#include <protocols/loops/loop_closure/loophash/LoopHashLoopClosureMover.fwd.hh>
...
class LoopHashLoopClosureMover : public moves::Mover {
public:
