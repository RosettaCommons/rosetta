...
// project headers
#include <protocols/loops/loop_closure/loophash/LoopHashLoopClosureMover.hh>
#include <protocols/loops/loop_closure/loophash/LoopHashLoopClosureMoverCreator.hh>
...
static basic::Tracer TR ("protocols.loops.loop_closure.loophash.LoopHashLoopClosureMover" );
