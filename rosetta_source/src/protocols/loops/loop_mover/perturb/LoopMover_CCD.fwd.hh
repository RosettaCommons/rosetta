...
typedef utility::pointer::owning_ptr< LoopMover_Perturb_CCD > LoopMover_Perturb_CCDOP;
typedef utility::pointer::owning_ptr< LoopMover_Perturb_CCD const > LoopMover_Perturb_CCDCOP;
