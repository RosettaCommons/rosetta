...
#ifndef INCLUDED_protocols_loops_LoopMover_SlidingWindow_hh
#define INCLUDED_protocols_loops_LoopMover_SlidingWindow_hh
...
class LoopMover_SlidingWindow: public IndependentLoopMover {
