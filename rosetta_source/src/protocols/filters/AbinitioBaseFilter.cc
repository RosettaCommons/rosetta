...
// AUTO-REMOVED #include <protocols/filters/RGFilter.hh>
// AUTO-REMOVED #include <protocols/filters/COFilter.hh>
// AUTO-REMOVED #include <protocols/filters/SheetFilter.hh>
...
static basic::Tracer tr("protocols.filters.AbinitioBaseFilter");
