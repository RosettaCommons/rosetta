...
/// @file   /protocols/PDDFScoreFilters/PDDFScoreFilters.fwd.hh
/// @brief  forward declaration for PDDFScoreFilter
/// @author dgront@chem.uw.edu.pl


#ifndef INCLUDED_protocols_filters_PDDFScoreFilter_fwd_hh
#define INCLUDED_protocols_filters_PDDFScoreFilter_fwd_hh
