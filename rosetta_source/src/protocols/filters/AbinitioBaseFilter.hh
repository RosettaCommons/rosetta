...
/// @file src/protocols/filters/AbinitioBaseFilter.hh
...
#ifndef INCLUDED_protocols_filters_AbinitioBaseFilter_hh
#define INCLUDED_protocols_filters_AbinitioBaseFilter_hh
...
class AbinitioBaseFilter : public Filter {
public:
