...
/// @file   src/protocols/filters/PackStatFilter.fwd.hh
/// @brief
/// @author Nobuyasu Koga (nobuyasu@uw.edu)


#ifndef INCLUDED_protocols_filters_PackStatFilter_fwd_hh
#define INCLUDED_protocols_filters_PackStatFilter_fwd_hh
