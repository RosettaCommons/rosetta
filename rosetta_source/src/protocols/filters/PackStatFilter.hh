...
/// @file ./src/protocols/filters/PackStatFilter.hh
/// @brief header file for PackStatFilter class.
/// @detailed
/// @author Nobuyasu Koga ( nobuyasu@uw.edu )


#ifndef INCLUDED_protocols_filters_PackStatFilter_hh
#define INCLUDED_protocols_filters_PackStatFilter_hh

// Unit Headers
#include <protocols/filters/PackStatFilter.fwd.hh>
