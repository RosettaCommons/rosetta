...
/// @file protocols/filters/AtomicDistanceFilter.hh
/// @brief Filter for looking at specific atom distances
/// @author Rocco Moretti (rmoretti@uw.edu)

#ifndef INCLUDED_protocols_filters_AtomicDistanceFilter_hh
#define INCLUDED_protocols_filters_AtomicDistanceFilter_hh
...
class AtomicDistanceFilter : public Filter
{
private:
