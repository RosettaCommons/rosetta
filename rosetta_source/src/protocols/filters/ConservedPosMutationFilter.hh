...
/// @file src/protocols/filters/ConservedPosMutationFilter.hh
/// @brief header file for ConservedPosMutationFitler class.
/// @detailed
/// @author Florian Richter (floric@u.washington.edu), may 2011


#ifndef INCLUDED_protocols_filters_ConservedPosMutationFilter_hh
#define INCLUDED_protocols_filters_ConservedPosMutationFilter_hh

// Unit Headers
#include <protocols/filters/ConservedPosMutationFilter.fwd.hh>
...
class ConservedPosMutationFilter : public Filter {
