...
/// @file ./src/protocols/filters/HolesFilter.hh
/// @brief header file for HolesFilter class.
/// @detailed
/// @author Nobuyasu Koga ( nobuyasu@uw.edu )


#ifndef INCLUDED_protocols_filters_HolesFilter_hh
#define INCLUDED_protocols_filters_HolesFilter_hh

// Unit Headers
#include <protocols/filters/HolesFilter.fwd.hh>
...
public:// virtual constructor
	...
	// @brief make clone
	virtual FilterOP clone() const { return new HolesFilter( *this ); }

	// @brief make fresh instance
	virtual FilterOP fresh_instance() const {	return new HolesFilter(); }
