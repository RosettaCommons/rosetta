...
#ifndef INCLUDED_protocols_toolbox_task_operations_RestrictToTerminiOperationCreator_hh
#define INCLUDED_protocols_toolbox_task_operations_RestrictToTerminiOperationCreator_hh
...
public:
	...
	virtual std::string keyname() const { return "RestrictToTermini"; }
};
