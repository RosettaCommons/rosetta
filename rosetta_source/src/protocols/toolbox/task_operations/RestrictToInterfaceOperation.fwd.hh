...
typedef utility::pointer::owning_ptr< RestrictToInterfaceOperation > RestrictToInterfaceOperationOP;
typedef utility::pointer::owning_ptr< RestrictToInterfaceOperation const > RestrictToInterfaceOperationCOP;
