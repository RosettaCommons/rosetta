...
void InterfaceTaskOperation::add_movable_jumps( core::Size const additional_jump ) {

	movable_jumps_.push_back( additional_jump );
}

void InterfaceTaskOperation::set_movable_jumps( utility::vector1_size const movable_jumps ) {
    movable_jumps_ = movable_jumps;
}

utility::vector1_size InterfaceTaskOperation::movable_jumps() const{
