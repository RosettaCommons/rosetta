...
#ifndef INCLUDED_protocols_toolbox_pose_metric_calculators_InterfaceDefinitionCalculatorBase_hh
#define INCLUDED_protocols_toolbox_pose_metric_calculators_InterfaceDefinitionCalculatorBase_hh
