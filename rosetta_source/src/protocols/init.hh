...
/// @file   src/protocols/init.hh
/// @brief  Initialization function to ensure all load-time factory registration occurs
///         for classes that live in the protocols library.  protocols::init() calls
///         devel::init().
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com)

#ifndef INCLUDED_protocols_init_hh
#define INCLUDED_protocols_init_hh
