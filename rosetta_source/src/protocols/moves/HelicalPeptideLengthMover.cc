...
using basic::Error;
using basic::Warning;
static basic::Tracer TR( "protocols.moves.HelicalPeptideLengthMover" );
...
{
	Mover::type( "HelicalPeptideLengthMover" );
}
