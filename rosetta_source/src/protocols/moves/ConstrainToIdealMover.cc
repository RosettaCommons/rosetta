...
/// @file protocols/moves/ConstrainToIdealMover.cc
...
//#include <protocols/moves/ConstrainToIdealMoverCreator.hh>
...
#include <protocols/rna/AllowInsert.hh> //need to move AllowInsert to toolbox XRW2
...
void ConstrainToIdealMover::set_AllowInsert(protocols::rna::AllowInsertOP allow_insert) {allow_insert_ = allow_insert;}

///@brief getter for AllowInsert
protocols::rna::AllowInsertOP ConstrainToIdealMover::get_AllowInsert() const {return allow_insert_;}
