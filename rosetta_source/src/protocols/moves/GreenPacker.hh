...
/// @file   protocols/moves/GreenPacker.hh
/// @brief  packing mover that makes extensive reuse of rotamer pair energies class declaration
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com)

#ifndef INCLUDED_protocols_moves_GreenPacker_hh
#define INCLUDED_protocols_moves_GreenPacker_hh
...
public:
	...
	virtual
	GroupDiscriminatorOP clone() const = 0;
...
public:
	...
	virtual
	GroupDiscriminatorOP clone() const;
...
class GreenPacker : public Mover
{
public:
	/// Types
...
public:
	...
	void
	set_group_discriminator( GroupDiscriminatorOP );
...
private:
	...
	GroupDiscriminatorOP group_discriminator_;
	utility::vector1< Size > group_ids_;
	...
	utility::vector1< utility::vector1< MinimalRotamerOP > > original_rotamers_;
	...
	/// @brief the internal geometry of the rotamers created in the first round
	utility::vector1< utility::vector1< MinimalRotamerOP > > current_rotamers_;
...
#endif // INCLUDED_protocols_moves_GreenPacker_HH
