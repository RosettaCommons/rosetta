...
/// @file protocols/moves/FavorSequenceProfile.hh
/// @brief Add a SequenceProfileConstraint to a pose.
/// @author Rocco Moretti (rmoretti@u.washington.edu)

#ifndef INCLUDED_protocols_moves_FavorSequenceProfile_hh
#define INCLUDED_protocols_moves_FavorSequenceProfile_hh
...
public:
	...
	protocols::moves::MoverOP clone() const { return( new FavorSequenceProfile( *this ) ); }
...
#endif /*INCLUDED_protocols_moves_FavorSequenceProfile_hh*/
