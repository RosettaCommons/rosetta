...
#ifndef PROTOCOLS_MOVES_HELIX_ROTATE_HH_
#define PROTOCOLS_MOVES_HELIX_ROTATE_HH_

// Unit header
#include <protocols/moves/HelixRotate.fwd.hh>
...
class HelixRotate : public Mover {
 public:
  HelixRotate();
...
#endif  // PROTOCOLS_MOVES_HELIX_ROTATE_HH_
