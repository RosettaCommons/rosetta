...
/// @file protocols/moves/PeptideStapleMover.hh
/// @brief Definition of classes for placing peptide staples in the pose.
/// @author Jacob Corn

#ifndef INCLUDED_protocols_moves_PeptideStapleMover_hh
#define INCLUDED_protocols_moves_PeptideStapleMover_hh
...
namespace protocols {
namespace moves {
class PeptideStapleMover : public Mover {
public:
	...
	virtual protocols::moves::MoverOP clone() const {
		return( new PeptideStapleMover( seqpos_, staple_gap_ ) );
	}
