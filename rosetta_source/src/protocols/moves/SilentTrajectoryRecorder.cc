...
/// @file   protocols/moves/SilentTrajectoryRecorder.cc
///
/// @brief
/// @author Oliver Lange
...
bool protocols::moves::SilentTrajectoryRecorder::options_registered_( false );

void protocols::moves::SilentTrajectoryRecorder::register_options() {
