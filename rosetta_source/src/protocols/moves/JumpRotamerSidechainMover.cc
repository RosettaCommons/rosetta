...
#include <protocols/moves/JumpRotamerSidechainMoverCreator.hh>
...
static basic::Tracer TR("protocols.moves.JumpRotamerSidechainMover");
...
JumpRotamerSidechainMover::clone() const {
	return new JumpRotamerSidechainMover(*this);
}
