...
#ifndef INCLUDED_protocols_moves_SetTorsion_hh
#define INCLUDED_protocols_moves_SetTorsion_hh

#include <protocols/moves/SetTorsion.fwd.hh>
...
public:
	...
	virtual protocols::moves::MoverOP clone() const {
		return (protocols::moves::MoverOP( new SetTorsion( *this ) ) );
	}
...
#endif //INCLUDED_protocols_moves_SetTorsion_HH_
