...
/// @file   protocols/moves/RotateJumpAxisMover.fwd.hh
/// @brief  RotateJumpAxisMover forward declarations header
/// @author Steven Lewis (smlewi@unc.edu)

#ifndef INCLUDED_protocols_moves_RotateJumpAxisMover_fwd_hh
#define INCLUDED_protocols_moves_RotateJumpAxisMover_fwd_hh
...
#endif //INCLUDED_protocols_moves_RotateJumpAxisMover_FWD_HH
