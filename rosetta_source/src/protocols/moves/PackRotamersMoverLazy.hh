...
#ifndef INCLUDED_protocols_moves_PackRotamersMoverLazy_hh
#define INCLUDED_protocols_moves_PackRotamersMoverLazy_hh

// Unit headers
#include <protocols/moves/PackRotamersMoverLazy.fwd.hh>
...
class PackRotamersMoverLazy: public PackRotamersMover{
