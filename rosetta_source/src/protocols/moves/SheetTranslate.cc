...
static basic::Tracer TR("protocols.moves.SheetTranslate");
...
MoverOP SheetTranslate::fresh_instance() const {
  return new SheetTranslate();
}

MoverOP SheetTranslate::clone() const {
  return new SheetTranslate(*this);
}
