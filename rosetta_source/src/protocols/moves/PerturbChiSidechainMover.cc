...
#include <protocols/moves/PerturbChiSidechainMoverCreator.hh>
...
static basic::Tracer TR("protocols.moves.PerturbChiSidechainMover");
...
PerturbChiSidechainMover::clone() const {
	return new PerturbChiSidechainMover(*this);
}
