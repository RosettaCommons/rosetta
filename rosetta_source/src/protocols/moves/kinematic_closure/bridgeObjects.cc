...
#include <protocols/moves/kinematic_closure/dixon.hh>
...
using core::Real;
static basic::Tracer TR( "protocols.moves.kinematic_closure.bridgeObjects" );
...
void test_chainParams() {
	...
	//TR.Debug << "vbond: " << vbond << std::endl;
	//TR.Debug << "xi: " << xi << std::endl;
	//TR.Debug << "eta: " << eta << std::endl;
	//TR.Debug << "delta: " << delta << std::endl;
 	//TR.Debug << "R0: " << std::endl;
 	printVector(R0);
 	//TR.Debug << "Q: " << std::endl;
 	printMatrix(Q);
	// output should be:
...
int main(int argc, char** argv)
{
	...
	//test_chainParams();
	//test_chainXYZ();
	//protocols::moves::kinematic_closure::test_chainXYZv2();
	//test_chainTORS();
	//test_rotateX();
	//test_bridgeObjects();
	protocols::moves::kinematic_closure::test_bridgeObjects_v2();
}
*/
