...
{
	//protocols::moves::kinematic_closure::test_det_3();
	//protocols::moves::kinematic_closure::test_crossp();
	//protocols::moves::kinematic_closure::test_normalize();
	protocols::moves::kinematic_closure::test_kic_jac();
