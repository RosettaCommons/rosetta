...
/// @file protocols/moves/TemperingBaseMover.cc
...
static basic::Tracer tr( "protocols.moves.TemperingBase" );


bool protocols::moves::TemperingBase::options_registered_( false );

//Mike: when you want to remove these Macros... leave them at least here as comment - since they provide documentation
void protocols::moves::TemperingBase::register_options() {
