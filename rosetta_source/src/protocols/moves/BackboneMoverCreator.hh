...
///@file protocols/moves/BackboneMoverCreator.hh
///@brief This class will create instances of Movers SmallMover and ShearMover for the MoverFactory
///@author Andrew Leaver-Fay via code_writer.py (aleaverfay@gmail.com)
///@author Rocco Moretti (rmoretti@u.washington.edu)

#ifndef INCLUDED_protocols_moves_BackboneMoverCreator_hh
#define INCLUDED_protocols_moves_BackboneMoverCreator_hh
