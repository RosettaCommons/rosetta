...
#ifndef INCLUDED_protocols_moves_mc_convergence_checks_HierarchicalLevel_fwd_hh
#define INCLUDED_protocols_moves_mc_convergence_checks_HierarchicalLevel_fwd_hh
