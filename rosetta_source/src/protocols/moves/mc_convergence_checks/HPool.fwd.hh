...
/// @file	protocols/moves/mc_convergence_checks/HPool.fwd.hh
/// @brief	hierarchical pool
/// @author Yuan Liu (wendao@u.washington.edu)

#ifndef INCLUDED_protocols_moves_mc_convergence_checks_HPool_fwd_hh
#define INCLUDED_protocols_moves_mc_convergence_checks_HPool_fwd_hh
