...
namespace mc_convergence_checks{
...
#ifdef USEMPI
  MPI_Comm   protocols::moves::mc_convergence_checks::MPIHPool_RMSD::MPI_COMM_POOL;
  ...
  MPIHPool_RMSD::initialize(){
    ...
    core::scoring::ScoreFunctionOP sfxn = core::scoring::ScoreFunctionFactory::create_score_function( option[ score::weights ]() );
