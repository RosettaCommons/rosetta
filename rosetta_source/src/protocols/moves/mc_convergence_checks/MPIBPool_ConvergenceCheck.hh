...
#ifndef INCLUDED_protocols_moves_mc_convergence_checks_MPIBPool_ConvergenceCheck_hh
#define INCLUDED_protocols_moves_mc_convergence_checks_MPIBPool_ConvergenceCheck_hh
