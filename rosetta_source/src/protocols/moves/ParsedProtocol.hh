...
/// @file devel/protein_interface_design/ParsedProtocol.hh
/// @author Sarel Fleishman (sarelf@u.washington.edu)

#ifndef INCLUDED_protocols_moves_ParsedProtocol_hh
#define INCLUDED_protocols_moves_ParsedProtocol_hh
...
/// guaranteed to have no state accumulation.
	...
	protocols::moves::MoverOP clone() const { return protocols::moves::MoverOP( new ParsedProtocol( *this ) ); }
...
#endif /*INCLUDED_protocols_ProteinInterfaceDesign_ParsedProtocol_HH*/
