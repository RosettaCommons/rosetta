...
/// @file ./protocols/moves/MakePolyXMover.hh
/// @brief  header file of MakePolyXMover.cc
/// @author Nobuyasu Koga ( nobuyasau@uw.edu )

#ifndef INCLUDED_protocols_moves_MakePolyXMover_hh
#define INCLUDED_protocols_moves_MakePolyXMover_hh

// Project headers
#include <core/pose/Pose.fwd.hh>
#include <protocols/moves/Mover.hh>
#include <protocols/moves/MakePolyXMover.fwd.hh>
...
class MakePolyXMover : public Mover {
public:
