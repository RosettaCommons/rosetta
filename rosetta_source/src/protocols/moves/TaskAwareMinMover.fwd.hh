...
/// @file   protocols/moves/TaskAwareMinMover.fwd.hh
/// @brief  TaskAwareMinMover forward declarations header
/// @author Steven Lewis (smlewi@unc.edu)


#ifndef INCLUDED_protocols_moves_TaskAwareMinMover_fwd_hh
#define INCLUDED_protocols_moves_TaskAwareMinMover_fwd_hh
...
#endif //INCLUDED_protocols_moves_TaskAwareMinMover_FWD_HH
