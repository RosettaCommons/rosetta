...
#ifndef INCLUDED_protocols_moves_asym_fold_and_dock_AsymFoldandDockMoveRbJumpMover_fwd_hh

#define INCLUDED_protocols_moves_asym_fold_and_dock_AsymFoldandDockMoveRbJumpMover_fwd_hh
