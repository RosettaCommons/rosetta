...
/// @file protocols/moves/HelicalPeptideLengthMover.hh
...
#ifndef INCLUDED_protocols_moves_HelicalPeptideLengthMover_hh
#define INCLUDED_protocols_moves_HelicalPeptideLengthMover_hh

// Unit Headers
#include <protocols/moves/HelicalPeptideLengthMover.fwd.hh>
...
class HelicalPeptideLengthMover : public Mover {
public:
	...
	virtual protocols::moves::MoverOP clone() const {
		return( new HelicalPeptideLengthMover( seqpos_, resname_, addition_type_ ) );
	}
