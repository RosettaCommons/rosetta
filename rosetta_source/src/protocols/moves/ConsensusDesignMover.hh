...
/// @file src/protocols/moves/ConsensusDesignMover.hh
/// @brief header file for ConsensusDesignMover
/// @author Florian Richter (floric@u.washington.edu), april 2011

#ifndef INCLUDED_protocols_moves_ConsensusDesignMover_hh
#define INCLUDED_protocols_moves_ConsensusDesignMover_hh

// Unit header
#include <protocols/moves/ConsensusDesignMover.fwd.hh>
...
class ConsensusDesignMover : public Mover {
