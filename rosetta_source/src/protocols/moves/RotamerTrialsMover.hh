...
#ifndef INCLUDED_protocols_moves_RotamerTrialsMover_hh
#define INCLUDED_protocols_moves_RotamerTrialsMover_hh
...
class RotamerTrialsMover : public Mover {
public:
...
class EnergyCutRotamerTrialsMover : public RotamerTrialsMover {
public:
