...
///@file protocols/moves/MakePolyXMoverCreator.hh
///@brief This class will create instances of Mover MakePolyXMover for the MoverFactory
///@author Andrew Leaver-Fay via code_writer.py (aleaverfay@gmail.com)

#ifndef INCLUDED_protocols_moves_MakePolyXMoverCreator_hh
#define INCLUDED_protocols_moves_MakePolyXMoverCreator_hh
