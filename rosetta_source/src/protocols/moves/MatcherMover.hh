...
/// @file   protocols/moves/MatherMover.hh
/// @brief  mover wrapper for the matcher
/// @author Florian Richter, floric@u.washington.edu, june 2010

#ifndef INCLUDED_protocols_moves_MatcherMover_hh
#define INCLUDED_protocols_moves_MatcherMover_hh

// Unit headers
#include <protocols/moves/MatcherMover.fwd.hh>
