...
/// @file   protocols/moves/ConstrainToIdealMover.fwd.hh
/// @brief  ConstrainToIdealMover forward declarations header
/// @author Steven Lewis (smlewi@unc.edu)


#ifndef INCLUDED_protocols_moves_ConstrainToIdealMover_fwd_hh
#define INCLUDED_protocols_moves_ConstrainToIdealMover_fwd_hh
