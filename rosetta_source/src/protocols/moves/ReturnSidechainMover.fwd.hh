...
/// @file   protocols/moves/ReturnSidechainMover.fwd.hh
/// @brief  ReturnSidechainMover forward declarations header
/// @author Steven Lewis (smlewi@unc.edu)


#ifndef INCLUDED_protocols_moves_ReturnSidechainMover_fwd_hh
#define INCLUDED_protocols_moves_ReturnSidechainMover_fwd_hh
...
#endif //INCLUDED_protocols_moves_ReturnSidechainMover_FWD_HH
