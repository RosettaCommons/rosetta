...
#ifndef INCLUDED_protocols_moves_PoseMembraneRigidBodyMover_hh
#define INCLUDED_protocols_moves_PoseMembraneRigidBodyMover_hh
...
class MovePoseToMembraneCenterMover : public Mover {
...
class MembraneCenterPerturbationMover : public Mover {
public:
...
class MembraneNormalPerturbationMover : public Mover {
public:
...
class WholeBodyTranslationMover :  public Mover {
public:
...
class WholeBodyRotationMover :  public Mover {
public:
...
#endif //INCLUDED_protocols_moves_PoseMembraneRigidBodyMover_HH
