...
#include <protocols/moves/PerturbRotamerSidechainMoverCreator.hh>
...
static basic::Tracer TR("protocols.moves.PerturbRotamerSidechainMover");
...
PerturbRotamerSidechainMover::clone() const {
	return new PerturbRotamerSidechainMover(*this);
}
