...
/// @file protocols/moves/PeptideStapleMover.cc
...
using basic::Error;
using basic::Warning;
static basic::Tracer TR( "protocols.moves.PeptideStapleMover" );
...
void PeptideStapleMover::minimize_( core::pose::Pose & pose )
{
	...
	protocols::moves::MinMover min_mover( mm, scorefxn, "dfpmin_armijo_nonmonotone_atol", 10.0 /*tolerance*/,
