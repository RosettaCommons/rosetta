...
/// @file /protocols/moves/ConstrainToIdealMover.hh
...
#ifndef INCLUDED_protocols_moves_ConstrainToIdealMover_hh
#define INCLUDED_protocols_moves_ConstrainToIdealMover_hh

// Unit Headers
#include <protocols/moves/ConstrainToIdealMover.fwd.hh>
...
#include <protocols/rna/AllowInsert.fwd.hh> //need to move AllowInsert to toolbox XRW2
...
public:
	...
	void set_AllowInsert(protocols::rna::AllowInsertOP allow_insert);

	///@brief getter for AllowInsert
	protocols::rna::AllowInsertOP get_AllowInsert() const;
