...
/// @class Broken-chain folding protocol specialized for NonlocalAbinitio.
...
class BrokenFold : public BrokenBase {
 public:
  BrokenFold(core::fragment::FragSetOP fragments_large,
             core::fragment::FragSetOP fragments_small,
 ...
 private:
  ...
  core::Size num_cycles(int stage) const;

  /// @brief Returns the temperature for stage i
  core::Real temperature(int stage) const;
};
