...
typedef utility::pointer::owning_ptr< LoopHashLibraryLoader > LoopHashLibraryLoaderOP;
typedef utility::pointer::owning_ptr< LoopHashLibraryLoader const > LoopHashLibraryLoaderCOP;
