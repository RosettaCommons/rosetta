...
#ifndef INCLUDED_protocols_rigid_FragInsertAndAlignMover_hh
#define INCLUDED_protocols_rigid_FragInsertAndAlignMover_hh

// AUTO-REMOVED #include <protocols/rigid/RBSegmentMover.hh>
