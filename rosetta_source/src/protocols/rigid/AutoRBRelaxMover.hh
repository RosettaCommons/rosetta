...
#ifndef INCLUDED_protocols_rigid_AutoRBRelaxMover_hh
#define INCLUDED_protocols_rigid_AutoRBRelaxMover_hh
...
// AUTO-REMOVED #include <protocols/rigid/RBSegment.hh>

#include <protocols/rigid/RBSegment.fwd.hh>
...
public:
	...
	virtual
	std::string get_name() const { return "AutoRBMover"; }
