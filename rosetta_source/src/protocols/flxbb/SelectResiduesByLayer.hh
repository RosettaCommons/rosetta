...
/// @file protocols/flxbb/SelectResiduesByLayer.hh
...
#ifndef INCLUDED_protocols_flxbb_SelectResiduesByLayer_hh
#define INCLUDED_protocols_flxbb_SelectResiduesByLayer_hh
