...
/// @file   protocols/protein_interface_design/filters/RotamerBoltzmannWeightFilter.fwd.hh
/// @brief  forward declaration for RotamerBoltzmannWeightFilter
/// @author  Sarel Fleishman sarelf@uw.edu


#ifndef INCLUDED_protocols_protein_interface_design_filters_RotamerBoltzmannWeight_fwd_hh
#define INCLUDED_protocols_protein_interface_design_filters_RotamerBoltzmannWeight_fwd_hh
