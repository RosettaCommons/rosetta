...
/// @file protocols/protein_interface_design/movers/DesignRepackMover.fwd.hh
/// @brief Forward declations for DesignRepackMover
/// @author Sarel Fleishman


#ifndef INCLUDED_protocols_protein_interface_design_movers_DesignRepackMover_fwd_hh
#define INCLUDED_protocols_protein_interface_design_movers_DesignRepackMover_fwd_hh
