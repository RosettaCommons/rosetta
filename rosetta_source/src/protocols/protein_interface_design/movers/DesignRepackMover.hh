...
/// @file protocols/protein_interface_design/movers/DesignRepackMover.hh
/// @author Sarel Fleishman (sarelf@u.washington.edu), Eva-Maria Strauch (evas01@u.washington.edu)

#ifndef INCLUDED_protocols_protein_interface_design_movers_DesignRepackMover_hh
#define INCLUDED_protocols_protein_interface_design_movers_DesignRepackMover_hh
