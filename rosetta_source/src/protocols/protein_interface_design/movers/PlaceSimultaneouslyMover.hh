...
class PlaceSimultaneouslyMover : public DesignRepackMover
{
public:
	...
	typedef std::pair< protocols::protein_interface_design::movers::DesignRepackMoverOP, core::Real > MoverRealPair;
public:
