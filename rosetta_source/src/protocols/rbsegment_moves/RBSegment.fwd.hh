...
#ifndef INCLUDED_protocols_rbsegment_moves_RBSegment_fwd_hh
#define INCLUDED_protocols_rbsegment_moves_RBSegment_fwd_hh
...
typedef utility::pointer::owning_ptr< protocols::rbsegment_moves::RBSegmentMover >  RBSegmentMoverOP;
