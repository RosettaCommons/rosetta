...
#ifndef INCLUDED_protocols_rbsegment_moves_RBSegment_hh
#define INCLUDED_protocols_rbsegment_moves_RBSegment_hh
...
#include <functional> // REQUIRED FOR WINDOWS
...
void select_RBsegments(
	utility::vector1< protocols::rbsegment_moves::RBSegment > const &rbsegs_in,
	protocols::loops::Loops const &loops_in,
	utility::vector1< protocols::rbsegment_moves::RBSegment > &rbsegs_selected,
