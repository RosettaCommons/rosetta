...
static basic::Tracer TR("protocols::rbsegment_moves::FragInsertAndAlignMover");
             ...
             core::Real randomness/*=0.0*/ )
{
	...
	static protocols::rbsegment_moves::RMSVallData rms_vall( option[ OptionKeys::loops::vall_file ] );
	...
	for (int i =  1; i <= (int)rbsegs.size(); ++i) {
		...
		// add a new frame
		frames_.push_back( new core::fragment::Frame( frag_start, frag_size ) );
