...
void BaseRole::lua_init(){
  using namespace basic::options;
    ...
    luabind::globals(lstate_)["elscripts"] = luabind::newtable( lstate_ );
    luabind::object nspace_( luabind::globals(lstate_)["elscripts"] );
		// make the lua tables that defintions() will write into
		nspace_["dtasks"] = luabind::newtable( lstate_ );
		nspace_["dscorefxns"] = luabind::newtable( lstate_ );
		nspace_["dmovers"] = luabind::newtable( lstate_ );
		nspace_["dfilters"] = luabind::newtable( lstate_ );
		nspace_["dinputters"] = luabind::newtable( lstate_ );
		nspace_["dinputterstream"] = luabind::newtable( lstate_ );
		nspace_["doutputters"] = luabind::newtable( lstate_ );
		nspace_["dworkunits"] = luabind::newtable( lstate_ );
    ...
    if( ! option[OptionKeys::els::script].user() ){
      ...
      err = luaL_dofile(lstate_, scriptname.c_str());
      if( err == 1) {
...
void BaseRole::instantiate_scorefxns() {
  ...
  luabind::globals(lstate_)["elscripts"]["scorefxns"] = luabind::newtable( lstate_ );
  scorefxns_.raw( luabind::globals(lstate_)["elscripts"]["scorefxns"] );

	LuaObject dscorefxns(luabind::globals(lstate_)["elscripts"]["dscorefxns"]);
    ...
    luabind::globals(lstate_)["elscripts"]["scorefxns"][ i.skey() ] = tmpsp;
	}
  ...
  if( luabind::type( scorefxns_["score12"].raw() ) == 0 ) {
    ...
    ScoreFunctionSP tmpsp( scorefxn.get() ); 
    scorefxn.relinquish_ownership();
    luabind::globals(lstate_)["elscripts"]["scorefxns"]["score12"] = tmpsp;
  }
...
void BaseRole::instantiate_tasks() {
  ...
  luabind::globals(lstate_)["elscripts"]["tasks"] = luabind::newtable( lstate_ );
  tasks_.raw( luabind::globals(lstate_)["elscripts"]["tasks"] );
...
void BaseRole::instantiate_movers() {
  ...
  luabind::globals(lstate_)["elscripts"]["movers"] = luabind::newtable( lstate_ );
...
void BaseRole::instantiate_filters() {
  ...
  luabind::globals(lstate_)["elscripts"]["filters"] = luabind::newtable( lstate_ );
  filters_.raw( luabind::globals(lstate_)["elscripts"]["filters"] );

	LuaObject dfilters( luabind::globals(lstate_)["elscripts"]["dfilters"]);
    ...
    luabind::globals(lstate_)["elscripts"]["filters"][ i.skey() ] = tmpsp;
	}
...
void BaseRole::instantiate_output() {
  ...
  luabind::globals(lstate_)["elscripts"]["outputters"] = luabind::newtable( lstate_ );
  outputters_.raw( luabind::globals(lstate_)["elscripts"]["outputters"] );

	LuaObject doutputters( luabind::globals(lstate_)["elscripts"]["doutputters"] );
...
void BaseRole::instantiate_input() {
  ...
  luabind::globals(lstate_)["elscripts"]["inputters"] = luabind::newtable( lstate_ );
  inputters_.raw( luabind::globals(lstate_)["elscripts"]["inputters"] );
