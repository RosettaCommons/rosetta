...
Ab_H3_cter_insert_mover::Ab_H3_cter_insert_mover(antibody2::Ab_Info & antibody_in) : Mover()   
{
           init(antibody_in, false, false);     
}
        
        
        
Ab_H3_cter_insert_mover::Ab_H3_cter_insert_mover(antibody2::Ab_Info & antibody_in, bool camelid ) : Mover()
{
    user_defined_ = true;
            
    init(antibody_in, camelid, false);
}
...
void Ab_H3_cter_insert_mover::init(antibody2::Ab_Info & antibody_in, bool camelid, bool benchmark)
{
