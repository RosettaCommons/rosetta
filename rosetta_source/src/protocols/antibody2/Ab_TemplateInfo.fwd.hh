...
/// @file protocls/antibody2/Ab_TemplateInfo.fwd.hh
/// @brief grafts a cdr onto the template of an antibody framework
/// @detailed
/// @author Jianqing Xu (xubest@gmail.com)


#ifndef INCLUDED_protocols_antibody2_Ab_TemplateInfo_fwd_hh
#define INCLUDED_protocols_antibody2_Ab_TemplateInfo_fwd_hh
