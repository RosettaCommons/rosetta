...
std::map < std::string, utility::vector1< std::string > > Motif::motifAtomIDs(
	...
	std::string("CYS"), utility::tools::make_vector1( std::string("HG"), std::string("SG"), std::string("CB") ),
	...
	std::string("SER"), utility::tools::make_vector1( std::string("HG"), std::string("OG"), std::string("CB") ),
	std::string("THR"), utility::tools::make_vector1( std::string("HG1"), std::string("OG1"), std::string("CG2") ),
