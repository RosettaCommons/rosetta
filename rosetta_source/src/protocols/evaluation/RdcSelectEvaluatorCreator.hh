...
#ifndef INCLUDED_protocols_evaluation_RdcSelectEvaluatorCreator_hh
#define INCLUDED_protocols_evaluation_RdcSelectEvaluatorCreator_hh
...
class RdcSelectEvaluatorCreator : public EvaluatorCreator
{
public:
