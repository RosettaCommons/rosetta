...
/// @file   protocols/evaluation/PalesEvaluatorCreator.hh
/// @brief  Header for PalesEvaluatorCreator
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_evaluation_PalesEvaluatorCreator_hh
#define INCLUDED_protocols_evaluation_PalesEvaluatorCreator_hh
...
class PalesEvaluatorCreator : public EvaluatorCreator
{
public:
