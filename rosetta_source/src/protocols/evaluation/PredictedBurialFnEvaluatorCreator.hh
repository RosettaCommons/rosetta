...
/// @file   protocols/evaluation/PredictedBurialFnEvaluatorCreator.hh
/// @brief  Header for PredictedBurialFnEvaluatorCreator
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_evaluation_PredictedBurialFnEvaluatorCreator_hh
#define INCLUDED_protocols_evaluation_PredictedBurialFnEvaluatorCreator_hh
...
class PredictedBurialFnEvaluatorCreator : public EvaluatorCreator
{
public:
