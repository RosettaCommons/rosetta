...
#ifndef INCLUDED_protocols_evaluation_ClashEvaluator_hh
#define INCLUDED_protocols_evaluation_ClashEvaluator_hh
...
public:
  PoseMetricEvaluator( std::string tag ) : SingleValuePoseEvaluator< T >( metric+"_"+tag ) {};
