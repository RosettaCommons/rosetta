...
/// @file   protocols/evaluation/RdcEvaluatorCreator.hh
/// @brief  Header for RdcEvaluatorCreator
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_evaluation_RdcEvaluatorCreator_hh
#define INCLUDED_protocols_evaluation_RdcEvaluatorCreator_hh
...
class RdcEvaluatorCreator : public EvaluatorCreator
{
public:
