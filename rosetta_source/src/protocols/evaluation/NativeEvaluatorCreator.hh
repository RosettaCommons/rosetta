...
#ifndef INCLUDED_protocols_evaluation_NativeEvaluatorCreator_hh
#define INCLUDED_protocols_evaluation_NativeEvaluatorCreator_hh
...
class NativeEvaluatorCreator : public EvaluatorCreator
{
public:
