...
/// @file   protocols/evaluation/RmsdTargetEvaluatorCreator.hh
/// @brief  Header for RmsdTargetEvaluatorCreator
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_evaluation_RmsdTargetEvaluatorCreator_hh
#define INCLUDED_protocols_evaluation_RmsdTargetEvaluatorCreator_hh
...
class RmsdTargetEvaluatorCreator : public EvaluatorCreator
{
public:
	RmsdTargetEvaluatorCreator() : options_registered_(false) {};
	virtual ~RmsdTargetEvaluatorCreator();
