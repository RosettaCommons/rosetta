...
#ifndef INCLUDED_protocols_evaluation_ExtraScoreEvaluatorCreator_hh
#define INCLUDED_protocols_evaluation_ExtraScoreEvaluatorCreator_hh
...
class ExtraScoreEvaluatorCreator : public EvaluatorCreator
{
public:
