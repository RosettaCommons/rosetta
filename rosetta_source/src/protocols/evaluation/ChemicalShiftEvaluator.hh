...
#ifndef INCLUDED_protocols_evaluation_ChemicalShiftEvaluator_hh
#define INCLUDED_protocols_evaluation_ChemicalShiftEvaluator_hh
...
class ChemicalShiftEvaluator : public SingleValuePoseEvaluator< core::Real > {
public:
