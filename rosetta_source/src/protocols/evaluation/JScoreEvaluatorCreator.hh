...
/// @file   protocols/evaluation/JScoreEvaluatorCreator.hh
/// @brief  Header for JScoreEvaluatorCreator
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_evaluation_JScoreEvaluatorCreator_hh
#define INCLUDED_protocols_evaluation_JScoreEvaluatorCreator_hh
...
class JScoreEvaluatorCreator : public EvaluatorCreator
{
public:
