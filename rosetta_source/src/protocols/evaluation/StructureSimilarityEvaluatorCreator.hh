...
/// @file   protocols/evaluation/StructureSimilarityEvaluatorCreator.hh
/// @brief  Header for StructureSimilarityEvaluatorCreator
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_evaluation_StructureSimilarityEvaluatorCreator_hh
#define INCLUDED_protocols_evaluation_StructureSimilarityEvaluatorCreator_hh
...
class StructureSimilarityEvaluatorCreator : public EvaluatorCreator
{
public:
