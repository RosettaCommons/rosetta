...
/// @file   protocols/evaluation/JumpNrEvaluatorCreator.hh
/// @brief  Header for JumpNrEvaluatorCreator
/// @author Matthew O'Meara

#ifndef INCLUDED_protocols_evaluation_JumpNrEvaluatorCreator_hh
#define INCLUDED_protocols_evaluation_JumpNrEvaluatorCreator_hh
...
class JumpNrEvaluatorCreator : public EvaluatorCreator
{
public:
