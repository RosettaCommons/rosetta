...
#ifndef INCLUDED_protocols_evaluation_CamShiftEvaluatorCreator_hh
#define INCLUDED_protocols_evaluation_CamShiftEvaluatorCreator_hh
...
class CamShiftEvaluatorCreator : public EvaluatorCreator
{
public:
