...
/// @file   src/apps/public/scenarios/chemically_conjugated_docking/UBQ_Gp_CYX-Cterm.cc
...
using basic::Error;
using basic::Warning;
static basic::Tracer TR("apps.public.scenarios.chemically_conjugated_docking.UBQ_Gp_CYX-Cterm");
