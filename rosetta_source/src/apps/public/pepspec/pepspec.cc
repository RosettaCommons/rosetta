...
// AUTO-REMOVED #include <core/kinematics/RT.fwd.hh>
...
// AUTO-REMOVED #include <protocols/toolbox/pose_metric_calculators/MetricValueGetter.fwd.hh>
...
// AUTO-REMOVED #include <numeric/internal/ColPointers.hh>
// AUTO-REMOVED #include <numeric/internal/ColVectors.hh>
// AUTO-REMOVED #include <numeric/internal/ColsPointer.hh>
// AUTO-REMOVED #include <numeric/internal/RowPointers.hh>
// AUTO-REMOVED #include <numeric/internal/RowVectors.hh>
// AUTO-REMOVED #include <numeric/internal/RowsPointer.hh>
...
)
{
	...
	MinMoverOP min_mover = new MinMover( mm, cen_scorefxn, "dfpmin", 0.001, true );
		...
		//check no_cen clash
			...
			//else replace rotamers and repack if necessary
				...
				if( has_clash( pose, is_pep, cen_scorefxn, clash_cutoff ) ){
					...
					RotamerTrialsMoverOP dz_rottrial ( new RotamerTrialsMover( cen_scorefxn, rp_task_factory ) );
...
//				if( option[ pepspec::phipsi_analysis ] ) out_file << pep_phipsi_analysis( pose );
			...
			//full_wts
			{
				...
				RotamerTrialsMoverOP dz_rottrial ( new RotamerTrialsMover( full_scorefxn, dz_task_factory ) );
			...
			if( option[ pepspec::soft_wts ].user() ){
				...
				RotamerTrialsMoverOP dz_rottrial ( new RotamerTrialsMover( soft_scorefxn, dz_task_factory ) );
				SequenceMoverOP design_seq = new SequenceMover;
				design_seq->add_mover( dz_pack );
				design_seq->add_mover( dz_rottrial );
				design_seq->add_mover( min_mover );
