...
namespace oop_design {
	...
	//RealOptionKey const pert_mc_temp( "oop_design::pert_mc_temp" );
	...
	//RealOptionKey const pert_pep_small_temp( "oop_design::pert_pep_small_temp" );
	//RealOptionKey const pert_pep_small_H( "oop_design::pert_pep_small_H" );
	//RealOptionKey const pert_pep_small_L( "oop_design::pert_pep_small_L" );
	//RealOptionKey const pert_pep_small_E( "oop_design::pert_pep_small_E" );
	//RealOptionKey const pert_pep_shear_temp( "oop_design::pert_pep_shear_temp" );
	//RealOptionKey const pert_pep_shear_H( "oop_design::pert_pep_shear_H" );
	//RealOptionKey const pert_pep_shear_L( "oop_design::pert_pep_shear_L" );
	//RealOptionKey const pert_pep_shear_E( "oop_design::pert_pep_shear_E" );
	...
	//BooleanOptionKey const final_design_min( "oop_design::final_design_min" );
	//BooleanOptionKey const use_soft_rep( "oop_design::use_soft_rep" );
	//BooleanOptionKey const mc_initial_pose( "oop_design::mc_initial_pose" );
	//BooleanOptionKey const oop_design_first( "oop_design::oop_design_first" );

	//BooleanOptionKey const pymol( "oop_design::pymol" );
	//BooleanOptionKey const keep_history( "oop_design::keep_history" );

	// design options
	//RealOptionKey const desn_mc_temp( "oop_design::desn_mc_temp" );
...
main( int argc, char* argv[] )
{
	...
	**********************************************************************************************************************/
	...
	option.add( oop_design::pert_mc_temp, "The temperature to use for the pertubation phase of the ODDM protocol. Defaults to 0.8." ).def( 0.8 );
	...
	option.add( oop_design::pert_pep_small_temp, "" ).def( 0.8 );
	option.add( oop_design::pert_pep_shear_temp, "" ).def( 0.8 );

	option.add( oop_design::pert_pep_small_H, "" ).def( 2.0 );
	option.add( oop_design::pert_pep_small_L, "" ).def( 2.0 );
	option.add( oop_design::pert_pep_small_E, "" ).def( 2.0 );
	option.add( oop_design::pert_pep_shear_H, "" ).def( 2.0 );
	option.add( oop_design::pert_pep_shear_L, "" ).def( 2.0 );
	option.add( oop_design::pert_pep_shear_E, "" ).def( 2.0 );
	*/
...
/*
	...
	simple_moves::RotamerTrialsMoverOP pert_rt(new simple_moves::EnergyCutRotamerTrialsMover( score_fxn, pert_tf, mc, 0.1 ) );
*/
	...
	*/
	...
	TaskFactoryOP desn_tf( new TaskFactory() );
	desn_tf->push_back( new core::pack::task::operation::InitializeFromCommandline );
	//desn_tf->push_back( new operation::RestrictToRepacking() ) ;
