  ...
  )
  {
    ...
    //			core::pose::remove_virtual_residues( &pose_for_rotation );
		...
		if( symm_min_ ) {
			...
			// set up the movemap
			core::scoring::ScoreFunctionCOP scorefxn = new core::scoring::symmetry::SymmetricScoreFunction( *core::scoring::ScoreFunctionFactory::create_score_function("score12") );
