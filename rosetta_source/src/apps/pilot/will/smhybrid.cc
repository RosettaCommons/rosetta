...
get_frags_map( bool design = false ) {
	...
	core::io::database::open(in,"ss_fragfiles/EEE.fragfile"); read_fragdata(fds["EEE"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/EEH.fragfile"); read_fragdata(fds["EEH"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/EEL.fragfile"); read_fragdata(fds["EEL"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/EHH.fragfile"); read_fragdata(fds["EHH"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/ELE.fragfile"); read_fragdata(fds["ELE"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/ELH.fragfile"); read_fragdata(fds["ELH"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/ELL.fragfile"); read_fragdata(fds["ELL"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/HEE.fragfile"); read_fragdata(fds["HEE"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/HEH.fragfile"); read_fragdata(fds["HEH"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/HEL.fragfile"); read_fragdata(fds["HEL"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/HHE.fragfile"); read_fragdata(fds["HHE"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/HHH.fragfile"); read_fragdata(fds["HHH"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/HHL.fragfile"); read_fragdata(fds["HHL"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/HLE.fragfile"); read_fragdata(fds["HLE"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/HLH.fragfile"); read_fragdata(fds["HLH"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/HLL.fragfile"); read_fragdata(fds["HLL"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/LEE.fragfile"); read_fragdata(fds["LEE"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/LEH.fragfile"); read_fragdata(fds["LEH"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/LEL.fragfile"); read_fragdata(fds["LEL"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/LHH.fragfile"); read_fragdata(fds["LHH"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/LLE.fragfile"); read_fragdata(fds["LLE"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/LLH.fragfile"); read_fragdata(fds["LLH"],in,design); in.close();
	core::io::database::open(in,"ss_fragfiles/LLL.fragfile"); read_fragdata(fds["LLL"],in,design); in.close();
	return fds;
}
