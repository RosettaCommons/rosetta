...
inline bool clash( xyzHASH const * h, float4 const a )
{
...
inline uint contacts( xyzHASH const * h, float4 const a )
{
...
int main(int argc, char *argv[]) {
  ...
  // xyzHASH hcl = { clash.grid_atoms(), clash.grid_stripe(), clash.grid_size(), dimcl, 3.4f*3.4f };
  // xyzHASH hct = { ctact.grid_atoms(), ctact.grid_stripe(), ctact.grid_size(), dimcl, 5.0f*5.0f };
