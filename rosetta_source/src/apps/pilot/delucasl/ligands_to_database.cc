...
int main(int argc, char*argv[])
{
	...
	std::string database_mode = basic::options::option[basic::options::OptionKeys::ligand_import::database_mode];
	utility::sql_database::sessionOP db_session(basic::database::get_db_session(database_name,database_mode,false,false));
