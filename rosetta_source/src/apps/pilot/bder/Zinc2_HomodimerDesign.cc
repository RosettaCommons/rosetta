...
/// @file    apps/pilot/bder/Zinc2_HomodimerDesign.cc
/// @brief   Starts with an undesigned symmetric dimer with two interface zinc sites as created by Zinc2_HomodimerDesign_setup, and designs the interface with sc, bb, and jump minimization.
...
using basic::Warning;
using basic::T;
static basic::Tracer TR("apps.pilot.bder.Zinc2_HomodimerDesign");
...
///@brief
class Zinc2_HomodimerDesign : public protocols::moves::Mover {
public:
  Zinc2_HomodimerDesign()
  {

		TR << "//////////////////////////////////////////////////////////////////////////////////////////////" << std::endl << std::endl;

		TR << "/// @file    apps/pilot/bder/Zinc2_HomodimerDesign.cc" << std::endl;
		TR << "/// @brief   Starts with an undesigned symmetric dimer with two interface zinc sites as created by Zinc2_HomodimerDesign_setup, and designs the interface with sc, bb, and jump minimization." << std::endl;
  ...
  apply( Pose & pose ){
	...
	setup_metalsite( Pose & pose ){
		...
		devel::metal_interface::ZincSiteFinderOP find_zinc1 = new devel::metal_interface::ZincSiteFinder( zn1_res );
		devel::metal_interface::ZincSiteFinderOP find_zinc2 = new devel::metal_interface::ZincSiteFinder( zn2_res );
		msr1_ = find_zinc1->find_zinc_site(pose); // msr is of type utility::vector1< devel::metal_interface::MetalSiteResidueOP >
		msr2_ = find_zinc2->find_zinc_site(pose);

		devel::metal_interface::AddZincSiteConstraintsOP constraints_adder1 = new devel::metal_interface::AddZincSiteConstraints( msr1_ );
		devel::metal_interface::AddZincSiteConstraintsOP constraints_adder2 = new devel::metal_interface::AddZincSiteConstraints( msr2_ );
	...
	virtual
	std::string
	get_name() const { return "Zinc2_HomodimerDesign"; }
...
typedef utility::pointer::owning_ptr< Zinc2_HomodimerDesign > Zinc2_HomodimerDesignOP;
