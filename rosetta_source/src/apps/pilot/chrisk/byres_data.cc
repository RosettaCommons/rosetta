...
)
{
	...
	std::string pdbnametag( core::pose::tag_from_pose( pose ) );
	std::string pdbname( pdbnametag + ".pdb" );
	/*
...
*/
	...
	//silent-type output
	io::silent::SilentFileData silent_data;
