...
//  std::cout << "-rbe:server_url " << option[rbe::server_url]() << std::endl;
//  std::cout << "-rbe:server_port " << option[rbe::server_port]() << std::endl;
//
//  std::stringstream options_ss;
//  options_ss << " -database lalal \n -rbe:server_url nonono \n -rbe:server_port 81 ";
//
//  newparams.push_back("-database lalal");
//  newparams.push_back("-rbe:server_url nonono");
//  newparams.push_back("-rbe:server_port 81");
//
//  utility::options::OptionCollection &option_collection  = initialize();
//  option_collection.load( argc, argv, false);
//  std::cout << "ReInit" << std::endl;
//  option_collection.load( newparams, false);
//  std::cout << "-rbe:server_url " << option[rbe::server_url]() << std::endl;
//  std::cout << "-rbe:server_port " << option[rbe::server_port]() << std::endl;
//
//  initialize().load( argc, argv, false);
//  std::cout << "-rbe:server_url " << option[rbe::server_url]() << std::endl;
//  std::cout << "-rbe:server_port " << option[rbe::server_port]() << std::endl;
//
//  return 0;
...
//  std::string script_contents = "<dock_design>\n\
//     <SCOREFXNS>\n\
...
//             <GenericMonteCarlo name=multicstopt mover_name=cstopt filter_name=allcst trials=10 sample_type=low temperature=0.6 drift=0/>\n\
//             <EnzRepackMinimize name=desmin_fixcat design=1 repack_only=0 scorefxn_minimize=myscore scorefxn_repack=soft_rep minimize_rb=1 minimize_sc=1 minimize_bb=0 cycles=2 minimize_lig=1 min_in_stages=0 backrub=0 task_operations=edto,limchi2,fixcat/>\n\
//             <EnzRepackMinimize name=desmin design=1 repack_only=0 scorefxn_minimize=myscore scorefxn_repack=soft_rep minimize_rb=1 minimize_sc=1 minimize_bb=0 cycles=2 minimize_lig=1 min_in_stages=0 backrub=0 task_operations=edto,limchi2,catres/>\n\
//             <GenericMonteCarlo name=multidesmin mover_name=desmin filter_name=interfE trials=3 sample_type=low temperature=0.6 drift=0/>\n\
//             <EnzRepackMinimize name=fin_min repack_only=0 design=0 scorefxn_minimize=myscore scorefxn_repack=myscore minimize_rb=1 minimize_sc=1 minimize_bb=1 cycles=1 task_operations=edto,limchi2,catres/>\n\
...
//     </MOVERS>\n\
//     <APPLY_TO_POSE>\n\
//             favor_native_residue bonus=1.25/>\n\
//     </APPLY_TO_POSE>\n\
//     <PROTOCOLS>\n\
//             <Add mover_name=cstadd/>\n\
//             <Add mover_name=cstopt filter_name=allcst/>\n\
//             <Add mover_name=desmin_fixcat/>\n\
//             <Add mover_name=multidesmin/>\n\
//             <Add mover_name=cstrem/>\n\
//             <Add mover_name=fin_min/>\n\
//             <Add mover_name=fin_rpkmin filter_name=interfE/>\n\
//             <Add mover_name=fincstadd filter_name=myfilter/>\n\
//     </PROTOCOLS>\n\
//</dock_design>\n\
//";
//
//  utility::Inline_File_Provider *provider = utility::Inline_File_Provider::get_instance();
//  provider->add_input_file( "parser_script.xml", script_contents );
//  provider->clear_input_files();
//  ////provider->remove_input_file( "parser_script.xml" );
//
//  protocols::jd2::DockDesignParser ddp;
//
//  core::pose::Pose pose;
