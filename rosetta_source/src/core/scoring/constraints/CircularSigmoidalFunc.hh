...
#ifndef INCLUDED_core_scoring_constraints_CircularSigmoidalFunc_hh
#define INCLUDED_core_scoring_constraints_CircularSigmoidalFunc_hh

#include <core/scoring/constraints/CircularSigmoidalFunc.fwd.hh>
