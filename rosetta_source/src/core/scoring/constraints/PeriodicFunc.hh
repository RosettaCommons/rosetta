...
/// @file src/core/scoring/constraints/PeriodicFunc.hh
...
#ifndef INCLUDED_core_scoring_constraints_PeriodicFunc_hh
#define INCLUDED_core_scoring_constraints_PeriodicFunc_hh
