...
typedef utility::pointer::owning_ptr< ResidueTypeConstraint > ResidueTypeConstraintOP;
typedef utility::pointer::owning_ptr< ResidueTypeConstraint const > ResidueTypeConstraintCOP;
