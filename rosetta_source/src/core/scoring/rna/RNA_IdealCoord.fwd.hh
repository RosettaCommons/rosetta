...
/// @file core/scoring/rna/RNA_IdealCoord.fwd.hh
/// @brief Apply ideal RNA geometry to a residue or a pose
/// @author Fang-Chieh Chou


#ifndef INCLUDED_core_scoring_rna_RNA_IdealCoord_fwd_HH
#define INCLUDED_core_scoring_rna_RNA_IdealCoord_fwd_HH
