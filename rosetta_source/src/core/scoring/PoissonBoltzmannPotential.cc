...
PB::eval_PB_energy_residue(
	...
	if (basic::options::option[ basic::options::OptionKeys::corrections::score::PB_score_residue_range ].user()) {
		if (rsd.seqpos() < basic::options::option[ basic::options::OptionKeys::corrections::score::PB_score_residue_range ][1]) return;
		if (rsd.seqpos() > basic::options::option[ basic::options::OptionKeys::corrections::score::PB_score_residue_range ][2])	return;
	}
