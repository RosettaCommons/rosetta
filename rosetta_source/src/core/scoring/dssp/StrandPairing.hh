...
//   core::Size pleating;
// } BetaPair;
// replaced by class Pairing in PairingsList.hh
...
public:
  ...
  void get_beta_pairs( PairingList& ) const;
...
private:
	//@brief first pairing of strand is begin1_ --> end2_
	//       last  pairing of strand is end1_ --> begin2_
...
public:
	...
	StrandPairingSet( PairingList const& );
  ~StrandPairingSet();
  ...
  bool paired( core::Size res1, core::Size res2, bool antiparallel ) const;
	bool has_pairing( Pairing const& ) const;
...
private:
  void add_pairing( core::Size res1, core::Size res2, bool antiparallel, core::Size pleating );
	void add_pairing( Pairing const & pairing );
  void selfmerge();
	void compute(
		ObjexxFCL::FArray2_float const & hbonds,
		float threshold,
