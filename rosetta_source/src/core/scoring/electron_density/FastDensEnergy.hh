...
/*
///
class ElecDensCentroidEnergy : public methods::ContextDependentLRTwoBodyEnergy {
public:

	///
	// Not defined yet, commenting out to make python bingings compile
	ElecDensCentroidEnergy( method::EnergyMethod);
