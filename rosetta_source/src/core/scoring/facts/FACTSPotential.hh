...
namespace scoring {
	...
	public:
		...
		Real E_elec( Size const res ) const { return E_elec_[res]; }
		Real E_solv( Size const res ) const { return E_solv_[res]; }
		...
		Real dsolv_dBR( Size const atm ) const { return dsolv_dBR_[atm]; }
		Vector elecF2( Size const atm ) const { return elecF2_[atm]; }
		Vector solvF2d( Size const atm ) const { return solvF2d_[atm]; }
		Vector solvF2BR( Size const atm ) const { return solvF2BR_[atm]; }
		Vector sasaF2( Size const atm ) const { return sasaF2_[atm]; }
	...
	private:
		...
		Real inv_die() const{	return inv_die_; }
