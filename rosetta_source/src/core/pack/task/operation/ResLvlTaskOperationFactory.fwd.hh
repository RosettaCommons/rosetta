...
typedef utility::pointer::owning_ptr< ResLvlTaskOperationFactory > ResLvlTaskOperationFactoryOP;
typedef utility::pointer::owning_ptr< ResLvlTaskOperationFactory const > ResLvlTaskOperationFactoryCOP;
