...
#    2. create a Python list of string arguments, make sure the first three are:
#        a. "app"
#        b. "-database"
#        c. the path to your PyRosetta database
#        d. any additional options you desire, by default PyRosetta loads with:
#            -ex1 (extra chi 1 rotamers)
#            -ex2aro (extra chi 2 rotamers for aromatic amino acids)
#    3. create a rosetta.utility.vector1_string()
#    4. add the Python list to the vector1_string (using the .extend method)
#    5. call rosetta.core.init with the vector1_string as an input
...
opts = ['app', '-database',
    os.path.abspath(os.environ['PYROSETTA_DATABASE']),
    '-ex1', '-ex2aro', '-constant_seed']
args = rosetta.utility.vector1_string()
args.extend(opts)
rosetta.core.init(args)
# if this causes errors, please comment it out and run using init(), this
#    should only happend if you have edited your environment paths,
#    see rosetta/__init__.py in the main PyRosetta directory for more options
#    on how to customize initialization
...
parser.add_option('--pdb_filename', dest = 'pdb_filename',
    default = 'demo/data/test_dock.pdb',    # default example PDB
