...
2) run the script:
    from commandline                        >python pose_structure.py
    
    from within python/ipython              [1]: run pose_structure.py
    
    after importing the relevant method     [1]: from pose_structure import *
                                            [2]: pose_structure( )
...
def pose_structure( pose , display_residues = [] ):
    ...
    pymover = PyMOL_Mover()
    pymover.apply( pose )    # export the structure to PyMOL
