...
basic::Tracer td( "devel.cartesian_frags.DNA_FragLib", basic::t_debug );
basic::Tracer ti( "devel.cartesian_frags.DNA_FragLib", basic::t_info );
basic::Tracer tw( "devel.cartesian_frags.DNA_FragLib", basic::t_warning );
