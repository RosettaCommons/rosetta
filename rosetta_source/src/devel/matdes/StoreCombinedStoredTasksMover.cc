...
/// @file devel/matdes/StoreCombinedStoredTasksMover.cc
/// @brief The StoreCombinedStoredTasksMover allows you to create a PackerTask at some point during a
...
// Unit Headers
#include <devel/matdes/StoreCombinedStoredTasksMover.hh>
...
static basic::Tracer TR("devel.matdes.StoreCombinedStoredTasksMover");
...
void
StoreCombinedStoredTasksMover::parse_my_tag( TagPtr const tag, protocols::moves::DataMap & data_map, protocols::filters::Filters_map const &, protocols::moves::Movers_map const &, core::pose::Pose const & )
{
