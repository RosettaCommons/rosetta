...
/// @file   devel/matdes/TaskAwareAlaScanCreator.hh
/// @brief  FilterCreators for the TaskAwareAlaScanCreator
/// @author Neil King (neilking@uw.edu)


#ifndef INCLUDED_devel_matdes_TaskAwareAlaScanCreator_hh
#define INCLUDED_devel_matdes_TaskAwareAlaScanCreator_hh
