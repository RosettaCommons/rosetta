...
/// @file   devel/matdes/TaskAwareSASAFilter.hh
/// @brief  header file for TaskAwareSASAFilter class
/// @author Neil King (neilking@u.washington.edu)


#ifndef INCLUDED_devel_matdes_TaskAwareSASAFilter_hh
#define INCLUDED_devel_matdes_TaskAwareSASAFilter_hh

// Unit Headers
#include <devel/matdes/TaskAwareSASAFilter.fwd.hh>
