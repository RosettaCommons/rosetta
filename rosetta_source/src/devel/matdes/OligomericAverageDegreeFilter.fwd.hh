...
/// @file   devel/matdes/OligomericAverageDegreeFilter.fwd.hh
/// @brief
/// @author Neil King (neilking@u.washington.edu)


#ifndef INCLUDED_devel_matdes_OligomericAverageDegreeFilter_fwd_hh
#define INCLUDED_devel_matdes_OligomericAverageDegreeFilter_fwd_hh
