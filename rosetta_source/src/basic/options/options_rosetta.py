  ...
  Option_Group( 'rigid',
    ...
    Option( 'replonly_loops', 'Boolean', desc = 'all loops will be regarded as repulsive-only', default='false' ),
		...
		Option_Group( 'file',
			...
			Option( 'extra_res_database_mode','String',desc="The type of database drivert o use for -in:file:extra_res_database.  Acceptable values are 'mysql' or 'sqlite3'",default='sqlite3'),
