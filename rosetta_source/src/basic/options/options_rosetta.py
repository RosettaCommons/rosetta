...
# Solid state NMR orientational constraints
 ...
 ## strand assembly options
	Option_Group( 'strand_assembly',
								...
								Option('min_strand_size','Integer', desc="Minimum size of a strand in a bundle"),
								Option('max_strand_size','Integer', desc="Maximum size of a strand in a bundle"),
							  ...
							  Option('min_sheet_angle','Real', desc="Minimum angle between sheets (CA and CA)"),
								...
								Option('no_strand_in_loop_in_extracted_sw', 'Boolean', desc="if true, ignore any pdb that has a strand as a loop in extracted sandwich"),
