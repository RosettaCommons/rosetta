...
# Solid state NMR orientational constraints
  ...
  ## strand assembly options
	Option_Group( 'strand_assembly',
		 Option('min_num_strands_to_deal','Integer', desc="Minimum number of strands to handle beta-sandwich", default='5'),
		 Option('max_num_strands_to_deal','Integer', desc="Maximum number of strands to handle beta-sandwich", default='13'),
		 Option('extract_native_only', 'Boolean', desc="if true, extract native full strands only", default='false' ),
		 Option('extract_sandwich', 'Boolean', desc="if true, extract sandwich too", default='true' ),
		 Option('min_strand_size','Integer', desc="Minimum size of a strand in a bundle", default='3'),
		 Option('max_strand_size','Integer', desc="Maximum size of a strand in a bundle", default='22'),
		 Option('min_CA_CA_dis','Real', desc="Minimum distance between CA and CA", default='4.0'),
     Option('max_CA_CA_dis','Real', desc="Maximum distance between CA and CA", default='5.7'),
		 Option('min_O_N_dis','Real', desc="Minimum distance between backbone oxygen and backbone nitrogen", default='2.6'),
		 Option('max_O_N_dis','Real', desc="Maximum distance between backbone oxygen and backbone nitrogen", default='3.1'),
		 Option('min_C_O_N_angle','Real', desc="Minimum angle between strands  to become one sheet", default='120'),
		 Option('min_sheet_dis','Real', desc="Minimum distance between sheets (CA and CA)", default='6'),
		 Option('max_sheet_dis','Real', desc="Maximum distance between sheets (CA and CA)", default='16'),
		 Option('min_sheet_torsion','Real', desc="Minimum torsion between sheets (CA and CA) with respect to terminal residues", default='-50'),
		 Option('max_sheet_torsion','Real', desc="Maximum torsion between sheets (CA and CA) with respect to terminal residues", default='-20'),
		 Option('min_sheet_torsion_cen_res','Real', desc="Minimum torsion between sheets (CA and CA) with respect to terminal central residues", default='-90'),
		 Option('max_sheet_torsion_cen_res','Real', desc="Max torsion between sheets (CA and CA) with respect to terminal central residues", default='90'),
		 Option('min_sheet_angle','Real', desc="Minimum angle between sheets (CA and CA)", default='30'),
     Option('max_sheet_angle','Real', desc="Maximum angle between sheets (CA and CA)", default='150'),
		 Option('min_inter_sheet_dis_CA_CA','Real', desc="minimum distance between inter sheets", default='4.0'),
		 Option('max_inter_sheet_dis_CA_CA','Real', desc="maximum distance between inter sheets", default='40.0'),
		 Option('min_shortest_dis_sidechain_inter_sheet','Real', desc="minimum distance between sidechains between sheets (pairs of strands)", default='2.0'),
		 Option('write_chain_B_resnum', 'Boolean', desc="if true, write chain_B_resnum file for InterfaceAnalyzer", default='true' ),
		 Option('write_phi_psi', 'Boolean', desc="if true, write phi_psi file", default='false' ),
		 Option('max_num_sw_per_pdb', 'Integer', desc="maximum number of sandwiches to be extracted per a pdb file", default='1' ),
),
