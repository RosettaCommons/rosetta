...
Options = Option_Group( '',
  ...
  Option_Group( 'rigid',
    ...
    Option( 'replonly_loops', 'Boolean', desc = 'all loops will be regarded as repulsive-only', default='false' ),
		Option( 'use_database', 'Boolean', desc="Read in structures from database.  Specify database via -inout:database_filename and wanted structures with -in:file:tags or select_structures_from_database"),
		Option( 'database_protocol', 'Integer', desc="Database to use when reading in structures", default="1"),
        Option( 'select_structures_from_database', 'StringVector',desc= "specify an SQL query to determine which structures get read in from a database specified with -inout:database_filename.  SELECT query must return structures.tag"),
        Option_Group( 'path',
