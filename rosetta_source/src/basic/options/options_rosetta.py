...
## --------------------------  END OF fragment picking --------------
  ...
  Option_Group('nonlocal',
	...
	Option_Group( 'corrections',
      ...
      Option( 'facts_GBpair_cut','Real', desc='GBpair interaction distance cutoff', default="12.0" ),
      ...
      Option( 'facts_asp_patch','Boolean', desc='Apply AtomicSolvationParameter for nonpolar interaction in FACTS', default="false" ),
		),
		Option_Group( 'chemical',
