...
Options = Option_Group( '',
  ...
  Option_Group( 'rigid',
		Option('fragment_cycles', 'Integer', desc = 'Number of fragment insertion cycles', default = '10000'),
		Option('jump_attempts', 'Integer', desc = 'Number of jump minimization attempts', default = '10'),
		Option('jump_cycles', 'Integer', desc = 'Number of jump minimization cycles', default = '500'),
...
#			 Option( 'minimize_tensor', 'Boolean', desc = 'Optimize the best tensor found form the grid search'),
	...
	Option_Group( 'out',
        ...
        Option( 'output_top_n_percent', 'Real', desc="Write out only the top n percent of structures by score.  This option is only relevent if -out:use_database is specified"),
        Option( 'top_n_percent_score_term', 'String', desc="Specify the score to use with the -out:top_n_percent", default="total_score"),
