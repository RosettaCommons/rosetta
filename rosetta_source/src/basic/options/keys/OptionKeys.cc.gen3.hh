...
namespace strand_assembly { IntegerOptionKey const max_starting_loop_size( "strand_assembly:max_starting_loop_size" );  }
namespace strand_assembly { IntegerOptionKey const max_ending_loop_size( "strand_assembly:max_ending_loop_size" );  }
...
namespace strand_assembly { IntegerOptionKey const max_E_in_extracted_sw_loop( "strand_assembly:max_E_in_extracted_sw_loop" );  }
...
namespace strand_assembly { BooleanOptionKey const do_not_connect_sheets_by_loops( "strand_assembly:do_not_connect_sheets_by_loops" );  }
namespace strand_assembly { RealOptionKey const check_canonicalness_cutoff( "strand_assembly:check_canonicalness_cutoff" );  }
namespace strand_assembly { BooleanOptionKey const count_AA_with_direction( "strand_assembly:count_AA_with_direction" );  }
namespace strand_assembly { RealOptionKey const inter_sheet_distance_to_see_whether_a_sheet_is_surrounded_by_other_sheets( "strand_assembly:inter_sheet_distance_to_see_whether_a_sheet_is_surrounded_by_other_sheets" );  }
namespace strand_assembly { BooleanOptionKey const exclude_desinated_pdbs( "strand_assembly:exclude_desinated_pdbs" );  }
