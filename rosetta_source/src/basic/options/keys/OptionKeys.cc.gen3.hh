...
namespace HelixAssembly { RealOptionKey const helix_cap_distance_cutoff( "HelixAssembly:helix_cap_distance_cutoff" );  }
namespace HelixAssembly { RealOptionKey const helix_contact_distance_cutoff( "HelixAssembly:helix_contact_distance_cutoff" );  }
...
namespace orbitals { BooleanOptionKey const orbital( "orbitals:orbital" );  }
namespace orbitals { RealOptionKey const atomic_cutoff( "orbitals:atomic_cutoff" );  }
namespace orbitals { BooleanOptionKey const verbose( "orbitals:verbose" );  }
...
namespace orbitals { BooleanOptionKey const threeA( "orbitals:threeA" );  }
namespace orbitals { BooleanOptionKey const fiveA( "orbitals:fiveA" );  }
namespace orbitals { BooleanOptionKey const no_pos_bonus( "orbitals:no_pos_bonus" );  }
namespace orbitals { BooleanOptionKey const sc_bb( "orbitals:sc_bb" );  }
namespace orbitals { BooleanOptionKey const ten( "orbitals:ten" );  }
namespace orbitals { BooleanOptionKey const dist( "orbitals:dist" );  }
namespace orbitals { RealOptionKey const nbr_distance_squared( "orbitals:nbr_distance_squared" );  }
namespace orbitals { BooleanOptionKey const bb_smooth( "orbitals:bb_smooth" );  }
