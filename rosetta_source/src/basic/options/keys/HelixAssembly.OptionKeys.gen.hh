...
namespace HelixAssembly { extern RealOptionKey const helix_cap_distance_cutoff; }
namespace HelixAssembly { extern RealOptionKey const helix_contact_distance_cutoff; }
