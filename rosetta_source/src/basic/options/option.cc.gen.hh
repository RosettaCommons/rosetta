...
option.add( basic::options::OptionKeys::in::file::centroid_input, "Enable centroid inputs of PDBs" ).def(false);
...
option.add( basic::options::OptionKeys::in::file::rama2b_map, "Ramachandran file used by rama2b" ).def("Rama08.dat");
...
option.add( basic::options::OptionKeys::in::file::vall, "Fragment database file, e.g vall.dat.2006-05-05" ).def("filtered.vall.dat.2006-05-05");
...
option.add( basic::options::OptionKeys::corrections::correct, "turn on default corrections:-corrections::chemical:icoor_05_2009-corrections::score:p_aa_pp P_AA_pp_08.2009-corrections::score:p_aa_pp_nogridshift-corrections::score:p_aa_pp_nogridshift-corrections::score:rama_not_squared-corrections::score:rama_map Rama.10.2009.yfsong.dat-scoring::hbond_params helix_hb_06_2009-corrections::score:hbond_fade 1.9 2.3 2.3 2.6 0.3 0.7 0.0 0.05-corrections::score:ch_o_bond_potential ch_o_bond_potential_near_min_yf.dat" ).def(false);
...
option.add( basic::options::OptionKeys::corrections::score::p_aa_pp, "Name of P_AA_PP potential file (search in the local directory first, then look in the database)" ).def("P_AA_pp");
...
option.add( basic::options::OptionKeys::corrections::score::rama_map, "Ramachandran file used by rama" ).def("Rama_smooth_dyn.dat_ss_6.4");
...
option.add( basic::options::OptionKeys::corrections::score::dun08_dir, "Name of dun08 dir" ).def("dun08");
option.add( basic::options::OptionKeys::corrections::score::dun02_file, "Name of dun02 input file" ).def("bbdep02.May.sortlib");
option.add( basic::options::OptionKeys::corrections::score::ch_o_bond_potential, "Name of ch_o_bond potential file (search in the local directory first, then look in the database)" ).def("ch_o_bond_potential.dat");
...
inline void add_rosetta_options_2( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::wum::n_masters, "Manual override for -n_slaves_per_master. How many master nodes should be spawned ? 1 by default. generall 1 for eery 256-512 cores is recommended depending on master workload" ).def(1);
...
inline void add_rosetta_options_3( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::AnchoredDesign::testing::VDW_weight, "centroid VDW weight; testing if 2 better than 1" ).lower(0).def(1.0);
...
option.add( basic::options::OptionKeys::HelixAssembly::helix_cap_distance_cutoff, "" );
option.add( basic::options::OptionKeys::HelixAssembly::helix_contact_distance_cutoff, "" );
...
option.add( basic::options::OptionKeys::pepspec::frag_file, "No description" ).def("filtered.vall.dat.2006-05-05.gz");
