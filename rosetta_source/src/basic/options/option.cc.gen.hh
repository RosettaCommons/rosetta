...
option.add( basic::options::OptionKeys::in::ignore_unrecognized_res, "Do not abort if unknown residues are found in PDB file;  instead, ignore them." ).def(false);
...
option.add( basic::options::OptionKeys::in::use_database, "Read in structures from database.  Specify database via -inout:database_filename and wanted structures with -in:file:tags" );
...
option.add( basic::options::OptionKeys::run::benchmark_scale, "Run in benchmark mode" ).def(1);
