...
typedef utility::pointer::owning_ptr< ResourceLocatorCreator > ResourceLocatorCreatorOP;
typedef utility::pointer::owning_ptr< ResourceLocatorCreator const > ResourceLocatorCreatorCOP;
