...
public:
	...
	void test_use_FallbackConfigFactory_to_get_loops_file() {
		...
		TS_ASSERT( loop_filename == loops_fallback->get_locator_id_from_description( "LoopsFile" ) );
		TS_ASSERT( "LoopsFile" == loops_fallback->get_loader_type_from_description( "LoopsFile" ) );
		TS_ASSERT( "LoopsFile_FallbackConfiguration" == loops_fallback->get_resource_tag_from_description( "LoopsFile" ) );
		TS_ASSERT( "" == loops_fallback->get_locator_tag_from_description( "LoopsFile" ) );
		TS_ASSERT( "" == loops_fallback->get_resource_options_tag_from_description( "LoopsFile" ) );
