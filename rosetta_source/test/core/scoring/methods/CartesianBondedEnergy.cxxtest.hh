...
class CartesianBondedEnergyTests : public CxxTest::TestSuite {
	...
	void test_cartbonded_start_score_start_func_match_w_total_flexibility()
	{
		...
		adv.validate_start_func_matches_start_score( 20.26177569390764, true );
