...
public:
  void setUp() {
	...
	void test_easy_construction_printing_hbond_set(){
		...
		#A    7  LEU  N  A    3  TYR  C    2.03  146.5  141.5 -122.2  1.000 -1.266
		#A    8  LYS  N  A    4  ILE  C    2.07  156.6  148.9 -115.6  1.000 -1.442
		#A    5  GLN  N  A    1  ASN  C    2.03  153.9  154.4 -143.8  1.000 -1.424
		#A    6  TRP  N  A    2  LEU  C    2.19  142.9  142.5 -149.9  1.000 -0.980
		#A    9  ASP  N  A    6  TRP  C    2.55  141.1   95.4 -106.5  1.000 -0.137
		#A   11  GLY  N  A    6  TRP  C    2.37  144.0  141.8  162.9  1.000 -0.393
