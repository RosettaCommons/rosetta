...
class Option_System_Manager:
    def __init__(self, current_directory=False):
        ...
        self.reset_options()
        if os.path.exists(self.pwd+"/local_settings.txt"):
            print "Loading personal option settings..."
            self.load_settings(self.pwd+"/local_settings.txt")
        
        else:
            print "Making local copy of settings..."
            os.system('cp '+self.pwd+"/settings.txt "+self.pwd+"/local_settings.txt")
            self.load_settings(self.pwd+"/local_settings.txt")
    ...
    #### Save/Load ####
        self.save_defaults_button = Button(self.main, text = "Save Defaults",command = lambda: self.save_settings(self.pwd+"/local_settings.txt"))
        self.load_defaults_button = Button(self.main, text="Load Defaults",command = lambda: self.load_settings(self.pwd+"/local_settings.txt"))
    ...
    def load_settings(self, path):
        if path != self.pwd+"/local_settings.txt":
    ...
    def clear_defaults(self):
        os.system('rm '+self.pwd+"/locla_settings.txt")
        self.reset_options()
    ...
    def save_settings(self, path):
        ...
        if path != self.pwd+"/locla_settings.txt":
