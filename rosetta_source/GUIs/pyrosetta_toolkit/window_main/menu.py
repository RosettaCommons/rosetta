...
class Menus():
	...
	self.score_menu.add_command(label = "Rescore PDBList + Output ScoredPDBList", command = lambda: output_tools.score_PDBLIST(self.toolkit.input_class.PDBLIST.get(), self.toolkit.score_class.score, False, self.toolkit.output_class))
