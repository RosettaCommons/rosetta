...
namespace stepwise { extern IntegerVectorOptionKey const working_res; }
...
namespace stepwise { namespace protein { extern BooleanOptionKey const disallow_backbone_sampling; } }
namespace stepwise { namespace protein { extern BooleanOptionKey const disable_sampling_of_loop_takeoff; } }
namespace stepwise { namespace protein { extern BooleanOptionKey const dump; } }
...
namespace stepwise { namespace protein { extern BooleanOptionKey const rescore_only; } }
namespace stepwise { namespace protein { extern StringOptionKey const min_type; } }
namespace stepwise { namespace protein { extern RealOptionKey const min_tolerance; } }
...
namespace stepwise { namespace protein { extern BooleanOptionKey const skip_minimize; } }
...
namespace stepwise { namespace protein { extern RealOptionKey const rmsd_screen; } }
...
namespace stepwise { namespace protein { extern BooleanOptionKey const protein_atr_rep_screen; } }
