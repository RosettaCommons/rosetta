...
namespace stepwise { namespace protein { BooleanOptionKey const disallow_backbone_sampling( "stepwise:protein:disallow_backbone_sampling" );  } }
...
namespace stepwise { namespace protein { BooleanOptionKey const dump( "stepwise:protein:dump" );  } }
...
namespace stepwise { namespace protein { BooleanOptionKey const rescore_only( "stepwise:protein:rescore_only" );  } }
...
namespace stepwise { namespace protein { BooleanOptionKey const skip_minimize( "stepwise:protein:skip_minimize" );  } }
...
namespace stepwise { namespace protein { RealOptionKey const rmsd_screen( "stepwise:protein:rmsd_screen" );  } }
...
namespace stepwise { namespace protein { BooleanOptionKey const protein_atr_rep_screen( "stepwise:protein:protein_atr_rep_screen" );  } }
