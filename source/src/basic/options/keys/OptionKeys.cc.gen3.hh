...
namespace optimization { BooleanOptionKey const new_sym_min( "optimization:new_sym_min" );  }
...
namespace stepwise { IntegerVectorOptionKey const working_res( "stepwise:working_res" );  }
...
namespace stepwise { namespace rna { BooleanOptionKey const allow_virtual_o2prime( "stepwise:rna:allow_virtual_o2prime" );  } }
...
namespace stepwise { namespace protein { StringOptionKey const min_type( "stepwise:protein:min_type" );  } }
namespace stepwise { namespace protein { RealOptionKey const min_tolerance( "stepwise:protein:min_tolerance" );  } }
...
namespace full_model { IntegerVectorOptionKey const virtual_res( "full_model:virtual_res" );  }
namespace full_model { IntegerVectorOptionKey const sample_res( "full_model:sample_res" );  }
namespace full_model { IntegerVectorOptionKey const calc_rms_res( "full_model:calc_rms_res" );  }
namespace full_model { namespace rna { BooleanOptionKey const rna( "full_model:rna" );  } }
namespace full_model { namespace rna { IntegerVectorOptionKey const terminal_res( "full_model:rna:terminal_res" );  } }
namespace full_model { namespace rna { IntegerVectorOptionKey const force_syn_chi_res_list( "full_model:rna:force_syn_chi_res_list" );  } }
namespace full_model { namespace rna { IntegerVectorOptionKey const force_north_sugar_list( "full_model:rna:force_north_sugar_list" );  } }
namespace full_model { namespace rna { IntegerVectorOptionKey const force_south_sugar_list( "full_model:rna:force_south_sugar_list" );  } }
...
namespace make_rot_lib { IntegerVectorOptionKey const two_fold_symetry_135_315( "make_rot_lib:two_fold_symetry_135_315" );  }
namespace make_rot_lib { IntegerVectorOptionKey const two_fold_symetry_0_180( "make_rot_lib:two_fold_symetry_0_180" );  }
namespace make_rot_lib { IntegerVectorOptionKey const three_fold_symetry_90_210_330( "make_rot_lib:three_fold_symetry_90_210_330" );  }
...
namespace bunsat_calc2 { RealOptionKey const probe_radius( "bunsat_calc2:probe_radius" );  }
namespace bunsat_calc2 { RealOptionKey const wobble( "bunsat_calc2:wobble" );  }
