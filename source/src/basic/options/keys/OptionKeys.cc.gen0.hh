...
namespace PCSTS5 { BooleanOptionKey const PCSTS5( "PCSTS5" );  }
namespace PCSTS5 { FileOptionKey const write_extra( "PCSTS5:write_extra" );  }
namespace PCSTS5 { IntegerOptionKey const normalization_id( "PCSTS5:normalization_id" );  }
namespace PCSTS6 { BooleanOptionKey const PCSTS6( "PCSTS6" );  }
namespace PCSTS6 { FileOptionKey const write_extra( "PCSTS6:write_extra" );  }
namespace PCSTS6 { IntegerOptionKey const normalization_id( "PCSTS6:normalization_id" );  }
namespace PCSTS7 { BooleanOptionKey const PCSTS7( "PCSTS7" );  }
namespace PCSTS7 { FileOptionKey const write_extra( "PCSTS7:write_extra" );  }
namespace PCSTS7 { IntegerOptionKey const normalization_id( "PCSTS7:normalization_id" );  }
namespace PCSTS8 { BooleanOptionKey const PCSTS8( "PCSTS8" );  }
namespace PCSTS8 { FileOptionKey const write_extra( "PCSTS8:write_extra" );  }
namespace PCSTS8 { IntegerOptionKey const normalization_id( "PCSTS8:normalization_id" );  }
namespace PCSTS9 { BooleanOptionKey const PCSTS9( "PCSTS9" );  }
namespace PCSTS9 { FileOptionKey const write_extra( "PCSTS9:write_extra" );  }
namespace PCSTS9 { IntegerOptionKey const normalization_id( "PCSTS9:normalization_id" );  }
