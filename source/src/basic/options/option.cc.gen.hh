...
option.add( basic::options::OptionKeys::PCSTS1::PCSTS1, "PCS option group" ).legal(true).def(true);
option.add( basic::options::OptionKeys::PCSTS1::write_extra, "Write into the File PCS calc, PCS exp, PCS dev, tensor informations, AT EACH ENERGY EVALUATION. More suited for rescoring" );
...
option.add( basic::options::OptionKeys::PCSTS2::PCSTS2, "PCS option group" ).legal(true).def(true);
option.add( basic::options::OptionKeys::PCSTS2::write_extra, "Write into the File PCS calc, PCS exp, PCS dev, tensor information, AT EACH ENERGY EVALUATION. More suited for rescoring" );
...
option.add( basic::options::OptionKeys::PCSTS3::PCSTS3, "PCS option group" ).legal(true).def(true);
option.add( basic::options::OptionKeys::PCSTS3::write_extra, "Write into the File PCS calc, PCS exp, PCS dev, tensor information, AT EACH ENERGY EVALUATION. More suited for rescoring" );
...
option.add( basic::options::OptionKeys::PCSTS4::PCSTS4, "PCS option group" ).legal(true).def(true);
option.add( basic::options::OptionKeys::PCSTS4::write_extra, "Write into the File PCS calc, PCS exp, PCS dev, tensor information, AT EACH ENERGY EVALUATION. More suited for rescoring" );
...
option.add( basic::options::OptionKeys::PCSTS5::PCSTS5, "PCS option group" ).legal(true).def(true);
option.add( basic::options::OptionKeys::PCSTS5::write_extra, "Write into the File PCS calc, PCS exp, PCS dev, tensor information, AT EACH ENERGY EVALUATION. More suited for rescoring" );
option.add( basic::options::OptionKeys::PCSTS5::normalization_id, "Normalize individual data set. The integer identify the normalization method to be used" );
option.add( basic::options::OptionKeys::PCSTS6::PCSTS6, "PCS option group" ).legal(true).def(true);
option.add( basic::options::OptionKeys::PCSTS6::write_extra, "Write into the File PCS calc, PCS exp, PCS dev, tensor information, AT EACH ENERGY EVALUATION. More suited for rescoring" );
option.add( basic::options::OptionKeys::PCSTS6::normalization_id, "Normalize individual data set. The integer identify the normalization method to be used" );
option.add( basic::options::OptionKeys::PCSTS7::PCSTS7, "PCS option group" ).legal(true).def(true);
option.add( basic::options::OptionKeys::PCSTS7::write_extra, "Write into the File PCS calc, PCS exp, PCS dev, tensor information, AT EACH ENERGY EVALUATION. More suited for rescoring" );
option.add( basic::options::OptionKeys::PCSTS7::normalization_id, "Normalize individual data set. The integer identify the normalization method to be used" );
option.add( basic::options::OptionKeys::PCSTS8::PCSTS8, "PCS option group" ).legal(true).def(true);
option.add( basic::options::OptionKeys::PCSTS8::write_extra, "Write into the File PCS calc, PCS exp, PCS dev, tensor information, AT EACH ENERGY EVALUATION. More suited for rescoring" );
option.add( basic::options::OptionKeys::PCSTS8::normalization_id, "Normalize individual data set. The integer identify the normalization method to be used" );
option.add( basic::options::OptionKeys::PCSTS9::PCSTS9, "PCS option group" ).legal(true).def(true);
option.add( basic::options::OptionKeys::PCSTS9::write_extra, "Write into the File PCS calc, PCS exp, PCS dev, tensor information, AT EACH ENERGY EVALUATION. More suited for rescoring" );
option.add( basic::options::OptionKeys::PCSTS9::normalization_id, "Normalize individual data set. The integer identify the normalization method to be used" );
...
option.add( basic::options::OptionKeys::stepwise::stepwise, "stepwise option group" ).legal(true).def(true);
...
option.add( basic::options::OptionKeys::stepwise::monte_carlo::monte_carlo, "monte_carlo option group" ).legal(true).def(true);
...
option.add( basic::options::OptionKeys::stepwise::rna::sample_res, "residues to build, the first element is the actual sample res while the other are the bulge residues" ).def();
option.add( basic::options::OptionKeys::stepwise::rna::sampler_native_rmsd_screen, "native_rmsd_screen ResidueSampler" ).def(false);
option.add( basic::options::OptionKeys::stepwise::rna::sampler_native_screen_rmsd_cutoff, "sampler_native_screen_rmsd_cutoff" ).def(2.0);
...
option.add( basic::options::OptionKeys::stepwise::rna::sampler_perform_phosphate_pack, "perform terminal phosphate packing inside StepWiseRNA_ResidueSampler" ).def(true);
...
option.add( basic::options::OptionKeys::stepwise::rna::finer_sampling_at_chain_closure, "Samplerer: finer_sampling_at_chain_closure" ).def(false);
option.add( basic::options::OptionKeys::stepwise::rna::PBP_clustering_at_chain_closure, "Samplerer: PBP_clustering_at_chain_closure" ).def(false);
option.add( basic::options::OptionKeys::stepwise::rna::sampler_allow_syn_pyrimidine, "sampler_allow_syn_pyrimidine" ).def(false);
option.add( basic::options::OptionKeys::stepwise::rna::sampler_extra_chi_rotamer, "Samplerer: extra_syn_chi_rotamer" ).def(false);
option.add( basic::options::OptionKeys::stepwise::rna::sampler_extra_beta_rotamer, "Samplerer: extra_beta_rotamer" ).def(false);
option.add( basic::options::OptionKeys::stepwise::rna::sampler_extra_epsilon_rotamer, "Samplerer: extra_epsilon_rotamer" ).def(true);
...
option.add( basic::options::OptionKeys::stepwise::rna::skip_sampling, "no sampling step in rna_swa residue sampling" ).def(false);
option.add( basic::options::OptionKeys::stepwise::rna::minimizer_perform_minimize, "minimizer_perform_minimize" ).def(true);
...
option.add( basic::options::OptionKeys::stepwise::rna::reinitialize_CCD_torsions, "Samplerer: reinitialize_CCD_torsions: Reinitialize_CCD_torsion to zero before every CCD chain closure" ).def(false);
option.add( basic::options::OptionKeys::stepwise::rna::sample_both_sugar_base_rotamer, "Samplerer: Super hacky for SQUARE_RNA" ).def(false);
option.add( basic::options::OptionKeys::stepwise::rna::sampler_include_torsion_value_in_tag, "Samplerer:include_torsion_value_in_tag" ).def(true);
...
option.add( basic::options::OptionKeys::stepwise::rna::do_not_sample_multiple_virtual_sugar, " Samplerer: do_not_sample_multiple_virtual_sugar " ).def(false);
option.add( basic::options::OptionKeys::stepwise::rna::sample_ONLY_multiple_virtual_sugar, " Samplerer: sample_ONLY_multiple_virtual_sugar " ).def(false);
...
option.add( basic::options::OptionKeys::stepwise::rna::minimizer_output_before_o2prime_pack, "minimizer_output_before_o2prime_pack" ).def(false);
option.add( basic::options::OptionKeys::stepwise::rna::minimizer_perform_o2prime_pack, "perform O2' hydrogen packing inside StepWiseRNA_Minimizer" ).def(true);
...
option.add( basic::options::OptionKeys::stepwise::rna::num_pose_minimize, "optional: set_num_pose_minimize by Minimizer" ).def(999999);
option.add( basic::options::OptionKeys::stepwise::rna::fixed_res, "Do not move these residues during minimization." ).def();
...
option.add( basic::options::OptionKeys::stepwise::rna::force_syn_chi_res_list, "optional: sample only syn chi for the res in sampler." ).def();
option.add( basic::options::OptionKeys::stepwise::rna::force_north_sugar_list, "optional: sample only north sugar for the res in sampler." ).def();
option.add( basic::options::OptionKeys::stepwise::rna::force_south_sugar_list, "optional: sample only south sugar for the res in sampler." ).def();
...
option.add( basic::options::OptionKeys::stepwise::rna::test_encapsulation, "Test ability StepWiseRNA Modeler to figure out what it needs from just the pose - no JobParameters" ).def(false);
...
option.add( basic::options::OptionKeys::stepwise::rna::terminal_res, "optional: residues that are not allowed to stack during sampling" ).def();
...
option.add( basic::options::OptionKeys::stepwise::rna::virtual_res, "optional: residues to be made virtual" ).def();
option.add( basic::options::OptionKeys::stepwise::rna::bulge_res, "optional: residues to be turned into a bulge variant" ).def();
