...
option.add( basic::options::OptionKeys::PCSTS1::PCSTS1, "PCSTS1 option group" ).legal(true).def(true);
...
option.add( basic::options::OptionKeys::PCSTS2::PCSTS2, "PCSTS2 option group" ).legal(true).def(true);
...
option.add( basic::options::OptionKeys::PCSTS3::PCSTS3, "PCSTS3 option group" ).legal(true).def(true);
...
option.add( basic::options::OptionKeys::PCSTS4::PCSTS4, "PCSTS4 option group" ).legal(true).def(true);
...
inline void add_rosetta_options_1( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::jumps::dump_frags, "dump jump_fragments " ).def(false);
...
option.add( basic::options::OptionKeys::score::rna_suite_potential, "In RNA calculation, directory containing suite potentials" ).def("");
...
option.add( basic::options::OptionKeys::score::use_membrane_rg, "use the modified RG score where RG calculated over input span centers of mass" ).def(false);
...
inline void add_rosetta_options_2( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::pose_metrics::interface_cutoff, "distance in angstroms (def. 10.0) for calculating what residues are at an interface via InterfaceNeighborDefinitionCalculator" ).def(10.0);
...
option.add( basic::options::OptionKeys::ddg::mut_file_tlc, "alternate specification for mutations using three letter codes instead of one letter codes so that it is compatible with noncanonical amino acids." ).def(false);
...
option.add( basic::options::OptionKeys::TailSegment::TailSegment, "TailSegment option group" ).legal(true).def(true);
...
inline void add_rosetta_options_3( utility::options::OptionCollection &option ) {option.add( basic::options::OptionKeys::remodel::remodel, "remodel option group" ).legal(true).def(true);
...
option.add( basic::options::OptionKeys::stepwise::working_res, "optional: residues in input pose in numbering of full-length pose. Used in clustering." ).def();
...
option.add( basic::options::OptionKeys::stepwise::rna::allow_virtual_o2prime, "allow O2' to be virtualized during packing." ).def(false);
...
option.add( basic::options::OptionKeys::stepwise::protein::protein, "protein option group" ).legal(true).def(true);
...
option.add( basic::options::OptionKeys::stepwise::protein::min_type, "Minimizer type" ).def("dfpmin_armijo_nonmonotone");
option.add( basic::options::OptionKeys::stepwise::protein::min_tolerance, "Minimizer tolerance" ).def(0.000025);
...
option.add( basic::options::OptionKeys::full_model::rna::rna, "rna option group" ).legal(true).def(true);
...
option.add( basic::options::OptionKeys::unfolded_state::unfolded_state, "unfolded_state option group" ).legal(true).def(true);
...
option.add( basic::options::OptionKeys::make_rot_lib::make_rot_lib, "make_rot_lib option group" ).legal(true).def(true);
option.add( basic::options::OptionKeys::make_rot_lib::options_file, "path to make rot lib options file" );
option.add( basic::options::OptionKeys::make_rot_lib::two_fold_symetry_135_315, "the chi number at which to apply two fold symetry across the 135/315 axis" );
option.add( basic::options::OptionKeys::make_rot_lib::two_fold_symetry_0_180, "the chi number at which to apply two fold symetry across the 0/180 axis" );
option.add( basic::options::OptionKeys::make_rot_lib::three_fold_symetry_90_210_330, "the chi number at which to apply two fold symetry across the 0/180 axis" );
option.add( basic::options::OptionKeys::cyclization::cyclization, "cyclization option group" ).legal(true).def(true);
...
option.add( basic::options::OptionKeys::bunsat_calc2::probe_radius, "Probe radius for SASA calculation" ).def(1.4);
option.add( basic::options::OptionKeys::bunsat_calc2::wobble, "Distance atoms can move towards or away from solvent. Value is subtracted from inner shell and added to outer shell for variable distance SASA." ).def(0.0);
