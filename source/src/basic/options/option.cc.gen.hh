...
option.add( basic::options::OptionKeys::stepwise::protein::disallow_backbone_sampling, "Just pack and minimize!" ).def(false);
...
option.add( basic::options::OptionKeys::stepwise::protein::dump, "Dump intermediate silent files" ).def(false);
...
option.add( basic::options::OptionKeys::stepwise::protein::rescore_only, "skip packing,clustering,minimizing -- just get scores & rmsds" ).def(false);
...
option.add( basic::options::OptionKeys::stepwise::protein::skip_minimize, "Skip minimize, e.g. in prepack step" ).def(false);
...
option.add( basic::options::OptionKeys::stepwise::protein::rmsd_screen, "keep sampled residues within this rmsd from the native pose" ).def(0.0);
...
option.add( basic::options::OptionKeys::stepwise::protein::protein_atr_rep_screen, "In packing, screen for contacts (but no clash) between partitions before packing" ).def(true);
