...
#			Option( 'fa_elec_co_only',   'Boolean', desc="Using only CO-CO interactions in fa_elec_bb_bb", default = 'false' ),
    ...
    Option_Group( 'water',
      ...
      Option( 'exclude_exposed', 'Boolean', desc='exclude point water rotamers with <= 16 CBs within 10 A', default='true'),
      Option( 'water_bump_check', 'Boolean', desc='exclude water rotamers that dont pass energy bump check', default='false' ),
      Option( 'lkb_overlap_distance', 'Real', desc='intersection distance when solvating with lkball sites', default='1.25' ),
      Option( 'lkb_cluster_radius', 'Real', desc='radius for clustering overlapping lkball sites', default='0.35' ),
      ...
      Option( 'record_dwell', 'Boolean', desc='record dwell time for all PWAT rotamers in FixbbPwatSimAnnealer', default='true' ),
      Option( 'print_dwell', 'Boolean', desc='create file with final raw PWAT dwell times from FixbbPwatSimAnnealer', default='false' ),
      Option( 'dwell_name', 'String', desc='file name for PWAT rotamer occupancies', default='dwell.log' ),
      Option( 'pack_temp', 'Real', desc="fixed annealing temperature", default='0.3' ),
      Option( 'spike_anneal', 'Boolean', desc='anneal with temp spikes after each outeriteration', default='true' ),
      Option( 'spike_steps_scale', 'Real', desc='scale for n_totalrot 100 K temp spikes samples during annealing', default='1.0' ),
      Option( 'spike_cycles', 'Integer', desc='number of rounds of temperature spiking for PWAT sampling', default='50' ),
      Option( 'innerit', 'Integer', desc='number of fixed temp annealing steps', default='250000' ),
      Option( 'dwell_cutoff', 'Real', desc='dwell time cutoff value for PWAT rotamers kept after normalizing by number of MC steps', default='0.1200' ),
      Option( 'cluster_radius', 'Real', desc='radius from dwell-weighted centroid for growing PWAT rotamer clusters', default='1.0' ),
      Option( 'cluster_cutoff', 'Real', desc='remove cluster if cumulative dwell time is not met', default='0.4000' ),
      Option( 'cluster_prefix', 'String', desc='prefix for rotset cutoff and centroid outputs', default="" ),
      Option( 'watlim_scale', 'Real', desc='scale factor for waters kept if using limit_water: scale factor * # molten residues', default='1.0' ),
      Option( 'print_clusters', 'Boolean', desc='option to turn on PWAT clustering', default='false' ),
      # options related to scoring PWAT and HOH residue types
      Option( 'pointwater_params', 'String', desc='PWAT: directory name for pointwater potential databases', default='norm_trunc6' ),
      Option( 'ordered_pt_wat_penalty', 'Real', desc='PWAT: Penalty for adding an ordered point water.  Implemented through pointwater scoreterm.', default='2.15037006642983' ),
      Option( 'pointwat_wat_bonus', 'Real', desc='PWAT: water-water bonus for nearby PWAT residues', default='0.810638995223315' ),
      Option( 'pointwat_wat_bonus_width', 'Real', desc='PWAT: factor determining width of water-water bonus exponential function', default='29.3807301999186' ),
      Option( 'ordered_wat_penalty', 'Real', desc='HOH: Penalty for adding an ordered water; implemented through ref scoreterm', default='1.7' ),
      Option( 'hbdon_H2O', 'Real', desc='hydrogen bond donor strength for HOH residues', default='1.15' ),
      Option( 'hbacc_H2O', 'Real', desc='hydrogen bond acceptor strength for HOH residues', default='1.15' ),
