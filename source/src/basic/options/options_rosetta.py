...
## --------------------------  END OF fragment picking --------------
  ...
  Option_Group('nonlocal',
	...
	Option_Group( 'score',
		...
		Option( 'facts_selfenergy_scale','Real', desc='Relative scale for FACTS self energy to pair energy', default="1.0" ),
		Option( 'facts_plane_to_self','Boolean', desc='Add atoms in same plane to self energy pairs', default="false" ),
		Option( 'facts_intrares_scale','Real', desc='Relative scale for FACTS intrares energy to interres energy', default="0.0" ),
		Option( 'facts_saltbridge_correction','Real', desc='FACTS Self energy parameter scaling factor for polarH', default="1.0" ),
		Option( 'facts_dshift','Real', desc='FACTS pair term denominator distance shift', default="0.0" ),
		Option( 'facts_die','Real', desc='FACTS dielectric constant', default="1.0" ),
		Option( 'facts_elec_sh_exponent','Real', desc='Shift function exponent for electrostatic part in FACTS', default="2.0" ),
