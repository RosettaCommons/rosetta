...
#		Option( 'msms_analysis', 'String', desc="Run MSMS on the structure and determine surface properties. " ),
    ...
    Option( 'data_file', 'String', desc="RDAT or legacy-format file with RNA chemical mapping data",default='' ),
		...
		Option_Group( 'farna',
		   ...
		   Option( 'params_file', 'String', desc= "Input file for pairings",default="default.prm" ),
       ...
       Option( 'vall_torsions', 'String', desc='Torsions file containing information on fragments from RNA models', default='rna.torsions' ),
          ...
          Option( 'extra_minimize_res', 'IntegerVector', desc= "Extra residues during minimize step",default=[]  ),
          Option( 'extra_minimize_chi_res', 'IntegerVector', desc= "Extra side-chain chis to move during minimize step",default=[]  ),
		 		), # -rna:farna:minimize
		), # -rna:farna
	), # -rna
