...
#			 Option( 'minimize_tensor', 'Boolean', desc = 'Optimize the best tensor found form the grid search'),
	...
	Option_Group( 'inout',
		...
		Option_Group('dbms',
		    ...
		    Option('separate_db_per_mpi_process','Boolean',desc="In MPI mode, open a separate sqlite3 database for each process with extension _<mpi_rank> and write partitioned schema to that database.", default='false'),
		    Option('database_partition','Integer',desc="Open a sepearte sqlite3 database with the extension _<partition> and write a partitioned schema to that database.",default='-1'),
