...
#		Option( 'minimizer_tol', 'Real', desc="tolerance for minimization", default='.0001'),
	...
	Option_Group( 'cyclic_peptide',
		...
		Option( 'MPI_batchsize_by_level', 'IntegerVector', desc="The number of jobs sent at a time by each communication level to its children.  Given N levels, N-1 values must be specified.  For example, given 3 communications levels, '100 10' would mean that the emperor sends 100 jobs at a time to each master, which sends 10 jobs at a time to each slave.  Must be specified for the helical_bundle_preidct and simple_cycpep_predict applications in MPI mode." ),
