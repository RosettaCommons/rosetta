...
#		Option( 'constraint_max', 'Real', default = '20.0', lower = '0', desc = 'highest value for constraint score (before and after minimization) that results in the rotamer being dropped'),
		...
		Option( 'fa_atr_rep_cutoff', 'Real', default = '0', desc = 'Value for ligand discovery cutoff for fa_atr_rep score function score'),
		...
		Option( 'ligand_wts_fxn_cutoff', 'Real', default = '0', desc = 'Value for ligand discovery cutoff for whole ligand.wts score function score'),
