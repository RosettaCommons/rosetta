...
#		Option( 'etable_lr'     , 'Real',   desc="lowers energy well at 6.5A" ),
    ...
    Option( 'fa_stack_lr_dist_cutoff' ,'Real', desc="distances below this get some lr stack.", default="7.5" ),
		...
		Option( 'hb_env_dep_new', 'Boolean', desc="Use new version of env-dep fading for hbond and fa_elec", default="false" ),
		Option( 'hb_env_dep_new_low_scale', 'Real', desc="For new version of env-dep fading, the lowend scale (as a fraction of buried strength)", default="0.2" ),
		Option( 'hb_env_dep_new_low_nneigh', 'Real', desc="For new version of env-dep fading, the number of 10A neighbors to be considered exposed", default="10" ),
		Option( 'hb_env_dep_new_high_nneigh', 'Real', desc="For new version of env-dep fading, the number of 10A neighbors to be considered buried", default="20" ),
