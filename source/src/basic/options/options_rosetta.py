...
#		Option('use_membrane_rg','Boolean',desc="use the modified RG score where RG calculated over input span centers of mass",default='false'),
    ...
    Option( 'allow_complex_loop_graph', 'Boolean', desc='LoopGraph hack - allow sharing of loops between cycles', default='false' ),
		...
		Option( 'aa_composition_setup_file', 'String', desc="The filename of a setup file for the aa_composition scoring term.  The default location for these files (which have a .comp extension) is /database/scoring/score_functions/aa_composition/.", default="sample_composition.comp" ),
