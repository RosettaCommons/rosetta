...
#		),
	...
	Option_Group( 'jd3',
		...
		Option( 'mpi_fraction_outputters', 'Real', desc='Fraction of the MPI nodes that node0 is allowed to use to output job results; non-archive nodes that output will also perform regular work in addition to their output work. This flag should range from 0 to 1. Note that node0 never outputs, so even if this is set to 0, one node will be deputized as an output node.', default='0.1' ),
