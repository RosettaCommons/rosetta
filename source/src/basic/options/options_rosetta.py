...
## --------------------------  END OF fragment picking --------------
  ...
  Option_Group('nonlocal',
	...
	Option_Group( 'score',
		...
		Option( 'rna_chem_map_lores_weight', 'Real', desc="In RNA lo-res chemical mapping scoring, final strength of rna_chem_map_lores term when -data_file is specified.", default="4.0"),
