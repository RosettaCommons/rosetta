...
#		Option( 'msms_analysis', 'String', desc="Run MSMS on the structure and determine surface properties. " ),
    ...
    Option( 'cut_at_rna_chainbreak', 'Boolean', desc="If O3' to P distance is > 2.5 Angstroms, assume cutpoint.",default='false' ),
		...
		Option_Group( 'denovo',
		   ...
		   Option( 'jump_library_file', 'String', desc= "Input file for jumps",default="1jj2_RNA_jump_library.dat" ),
                   Option( 'vall_torsions', 'String', desc='Torsions file containing information on fragments from RNA models', default='RICHARDSON_RNA09.torsions' ),
