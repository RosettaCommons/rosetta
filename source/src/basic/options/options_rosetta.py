...
#		Option( 'minimizer_tol', 'Real', desc="tolerance for minimization", default='.0001'),
	...
	Option_Group( 'cyclic_peptide',
		...
		Option( 'sample_cis_pro_frequency', 'Real', desc="The fraction of the time that omega=0 degrees is sampled at positions preceding L-proline or D-proline.  Defaults to no sampling at these positions.", default='0.0'),
