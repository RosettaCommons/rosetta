...
#		Option( 'minimizer_tol', 'Real', desc="tolerance for minimization", default='.0001'),
	...
	Option_Group( 'cyclic_peptide',
		...
		Option( 'MPI_auto_2level_distribution', 'Boolean', desc="If true, will automatically set up job distribution with one emperor talking to N-1 slaves, where N is the total number of processes.  Cannot be used with -MPI_processes_by_level.  Default false.", default='false' ),
		...
		Option( 'threads_per_slave', 'Integer', desc="In the multi-threaded MPI compilation, this is the number of threads to launch per slave process.  Note that emperor and master-layer processes do not launch threads.  A value of 1 (the default) means that only standard hierarchical process-based parallelism will be used.  In non-MPI or non-threaded compilations, this option is unused.", default='1' ),
