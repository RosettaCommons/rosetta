		...
		Option_Group( 'file',
		  ...
		  Option( 'silent', 'FileVector', desc = 'silent input filename(s)',default=[]),
			...
			Option( 'ddg_predictions_file', 'File',
					...
					default=''),
		  Option( 'input_res', 'IntegerVector', desc='Residues already present in starting file',default=[]),
...
## --------------------------  END OF fragment picking --------------
  ...
  Option_Group('nonlocal',
	...
	Option_Group( 'score',
		...
		Option( 'rama_score_nonstandard_connections', 'Boolean', desc='Should the rama scorefunction score residues that are connected in unusual ways (e.g. to residues that are not adjacent in linear sequence, or by backbone-to-sidechain connections)?', default='false'),
		...
		Option( 'geom_sol_correct_acceptor_base', 'Boolean', desc="Fixed definition of base atom for acceptors to match hbonds_geom", default='true'),
...
# Solid state NMR orientational constraints
   ...
   Option_Group('dc',
	...
	Option_Group( 'stepwise',
		...
		Option( 'working_res', 'IntegerVector', desc="optional: residues in input pose in numbering of full-length pose. Used in clustering.", default=[] ),
    ...
    Option_Group( 'rna',
      ...
      Option( 'missing_res', 'IntegerVector', desc='Residues missing in starting pose_1, alternative to input_res',default=[] ),
	    ...
	    Option( 'force_syn_chi_res_list', 'IntegerVector', desc="optional: sample only syn chi for the res in sampler.", default=[] ),
	    Option( 'force_north_sugar_list', 'IntegerVector', desc="optional: sample only north sugar for the res in sampler.", default=[] ),
	    Option( 'force_south_sugar_list', 'IntegerVector', desc="optional: sample only south sugar for the res in sampler.", default=[] ),
    ...
    Option_Group( 'protein',
	    ...
	    Option( 'disallow_backbone_sampling', 'Boolean', desc="Just pack and minimize!",default="false" ),
	    ...
	    Option( 'dump', 'Boolean', desc="Dump intermediate silent files",default="false" ),
	    ...
	    Option( 'rescore_only', 'Boolean', desc="skip packing,clustering,minimizing -- just get scores & rmsds",default="false" ),
	    ...
	    Option( 'expand_loop_takeoff', 'Boolean', desc="expand -sample_res loop to include connection to previous/next residues",default="false" ),
		  ...
		  Option( 'protein_atr_rep_screen', 'Boolean', desc='In packing, screen for contacts (but no clash) between partitions before packing',default='true' ),
	),
	),
    ...
    Option( 'virtual_res', 'IntegerVector', desc="optional: residues for defining virtual residues", default=[] ),
		Option( 'sample_res', 'IntegerVector', desc="residues to build (for SWA, the first element is the actual sample res while the other are the bulge residues)", default=[] ),
		Option( 'calc_rms_res', 'IntegerVector', desc="residues over which to calculate rms for SWA. Not in wide use anymore.", default=[] ),
	),
