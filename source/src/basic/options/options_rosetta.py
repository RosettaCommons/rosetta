...
#			 Option( 'minimize_tensor', 'Boolean', desc = 'Optimize the best tensor found form the grid search'),
    ...
    Option( 'extra_eggshell_dist',	     'Real',default='5',desc='Distance to extend extra eggshell points'),
	...
	Option_Group('antibody',
      ...
      Option('do_graft_design', 'Boolean',
			...
			Option('top_graft_designs', 'Integer',
				desc='Number of top graft designs to keep (ensemble).  These will be written to a PDB and move onto the next step in the protocol.',
				default='10'),
			Option('dump_post_graft_designs', 'Boolean',
				desc='Write the top ensembles to file after the graft-design step.',
				default='false'
			),
			...
			Option('dock_post_graft', 'Boolean',
				desc='Run a short lowres docking step after each graft and before any minimization.',
				default='false'),
