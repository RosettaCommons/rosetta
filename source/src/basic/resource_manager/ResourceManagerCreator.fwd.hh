...
typedef utility::pointer::owning_ptr< ResourceManagerCreator > ResourceManagerCreatorOP;
typedef utility::pointer::owning_ptr< ResourceManagerCreator const > ResourceManagerCreatorCOP;
