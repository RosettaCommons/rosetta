...
)
{
	...
	**********************************************************/
	...
	if ( option[ hddm::final_design_min].value() ) {
		...
		minimization_packing::PackRotamersMoverOP final_desn_pr( minimization_packing::PackRotamersMoverOP( new minimization_packing::PackRotamersMover(score_fxn, final_desn_pt, 10 ) ) );
