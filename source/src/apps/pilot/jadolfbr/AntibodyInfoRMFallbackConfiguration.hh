...
/// @file   protocols/looops/AntibodyInfoRMFallbackConfiguration.hh
/// @author Michael Pacella mpacella88@gmail.com

#ifndef INCLUDED_protocols_antibody_surface_vector_fallback_configuration_HH
#define INCLUDED_protocols_antibody_surface_vector_fallback_configuration_HH

// Unit Header
#include <protocols/antibody/AntibodyInfoRMFallbackConfiguration.fwd.hh>
...
class AntibodyInfoRMFallbackConfiguration : public basic::resource_manager::FallbackConfiguration {
public:
	typedef basic::resource_manager::ResourceDescription ResourceDescription;
public:
	AntibodyInfoRMFallbackConfiguration();
...
#endif // INCLUDED_protocols_antibody_surface_vector_fallback_configuration_HH
