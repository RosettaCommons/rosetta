...
//#include <protocols/farna/RNA_DenovoParameters.hh>
...
main( int argc, char * argv [] )
{
	try {
		...
		NEW_OPT( angle_range_bb, "range bb torsions are allowed to move", 180 );
		NEW_OPT( angle_range_chi, "range chi torsions are allowed to move", 180 );
