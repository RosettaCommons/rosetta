...
/// @brief Mutate a residue, hijacking one of the mp:mutate_relax flags
...
static THREAD_LOCAL basic::Tracer TR( "apps.pilot.jkleman.mutate" );
...
main( int argc, char * argv [] )
{
	try {
		...
		if ( ! option[ OptionKeys::mp::mutate_relax::mutation ].user() ) {
			...
			utility_exit_with_message("No mutations given. Use flag -mp:mutate_relax:mutation. Quitting.");
		} else {
