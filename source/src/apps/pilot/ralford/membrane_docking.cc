...
public: 
	...
	void apply( Pose & pose ) {
		...
		ScoreFunctionOP mpdocking_low = ScoreFunctionFactory::create_score_function("cen_membrane_2014");
		ScoreFunctionOP mpdocking_high = ScoreFunctionFactory::create_score_function("fa_membrane_2014");
