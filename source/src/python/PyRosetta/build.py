...
def create_package(rosetta_source_path, path):
    ...
    for f in 'self-test.py PyMOL-RosettaServer.py PyMOL-RosettaServer.python3.py PyMOL-Rosetta-relay-client.python3.py'.split(): shutil.copy(rosetta_source_path + '/src/python/PyRosetta/src/' + f, path)
