...
//extern template void Base::foo(A &);
//extern template void Base::foo(A &);
//extern template void Base::foo(B &);
extern template void Base::foo(bool &);


extern template void Base::emplace(int &, double &);


extern template void Base::naa(bool &, float&);
