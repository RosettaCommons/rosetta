...
class TestInitFileSigner(unittest.TestCase):
    def test_init_file_signer(self):
        with tempfile.TemporaryDirectory() as workdir:
            ...
            metadata = {"comment": "foo", "idx_input": "bar", "idx_output": 10, "sha256": "test", "signature": 123}
            ...
            with self.assertRaises(TypeError):  # Fails because metadata 'idx_input' value is a `str` object
            ...
            metadata = {"comment": "bar", "idx_input": -5, "idx_output": 10, "sha256": None, "signature": None}
            verify_init_file(
                output_init_file,
                input_packed_pose=input_packed_pose,
                output_packed_pose=output_packed_pose,
            ...
            with self.assertRaises(IndexError):  # Fails since metadata 'idx_input' and 'idx_output' values are out of range
                _ = get_poses_from_init_file(output_init_file, verify=False)

            metadata = {"comment": "baz", "idx_input": 1, "idx_output": 1, "sha256": 256}
            ...
            metadata = {"comment": "baz", "idx_input": 0, "idx_output": 0}
            verify_init_file(
                output_init_file,
                input_packed_pose=input_packed_pose,
                output_packed_pose=output_packed_pose,
            ...
            metadata = {"comment": "baz", "idx_input": 1, "idx_output": 0, "signature": "test"}
