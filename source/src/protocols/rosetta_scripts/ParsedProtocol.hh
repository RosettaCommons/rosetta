...
public:
  ...
  void add_mover( protocols::moves::MoverCOP mover, std::string const& mover_name, protocols::filters::FilterOP filter, core::Real const& apply_probability );
  ...
  std::string const& mode() const{ return mode_; }
  iterator begin();
  const_iterator begin() const;
  iterator end();
  const_iterator end() const;
  void check_apply_probabilities();
  utility::vector1< core::Real > apply_probability() const;
  void apply_probability( utility::vector1< core::Real > const& );
...
private:
  ...
  virtual moves::MoverOP parse_subtag( TagCOP const& tag,
                                       TagCOP const& supertag,
                                       basic::datacache::DataMap &data,
                                       protocols::filters::Filters_map const &filters,
                                       protocols::moves::Movers_map const &movers );
  virtual void mode( std::string const& mode_in );
private:
