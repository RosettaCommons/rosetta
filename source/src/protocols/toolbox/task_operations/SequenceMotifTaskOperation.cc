...
#include <protocols/toolbox/task_operations/SequenceMotifTaskOperationCreator.hh>
...
static basic::Tracer TR( "protocols.toolbox.task_operations.SequenceMotifTaskOperation" );
