...
#ifndef INCLUDED_protocols_toolbox_task_operations_StoreCompoundTaskMover_fwd_hh
#define INCLUDED_protocols_toolbox_task_operations_StoreCompoundTaskMover_fwd_hh
