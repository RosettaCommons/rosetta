...
/// @file protocols/toolbox/task_operations/ResfileCommandOperation
/// @brief Applies the equivalent of a resfile line (without the resnums) to residues specified in a residue selector.
/// @author Jared Adolf-Bryfogle (jadolfbr@gmail.com)


#ifndef INCLUDED_protocols_toolbox_task_operations_ResfileCommandOperation_hh
#define INCLUDED_protocols_toolbox_task_operations_ResfileCommandOperation_hh

#include <protocols/toolbox/task_operations/ResfileCommandOperation.fwd.hh>
...
#endif //INCLUDED_protocols/toolbox/task_operations_ResfileCommandOperation_fwd_hh
