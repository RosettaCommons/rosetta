...
#include <protocols/toolbox/task_operations/ResfileCommandOperation.hh>
#include <protocols/toolbox/task_operations/ResfileCommandOperationCreator.hh>
...
static basic::Tracer TR( "protocols.toolbox.task_operations.ResfileCommandOperation" );
