...
/// @file   protocols/toolbox/task_operations/RestrictInterGroupVectorOperation.fwd.hh
/// @brief
/// @author  Ben Stranges stranges@unc.edu

#ifndef INCLUDED_protocols_toolbox_task_operations_RestrictInterGroupVectorOperation_fwd_hh
#define INCLUDED_protocols_toolbox_task_operations_RestrictInterGroupVectorOperation_fwd_hh
