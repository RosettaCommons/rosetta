...
typedef utility::pointer::owning_ptr< LoopsExplicitDefiner > LoopsExplicitDefinerOP;
typedef utility::pointer::owning_ptr< LoopsExplicitDefiner const > LoopsExplicitDefinerCOP;
