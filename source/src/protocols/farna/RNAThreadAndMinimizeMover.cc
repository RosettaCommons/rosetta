...
// Unit headers
#include <protocols/farna/RNAThreadAndMinimizeMover.hh>
#include <protocols/farna/RNAThreadAndMinimizeMoverCreator.hh>
...
static THREAD_LOCAL basic::Tracer TR( "protocols.farna.RNAThreadAndMinimizeMover" );
