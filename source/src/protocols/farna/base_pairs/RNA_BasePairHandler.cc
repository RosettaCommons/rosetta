...
/// @file protocols/farna/base_pairs/RNA_BasePairHandler.cc
/// @brief
/// @details
...
static basic::Tracer TR( "protocols.farna.base_pairs.RNA_BasePairHandler" );
	...
	Real const suppress_bp_constraint /* = 1.0 */ ) const
{
	...
	protocols::farna::setup_base_pair_constraints( pose, pairings, suppress_bp_constraint );
}
