...
/// @file src/protocols/farna/thermal_sampling/util.hh
/// @brief
/// @details
///
/// @author Andy Watkins
...
#ifndef INCLUDED_protocols_farna_thermal_sampling_util_HH
#define INCLUDED_protocols_farna_thermal_sampling_util_HH
