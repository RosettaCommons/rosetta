...
public:
	...
	get_lowest_scoring_abbreviated_assembly() const;
	...
	void
	set_lowest_scoring_abbreviated_assembly( utility::vector1< data_storage::BasisPair > abbreviated_assembly );
	//shouldn't use this one either...
	void
