...
utility::vector1< data_storage::BasisPair >
AssemblyMover::get_lowest_scoring_abbreviated_assembly() const{
	return lowest_scoring_assembly_;
}
...
void
AssemblyMover::set_lowest_scoring_abbreviated_assembly( utility::vector1< data_storage::BasisPair > abbreviated_assembly ){
	lowest_scoring_assembly_ = abbreviated_assembly;
}
