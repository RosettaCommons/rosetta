...
/// @file GlobalRequirement.hh
///
/// @brief An interface for all SEWING requirements concerning an entire assembly
/// @author Frank Teets

#ifndef INCLUDED_protocols_sewing_sampling_requirements_GlobalRequirement_hh
#define INCLUDED_protocols_sewing_sampling_requirements_GlobalRequirement_hh
...
class GlobalRequirement : public utility::pointer::ReferenceCount {
