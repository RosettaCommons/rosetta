...
#include <protocols/replica_docking/IrmsdFilter.hh>
#include <protocols/replica_docking/IrmsdFilterCreator.hh>
...
static basic::Tracer TR( "protocols.replica_docking.IrmsdFilter" );
