...
/// @brief
/// @author Zhe Zhang
#ifndef INCLUDED_protocols_replica_docking_AddEncounterConstraintMover_hh
#define INCLUDED_protocols_replica_docking_AddEncounterConstraintMover_hh

#include <protocols/replica_docking/AddEncounterConstraintMover.fwd.hh>
