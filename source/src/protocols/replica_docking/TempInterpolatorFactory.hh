...
#ifndef INCLUDED_protocols_replica_docking_TempInterpolatorFactory_hh
#define INCLUDED_protocols_replica_docking_TempInterpolatorFactory_hh

// Unit Headers
#include <protocols/replica_docking/TempInterpolatorFactory.fwd.hh>
