...
#include <protocols/replica_docking/FrozenSidechainsMover.hh>
#include <protocols/replica_docking/FrozenSidechainsMoverCreator.hh>
...
static basic::Tracer tr( "protocols.replica_docking.FrozenSidechainsMover" );
