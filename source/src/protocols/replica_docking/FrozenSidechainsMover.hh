...
#ifndef INCLUDED_protocols_replica_docking_FrozenSidechainsMover_hh
#define INCLUDED_protocols_replica_docking_FrozenSidechainsMover_hh

#include <protocols/replica_docking/FrozenSidechainsMover.fwd.hh>
