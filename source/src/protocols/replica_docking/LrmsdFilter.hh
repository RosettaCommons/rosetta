...
#ifndef INCLUDED_protocols_replica_docking_LrmsdFilter_hh
#define INCLUDED_protocols_replica_docking_LrmsdFilter_hh

#include <protocols/replica_docking/LrmsdFilter.fwd.hh>
