...
#include <protocols/replica_docking/FnonnatFilter.hh>
#include <protocols/replica_docking/FnonnatFilterCreator.hh>
...
static basic::Tracer TR( "protocols.replica_docking.FnonnatFilter" );
