...
#ifndef INCLUDED_protocols_replica_docking_IrmsdFilter_hh
#define INCLUDED_protocols_replica_docking_IrmsdFilter_hh

#include <protocols/replica_docking/IrmsdFilter.fwd.hh>
