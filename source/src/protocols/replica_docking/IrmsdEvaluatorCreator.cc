...
// Unit Headers
#include <protocols/replica_docking/WrapFilterAsEvaluatorCreator.hh>
...
#include <protocols/replica_docking/IrmsdEvaluator.hh>
...
static basic::Tracer tr( "protocols.replica_docking.IrmsdEvaluatorCreator" );
