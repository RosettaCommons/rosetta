...
#ifndef INCLUDED_protocols_replica_docking_FnatFilter_hh
#define INCLUDED_protocols_replica_docking_FnatFilter_hh

#include <protocols/replica_docking/FnatFilter.fwd.hh>
