...
/// @file /protocols.replica_docking/TempWeightedMetropolisHastingsMover.hh
...
#ifndef INCLUDED_protocols_replica_docking_TempWeightedMetropolisHastingsMover_hh
#define INCLUDED_protocols_replica_docking_TempWeightedMetropolisHastingsMover_hh
...
class TempWeightedMetropolisHastingsMover : public protocols::canonical_sampling::MetropolisHastingsMover {
	typedef utility::vector1< protocols::replica_docking::TempInterpolatorBaseOP > Interpolators;
