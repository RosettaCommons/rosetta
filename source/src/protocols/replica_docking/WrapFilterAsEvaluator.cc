...
// Unit Headers
#include <protocols/replica_docking/WrapFilterAsEvaluator.hh>

// Package Headers

#include <protocols/replica_docking/InteractionScoreFilter.hh>
#include <protocols/replica_docking/InteractionScoreFilter.fwd.hh>
// Project Headers
...
//#include <protocols/replica_docking/AddEncounterConstraintMover.hh>
...
static basic::Tracer tr( "protocols.replica_docking.WrapFilterAsEvaluator" );
...
{
	// iscfilter_ = new protocols::replica_docking::InteractionScoreFilter( scorefxn_name );
	filter_ = filter;
