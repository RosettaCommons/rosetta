...
#ifndef INCLUDED_protocols_replica_docking_ModulatedMover_hh
#define INCLUDED_protocols_replica_docking_ModulatedMover_hh
...
#include <protocols/replica_docking/TempInterpolator.hh>
#include <protocols/replica_docking/TempInterpolator.fwd.hh>
...
class ModulatedMover : public protocols::canonical_sampling::ThermodynamicMover {
	...
	//  typedef std::map< std::string, protocols::replica_docking::TempInterpolatorOP > Interpolators;
	typedef std::map< std::string, protocols::replica_docking::TempInterpolatorBaseOP > Interpolators;
