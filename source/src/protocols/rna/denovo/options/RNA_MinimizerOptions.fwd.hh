...
/// @file protocols/rna/denovo/options/RNA_MinimizerOptions.fwd.hh
/// @brief
/// @details
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_farna_RNA_MinimizerOptions_FWD_HH
#define INCLUDED_protocols_farna_RNA_MinimizerOptions_FWD_HH
