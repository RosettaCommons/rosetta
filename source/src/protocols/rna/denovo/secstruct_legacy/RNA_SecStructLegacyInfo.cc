...
#include <protocols/rna/denovo/secstruct_legacy/RNA_SecStructLegacyInfo.fwd.hh>
...
void
protocols::rna::denovo::secstruct_legacy::RNA_SecStructLegacyInfo::save( Archive & arc ) const {
...
template< class Archive >
void
protocols::rna::denovo::secstruct_legacy::RNA_SecStructLegacyInfo::load( Archive & arc ) {
	arc( cereal::base_class< basic::datacache::CacheableData >( this ) );
	arc( rna_secstruct_legacy_ ); // std::string
}

SAVE_AND_LOAD_SERIALIZABLE( protocols::rna::denovo::secstruct_legacy::RNA_SecStructLegacyInfo );
CEREAL_REGISTER_TYPE( protocols::rna::denovo::secstruct_legacy::RNA_SecStructLegacyInfo )
