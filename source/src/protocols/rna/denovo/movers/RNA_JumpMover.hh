...
/// @file protocols/rna/denovo/movers/RNA_JumpMover.hh
/// @brief
/// @details
...
public:
	...
	//constructor
	RNA_JumpMover( protocols::rna::denovo::libraries::RNA_JumpLibraryCOP rna_jump_library,
...
private:
	...
	protocols::rna::denovo::libraries::RNA_JumpLibraryCOP rna_jump_library_;
