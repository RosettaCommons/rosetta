...
/// @file protocols/rna/denovo/setup/RNA_DeNovoParameters.fwd.hh
/// @brief
/// @details
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_farna_RNA_DeNovoParameters_FWD_HH
#define INCLUDED_protocols_farna_RNA_DeNovoParameters_FWD_HH
