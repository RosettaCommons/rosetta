...
/// @file protocols/rna/denovo/setup/RNA_DeNovoSetup.hh
/// @brief
/// @detailed
...
#include <protocols/rna/denovo/setup/RNA_DeNovoSetup.fwd.hh>
...
private:
	...
	protocols::rna::denovo::options::RNA_DeNovoProtocolOptionsOP options_;
	protocols::rna::denovo::setup::RNA_DeNovoParametersOP rna_params_;
