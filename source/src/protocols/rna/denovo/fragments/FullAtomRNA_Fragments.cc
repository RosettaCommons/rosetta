...
#include <protocols/rna/denovo/util.hh> // for compare_RNA_char, compare_RNA_secstruct
	...
	Size const type /* = MATCH_YR */) const
{
	...
	std::string const & RNA_secstruct( secstruct_legacy::get_rna_secstruct_legacy( pose ) );
