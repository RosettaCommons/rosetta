...
///
void
HierarchicalHybridJD_JobResultsSummary::set_originating_node_MPI_rank(
	int const rank
) {
...
///
void
HierarchicalHybridJD_JobResultsSummary::set_jobindex_on_originating_node(
...
void
HierarchicalHybridJD_JobResultsSummary::add_MPI_rank_handling_message(
	int const new_proc
) {
