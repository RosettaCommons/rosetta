...
public:
	...
	// XRW TEMP  virtual std::string get_name() const { return "OopDockDesignProtocol"; }
	protocols::moves::MoverOP fresh_instance() const override { return OopDockDesignProtocolOP( new OopDockDesignProtocol ); }
