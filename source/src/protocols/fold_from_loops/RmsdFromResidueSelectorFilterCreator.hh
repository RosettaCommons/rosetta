...
#ifndef INCLUDED_protocols_fold_from_loops_RmsdFromResidueSelectorFilterCreator_hh
#define INCLUDED_protocols_fold_from_loops_RmsdFromResidueSelectorFilterCreator_hh
