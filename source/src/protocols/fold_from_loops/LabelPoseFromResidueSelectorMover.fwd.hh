...
#ifndef INCLUDED_protocols_fold_from_loops_LabelPoseFromResidueSelectorMover_fwd_hh
#define INCLUDED_protocols_fold_from_loops_LabelPoseFromResidueSelectorMover_fwd_hh
