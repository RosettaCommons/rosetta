...
#ifndef INCLUDED_protocols_fold_from_loops_LabelPoseFromResidueSelectorMoverCreator_hh
#define INCLUDED_protocols_fold_from_loops_LabelPoseFromResidueSelectorMoverCreator_hh
