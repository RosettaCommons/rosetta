...
#ifndef INCLUDED_protocols_fold_from_loops_SegmentedAtomPairConstraintGeneratorCreator_hh
#define INCLUDED_protocols_fold_from_loops_SegmentedAtomPairConstraintGeneratorCreator_hh
