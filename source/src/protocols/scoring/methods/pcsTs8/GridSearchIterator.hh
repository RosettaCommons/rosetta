...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs8_GridSearchIterator_hh
#define INCLUDED_protocols_scoring_methods_pcsTs8_GridSearchIterator_hh
...
class GridSearchIterator_Ts8 : public utility::pointer::ReferenceCount {
public:
	GridSearchIterator_Ts8();

	~GridSearchIterator_Ts8();

	GridSearchIterator_Ts8(GridSearchIterator_Ts8 const & other);

	GridSearchIterator_Ts8 &
	operator=(GridSearchIterator_Ts8 const & other);

	GridSearchIterator_Ts8(numeric::xyzVector< core::Real > const coo1,
