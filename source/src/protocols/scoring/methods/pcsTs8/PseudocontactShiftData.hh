...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs8_PseudocontactShiftData_hh
#define INCLUDED_protocols_scoring_methods_pcsTs8_PseudocontactShiftData_hh

// Package headers
#include <protocols/scoring/methods/pcsTs8/PseudocontactShiftInput.fwd.hh>
...
public:
	//PCS_data_per_lanthanides_Ts8(std::string, PCS_file_data_Ts8 & P_f_d, core::Real const weight);

	PCS_data_per_lanthanides_Ts8(std::string, core::Real const weight, utility::vector1< PCS_line_data_Ts8 > & PCS_d_l_a);
...
public:
	...
	PCS_data_per_lanthanides_Ts8(PCS_data_per_lanthanides_Ts8 const &other);

	PCS_data_per_lanthanides_Ts8 &
	operator=( PCS_data_per_lanthanides_Ts8 const & other );
	...
	*/
	...
	core::Real
	calculate_tensor_and_cost_with_svd(PCS_tensor_Ts8 &PCS_t);

	//core::Real calculate_tensor_and_cost_with_svd_precalc(PCS_tensor_Ts8 &PCS_t);
};



class PCS_data_Ts8 : public basic::datacache::CacheableData {
private:
	core::Size n_lanthanides_;
	core::Size n_pcs_spin_;
	utility::vector1<PCS_line_data_Ts8> PCS_data_line_all_spin_;
	utility::vector1<PCS_data_per_lanthanides_Ts8> PCS_data_per_lanthanides_all_;
...
public:
	...
	PCS_data_Ts8(PCS_data_input_Ts8 & P_d_i);

	PCS_data_Ts8(PCS_data_input_Ts8 & P_d_i, utility::vector1< bool > const exclude_residues );

	PCS_data_Ts8(PCS_data_Ts8 const &other);

	PCS_data_Ts8 &
	operator=( PCS_data_Ts8 const & src );
	...
	core::Size
	where_is_line(PCS_line_data_Ts8 & P_l_d);
