...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs8_TensorsOptimizer_hh
#define INCLUDED_protocols_scoring_methods_pcsTs8_TensorsOptimizer_hh
...
class TensorsOptimizer_Ts8 : public core::optimization::Multifunc {

public:
	PCS_data_Ts8 const & pcs_d_;

  TensorsOptimizer_Ts8();

  TensorsOptimizer_Ts8(PCS_data_Ts8 const & pcs_d);
