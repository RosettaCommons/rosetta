...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs8_PseudocontactShiftTensor_hh
#define INCLUDED_protocols_scoring_methods_pcsTs8_PseudocontactShiftTensor_hh
...
public:
	...
	PCS_tensor_Ts8(PCS_tensor_Ts8 const & other);

	PCS_tensor_Ts8 &
	operator=(PCS_tensor_Ts8 const & other);

  PCS_tensor_Ts8(  core::Real const chi_xx,
  ...
  core::Real
	...
	void
	copy_from_ref(PCS_tensor_Ts8 & other);
