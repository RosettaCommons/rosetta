...
basic::Tracer TR_pcs_d_p_l_Ts1("protocols.scoring.methods.pcsTs1.PCS_data_per_lanthanides_Ts1");
basic::Tracer TR_pcs_d_Ts1("protocols.scoring.methods.pcsTs1.PCS_data_Ts1");
...
PCS_data_per_lanthanides_Ts1::PCS_data_per_lanthanides_Ts1():
	filename_(""), weight_(0)
{
	utility_exit_with_message( "You shouldn't call the empty constructor for PCS_data_per_lanthanides_Ts1 class" );
}
...
PCS_data_per_lanthanides_Ts1::get_normalization_factor() const{
	...
	/*
core::Real
PCS_data_per_lanthanides_Ts1::get_normalization_1() const{
	return normalization_1_;
}

core::Real
PCS_data_per_lanthanides_Ts1::get_normalization_2() const{
	return normalization_2_;
}

core::Real
PCS_data_per_lanthanides_Ts1::get_normalization_3() const{
...
PCS_data_Ts1::PCS_data_Ts1(PCS_data_Ts1 const &other):
	CacheableData()
{
	n_lanthanides_ = other.n_lanthanides_;
	n_pcs_spin_ = other.n_pcs_spin_;
...
void
PCS_data_per_lanthanides_Ts1::print_index_A() const{
	core::Size i;
	for (i = 1; i <= n_pcs_; ++i){
		TR_pcs_d_p_l_Ts1 << i << " -> "  <<A_index_[i] << std::endl;
	}
}
*/
...
// 	utility::vector1<PCS_line_data_Ts1> & PCS_d_l_a = PCS_f_d.get_PCS_data_line_all_reference();
