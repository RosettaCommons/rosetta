...
// Package headers
#include <protocols/scoring/methods/pcsTs1/PseudocontactShiftInput.fwd.hh>
...
public:
	...
	PCS_data_per_lanthanides_Ts1(std::string, core::Real const weight, utility::vector1< PCS_line_data_Ts1 > & PCS_d_l_a);
...
public:
	...
	PCS_data_Ts1(PCS_data_Ts1 const &other);

	PCS_data_Ts1 &
	operator=( PCS_data_Ts1 const & src );
