...
static THREAD_LOCAL basic::Tracer TR_pcs_d_p_l( "protocols.scoring.methods.pcs.PCS_data_per_lanthanides" );
static THREAD_LOCAL basic::Tracer TR_pcs_d( "protocols.scoring.methods.pcs.PCS_data" );
