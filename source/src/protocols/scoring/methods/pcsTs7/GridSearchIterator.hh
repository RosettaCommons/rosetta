...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs7_GridSearchIterator_hh
#define INCLUDED_protocols_scoring_methods_pcsTs7_GridSearchIterator_hh
...
class GridSearchIterator_Ts7 : public utility::pointer::ReferenceCount {
public:
	GridSearchIterator_Ts7();

	~GridSearchIterator_Ts7();

	GridSearchIterator_Ts7(GridSearchIterator_Ts7 const & other);

	GridSearchIterator_Ts7 &
	operator=(GridSearchIterator_Ts7 const & other);

	GridSearchIterator_Ts7(numeric::xyzVector< core::Real > const coo1,
