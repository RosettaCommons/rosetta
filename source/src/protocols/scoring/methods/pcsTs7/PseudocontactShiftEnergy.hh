...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs7_PseudocontactShiftEnergy_hh
#define INCLUDED_protocols_scoring_methods_pcsTs7_PseudocontactShiftEnergy_hh

// Package headers
#include <protocols/scoring/methods/pcsTs7/PseudocontactShiftData.fwd.hh>
#include <protocols/scoring/methods/pcsTs7/PseudocontactShiftTensor.fwd.hh>
#include <protocols/scoring/methods/pcsTs7/PseudocontactShiftEnergy.fwd.hh>
...
class PCS_Energy_Ts7 : public core::scoring::methods::WholeStructureEnergy {
public:
...
public:
	...
	PCS_Energy_Ts7 &
	operator=(PCS_Energy_Ts7 const & other);

	PCS_Energy_Ts7(PCS_Energy_Ts7 const & other);
	...
	calculate_scores_and_tensors_from_pose_and_PCS_data(
		...
		utility::vector1<PCS_tensor_Ts7> & vec_best_tensor,
	...
	minimize_tensors_from_PCS_data(
		utility::vector1<PCS_tensor_Ts7> & vec_best_tensor,
		numeric::xyzVector< core::Real > & best_coo,
		PCS_data_Ts7 const & pcs_d
	) const;

	/*core::Real
	calculate_single_score_and_tensor_from_PCS_data_per_lanthanides(
		PCS_tensor_Ts7 & PCS_t,
		PCS_data_per_lanthanides_Ts7 & pcs_d_p_l
	) const; */
	...
	void
	dump_PCS_info(
		utility::vector1<PCS_tensor_Ts7> const & vec_tensor,
...
class PCS_Energy_parameters_manager_Ts7 {
public:
	static
	PCS_Energy_parameters_manager_Ts7 *
	get_instance();

private:
	static PCS_Energy_parameters_manager_Ts7 * instance_;
