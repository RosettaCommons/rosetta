...
basic::Tracer TR_pcs_d_p_l_Ts3("protocols.scoring.methods.pcsTs3.PCS_data_per_lanthanides_Ts3");
basic::Tracer TR_pcs_d_Ts3("protocols.scoring.methods.pcsTs3.PCS_data_Ts3");
...
PCS_data_per_lanthanides_Ts3::get_normalization_factor() const{
	...
	/*
core::Real
PCS_data_per_lanthanides_Ts3::get_normalization_1() const{
	return normalization_1_;
}

core::Real
PCS_data_per_lanthanides_Ts3::get_normalization_2() const{
	return normalization_2_;
}

core::Real
PCS_data_per_lanthanides_Ts3::get_normalization_3() const{
...
void
PCS_data_per_lanthanides_Ts3::print_index_A() const{
	core::Size i;
	for (i = 1; i <= n_pcs_; ++i){
		TR_pcs_d_p_l_Ts3 << i << " -> "  <<A_index_[i] << std::endl;
	}
}
*/
...
// 	utility::vector1<PCS_line_data_Ts3> & PCS_d_l_a = PCS_f_d.get_PCS_data_line_all_reference();
