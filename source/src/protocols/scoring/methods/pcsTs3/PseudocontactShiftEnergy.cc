...
static thread_local basic::Tracer TR_PCS_Energy_Ts3( "protocols.scoring.methods.pcsTs3.PCS_Energy_Ts3" );
...
PCS_Energy_Ts3::PCS_Energy_Ts3(PCS_Energy_Ts3 const & src ):
	parent( src )
{
}
...
/// c-tor
PCS_Energy_Ts3::PCS_Energy_Ts3() :
	parent( new PseudocontactShiftEnergyCreator_Ts3 )
{}
...
PCS_Energy_parameters_manager_Ts3::get_instance(){
	if ( instance_ == 0 ){
		instance_ = new PCS_Energy_parameters_manager_Ts3();
	}
	return instance_;
}
...
PCS_Energy_parameters_manager_Ts3 * PCS_Energy_parameters_manager_Ts3::instance_( 0 );
