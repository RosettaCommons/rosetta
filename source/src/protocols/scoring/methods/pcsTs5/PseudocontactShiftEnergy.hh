...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs5_PseudocontactShiftEnergy_hh
#define INCLUDED_protocols_scoring_methods_pcsTs5_PseudocontactShiftEnergy_hh
...
#include <protocols/scoring/methods/pcsTs5/PseudocontactShiftEnergy.fwd.hh>
...
class PCS_Energy_Ts5 : public core::scoring::methods::WholeStructureEnergy {
public:
...
public:
	...
	PCS_Energy_Ts5 &
	operator=(PCS_Energy_Ts5 const & other);

	PCS_Energy_Ts5(PCS_Energy_Ts5 const & other);
	...
	calculate_single_score_and_tensor_from_PCS_data_per_lanthanides(
		PCS_tensor_Ts5 & PCS_t,
		PCS_data_per_lanthanides_Ts5 & pcs_d_p_l
	) const; */
...
class PCS_Energy_parameters_manager_Ts5 {
public:
	static
...
private:
	static PCS_Energy_parameters_manager_Ts5 * instance_;
