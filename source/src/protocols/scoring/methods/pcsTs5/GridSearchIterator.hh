...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs5_GridSearchIterator_hh
#define INCLUDED_protocols_scoring_methods_pcsTs5_GridSearchIterator_hh
...
class GridSearchIterator_Ts5 : public utility::pointer::ReferenceCount {
public:
	GridSearchIterator_Ts5();

	~GridSearchIterator_Ts5();

	GridSearchIterator_Ts5(GridSearchIterator_Ts5 const & other);

	GridSearchIterator_Ts5 &
	operator=(GridSearchIterator_Ts5 const & other);

	GridSearchIterator_Ts5(numeric::xyzVector< core::Real > const coo1,
