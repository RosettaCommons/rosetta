...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs5_PseudocontactShiftTensor_hh
#define INCLUDED_protocols_scoring_methods_pcsTs5_PseudocontactShiftTensor_hh
...
public:
	...
	PCS_tensor_Ts5(PCS_tensor_Ts5 const & other);

	PCS_tensor_Ts5 &
	operator=(PCS_tensor_Ts5 const & other);

  PCS_tensor_Ts5(  core::Real const chi_xx,
  ...
  core::Real
	...
	void
	copy_from_ref(PCS_tensor_Ts5 & other);
