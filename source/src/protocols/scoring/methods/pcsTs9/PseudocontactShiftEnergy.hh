...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs9_PseudocontactShiftEnergy_hh
#define INCLUDED_protocols_scoring_methods_pcsTs9_PseudocontactShiftEnergy_hh

// Package headers
#include <protocols/scoring/methods/pcsTs9/PseudocontactShiftData.fwd.hh>
#include <protocols/scoring/methods/pcsTs9/PseudocontactShiftTensor.fwd.hh>
#include <protocols/scoring/methods/pcsTs9/PseudocontactShiftEnergy.fwd.hh>
...
class PCS_Energy_Ts9 : public core::scoring::methods::WholeStructureEnergy {
public:
...
public:
	...
	PCS_Energy_Ts9 &
	operator=(PCS_Energy_Ts9 const & other);

	PCS_Energy_Ts9(PCS_Energy_Ts9 const & other);
	...
	calculate_single_score_and_tensor_from_PCS_data_per_lanthanides(
		PCS_tensor_Ts9 & PCS_t,
		PCS_data_per_lanthanides_Ts9 & pcs_d_p_l
	) const; */
...
class PCS_Energy_parameters_manager_Ts9 {
public:
	static
...
private:
	static PCS_Energy_parameters_manager_Ts9 * instance_;
