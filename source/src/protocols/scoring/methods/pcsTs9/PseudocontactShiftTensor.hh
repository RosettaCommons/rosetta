...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs9_PseudocontactShiftTensor_hh
#define INCLUDED_protocols_scoring_methods_pcsTs9_PseudocontactShiftTensor_hh
...
public:
	...
	PCS_tensor_Ts9(PCS_tensor_Ts9 const & other);

	PCS_tensor_Ts9 &
	operator=(PCS_tensor_Ts9 const & other);

  PCS_tensor_Ts9(  core::Real const chi_xx,
  ...
  core::Real
	...
	void
	copy_from_ref(PCS_tensor_Ts9 & other);
