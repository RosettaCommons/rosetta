...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs9_PseudocontactShiftData_hh
#define INCLUDED_protocols_scoring_methods_pcsTs9_PseudocontactShiftData_hh

// Package headers
#include <protocols/scoring/methods/pcsTs9/PseudocontactShiftInput.fwd.hh>
...
public:
	//PCS_data_per_lanthanides_Ts9(std::string, PCS_file_data_Ts9 & P_f_d, core::Real const weight);

	PCS_data_per_lanthanides_Ts9(std::string, core::Real const weight, utility::vector1< PCS_line_data_Ts9 > & PCS_d_l_a);
...
public:
	...
	PCS_data_per_lanthanides_Ts9(PCS_data_per_lanthanides_Ts9 const &other);

	PCS_data_per_lanthanides_Ts9 &
	operator=( PCS_data_per_lanthanides_Ts9 const & other );
	...
	*/
	...
	core::Real
	calculate_tensor_and_cost_with_svd(PCS_tensor_Ts9 &PCS_t);

	//core::Real calculate_tensor_and_cost_with_svd_precalc(PCS_tensor_Ts9 &PCS_t);
};



class PCS_data_Ts9 : public basic::datacache::CacheableData {
private:
	core::Size n_lanthanides_;
	core::Size n_pcs_spin_;
	utility::vector1<PCS_line_data_Ts9> PCS_data_line_all_spin_;
	utility::vector1<PCS_data_per_lanthanides_Ts9> PCS_data_per_lanthanides_all_;
...
public:
	...
	PCS_data_Ts9(PCS_data_input_Ts9 & P_d_i);

	PCS_data_Ts9(PCS_data_input_Ts9 & P_d_i, utility::vector1< bool > const exclude_residues );

	PCS_data_Ts9(PCS_data_Ts9 const &other);

	PCS_data_Ts9 &
	operator=( PCS_data_Ts9 const & src );
	...
	core::Size
	where_is_line(PCS_line_data_Ts9 & P_l_d);
