...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs6_PseudocontactShiftTensor_hh
#define INCLUDED_protocols_scoring_methods_pcsTs6_PseudocontactShiftTensor_hh
...
public:
	...
	PCS_tensor_Ts6(PCS_tensor_Ts6 const & other);

	PCS_tensor_Ts6 &
	operator=(PCS_tensor_Ts6 const & other);

  PCS_tensor_Ts6(  core::Real const chi_xx,
  ...
  core::Real
	...
	void
	copy_from_ref(PCS_tensor_Ts6 & other);
