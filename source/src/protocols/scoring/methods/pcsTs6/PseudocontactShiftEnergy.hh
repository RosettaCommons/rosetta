...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs6_PseudocontactShiftEnergy_hh
#define INCLUDED_protocols_scoring_methods_pcsTs6_PseudocontactShiftEnergy_hh
...
#include <protocols/scoring/methods/pcsTs6/PseudocontactShiftEnergy.fwd.hh>
...
class PCS_Energy_Ts6 : public core::scoring::methods::WholeStructureEnergy {
public:
...
public:
	...
	PCS_Energy_Ts6 &
	operator=(PCS_Energy_Ts6 const & other);

	PCS_Energy_Ts6(PCS_Energy_Ts6 const & other);
	...
	calculate_single_score_and_tensor_from_PCS_data_per_lanthanides(
		PCS_tensor_Ts6 & PCS_t,
		PCS_data_per_lanthanides_Ts6 & pcs_d_p_l
	) const; */
...
private:
	static PCS_Energy_parameters_manager_Ts6 * instance_;
