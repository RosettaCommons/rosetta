...
#ifndef INCLUDED_protocols_scoring_methods_pcsTs6_GridSearchIterator_hh
#define INCLUDED_protocols_scoring_methods_pcsTs6_GridSearchIterator_hh
...
class GridSearchIterator_Ts6 : public utility::pointer::ReferenceCount {
public:
	GridSearchIterator_Ts6();

	~GridSearchIterator_Ts6();

	GridSearchIterator_Ts6(GridSearchIterator_Ts6 const & other);

	GridSearchIterator_Ts6 &
	operator=(GridSearchIterator_Ts6 const & other);

	GridSearchIterator_Ts6(numeric::xyzVector< core::Real > const coo1,
