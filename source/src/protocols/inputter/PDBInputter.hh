...
/// @file protocols/inputter/PDBInputter.hh
/// @brief An inputter that takes a list of pdbs
/// @author Ken Jung

#ifndef INCLUDED_protocols_inputter_PDBInputter_hh
#define INCLUDED_protocols_inputter_PDBInputter_hh

// Unit Headers
#include <protocols/inputter/PDBInputter.fwd.hh>
