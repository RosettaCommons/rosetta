...
#ifndef INCLUDED_protocols_simple_filters_FragmentScoreFilter_hh
#define INCLUDED_protocols_simple_filters_FragmentScoreFilter_hh

// Unit headers
#include <protocols/simple_filters/FragmentScoreFilter.fwd.hh>
