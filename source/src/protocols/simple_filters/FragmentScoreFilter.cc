...
#include <protocols/simple_filters/FragmentScoreFilter.hh>
#include <protocols/simple_filters/FragmentScoreFilterCreator.hh>
...
static basic::Tracer TR( "protocols.simple_filters.FragmentScoreFilter" );
