...
/// @file protocols/simple_moves/MakeJunctionsMover.cc
...
#include <protocols/simple_moves/MakeJunctionsMoverCreator.hh>
#include <protocols/simple_moves/MakeJunctionsMover.hh>
...
static basic::Tracer TR( "protocols.simple_moves.MakeJunctionsMover" );
