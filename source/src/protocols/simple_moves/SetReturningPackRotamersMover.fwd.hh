...
#ifndef INCLUDED_protocols_simple_moves_SetReturningPackRotamersMover_fwd_hh
#define INCLUDED_protocols_simple_moves_SetReturningPackRotamersMover_fwd_hh
