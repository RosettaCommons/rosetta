...
/// @file protocols/hbnet/MCHBNetInteractionGraph.fwd.hh
...
#ifndef INCLUDED_protocols_hbnet_MCHBNetInteractionGraph_FWD_HH
#define INCLUDED_protocols_hbnet_MCHBNetInteractionGraph_FWD_HH
