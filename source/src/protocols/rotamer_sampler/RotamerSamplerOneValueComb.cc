...
/// @file protocols/rotamer_sampler/RotamerSamplerOneValueComb.cc
...
///////////////////////////////////////////////////////////////////////////
RotamerSamplerOneValueComb::RotamerSamplerOneValueComb():
...
///////////////////////////////////////////////////////////////////////////
ValueList const &
RotamerSamplerOneValueComb::get_value_list( utility::vector1< Size > const & id_list ){
	...
	for ( Size n = 1; n <= id_list.size(); n++ ){
		...
		RotamerSamplerOneValue * rotamer_one_value = static_cast< RotamerSamplerOneValue * >( rotamer_list_[n]() );
...
///////////////////////////////////////////////////////////////////////////
ValueList const &
RotamerSamplerOneValueComb::get_value_list( Size const id ){
