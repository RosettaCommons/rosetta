...
/// @file protocols/rotamer_sampler/rigid_body/RigidBodyRotamerValueRange.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.rotamer_sampler.rigid_body.RigidBodyRotamerValueRange" );
...
namespace rigid_body {
	...
	//Constructor
	RigidBodyRotamerValueRange::RigidBodyRotamerValueRange():
			centroid_bin_min_( 0 ),
			centroid_bin_max_( 0 ),
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerValueRange::set_sampler_values( Real const & val_min, Real const & val_max, Real const & val_bin, utility::vector1< Real > & values ){
		values.clear();
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerValueRange::set_x_values( Real const centroid_x_min, Real const centroid_x_max, Real const centroid_x_bin ){
		set_sampler_values( centroid_x_min, centroid_x_max, centroid_x_bin, x_values_ );
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerValueRange::set_y_values( Real const centroid_y_min, Real const centroid_y_max, Real const centroid_y_bin ){
		set_sampler_values( centroid_y_min, centroid_y_max, centroid_y_bin, y_values_ );
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerValueRange::set_z_values( Real const centroid_z_min, Real const centroid_z_max, Real const centroid_z_bin ){
		set_sampler_values( centroid_z_min, centroid_z_max, centroid_z_bin, z_values_ );
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerValueRange::set_euler_alpha_values( Real const centroid_euler_alpha_min, Real const centroid_euler_alpha_max, Real const centroid_euler_alpha_bin ){
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerValueRange::set_euler_z_values( Real const centroid_euler_z_min, Real const centroid_euler_z_max, Real const centroid_euler_z_bin ){
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerValueRange::set_euler_gamma_values( Real const centroid_euler_gamma_min, Real const centroid_euler_gamma_max, Real const centroid_euler_gamma_bin ){
