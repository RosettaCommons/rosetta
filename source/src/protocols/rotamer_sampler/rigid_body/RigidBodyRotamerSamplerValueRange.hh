...
/// @file protocols/rotamer_sampler/rigid_body/RigidBodyRotamerSamplerValueRange.hh
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_rotamer_sampler_rigid_body_RigidBodyRotamerSamplerValueRange_HH
#define INCLUDED_protocols_rotamer_sampler_rigid_body_RigidBodyRotamerSamplerValueRange_HH

#include <utility/pointer/ReferenceCount.hh>
#include <protocols/rotamer_sampler/RotamerSamplerOneValue.hh>
#include <protocols/rotamer_sampler/rigid_body/RigidBodyRotamerSamplerValueRange.fwd.hh>
...
namespace rigid_body {
	...
	class RigidBodyRotamerSamplerValueRange: public utility::pointer::ReferenceCount {

	public:

		//constructor
		RigidBodyRotamerSamplerValueRange();
