...
/// @file protocols/rotamer_sampler/rigid_body/RigidBodyRotamerSampler.cc
/// @brief
/// @detailed
...
//
// This RotamerSampler also gives out a Stub of the moving residues, which can be useful for screening.
//
...
static basic::Tracer TR( "protocols.rotamer_sampler.rigid_body.RigidBodyRotamerSampler" );
...
namespace rigid_body {
	...
	RigidBodyRotamerSampler::RigidBodyRotamerSampler( pose::Pose const & pose,
	...
	RigidBodyRotamerSampler::RigidBodyRotamerSampler( Size const moving_res,
	...
	//Destructor
	RigidBodyRotamerSampler::~RigidBodyRotamerSampler()
	{}

	////////////////////////////////////////////////////////////
	void RigidBodyRotamerSampler::init() {

		value_range_.init();
		clear_rotamer();

		RotamerSamplerOneValueOP x_rotamer = new RotamerSamplerOneValue( value_range_.x_values()   );
		RotamerSamplerOneValueOP y_rotamer = new RotamerSamplerOneValue( value_range_.y_values()   );
		RotamerSamplerOneValueOP z_rotamer = new RotamerSamplerOneValue( value_range_.z_values()   );
		RotamerSamplerOneValueOP euler_alpha_rotamer = new RotamerSamplerOneValue( value_range_.euler_alpha_values()   );
		RotamerSamplerOneValueOP euler_z_rotamer     = new RotamerSamplerOneValue( value_range_.euler_z_values() );
		RotamerSamplerOneValueOP euler_gamma_rotamer = new RotamerSamplerOneValue( value_range_.euler_gamma_values()   );
		...
		RotamerSamplerOneValueComb::init();

	}

	///////////////////////////////////////////////////////////////////////////
	void RigidBodyRotamerSampler::apply( core::pose::Pose & pose ){
		apply( pose, id_ );
	}
	...
	///////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::apply( core::conformation::Residue & residue_initially_at_origin ){
		Size const seqpos = residue_initially_at_origin.seqpos();

		// this function only works when RigidBodyRotamerSampler is initialized with a pose. Don't call this otherwise.
	...
	///////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::apply( Vector & xyz_initially_at_origin, Size const seqpos ){
	...
	RigidBodyRotamerSampler::get_stub() {
		return get_stub( id_list_ );
	}

	///////////////////////////////////////////////////////////////////////////
	core::kinematics::Stub const &
	RigidBodyRotamerSampler::get_stub( utility::vector1< Size > const & id_list ) {
	...
	///////////////////////////////////////////////////////////////////////////
	core::kinematics::Stub const &
	RigidBodyRotamerSampler::get_stub( Size const id ) {
	...
	RigidBodyRotamerSampler::get_values() {
		return get_value_list( id_list_ );
	}

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::transform_single_residue( pose::Pose & pose, Size const & seq_num,
	...
	///////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::apply_by_jump( pose::Pose & pose, Size const & seq_num,
																	 core::kinematics::Stub const & ){
	...
	///////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::calculate_jump( pose::Pose & pose, Size const seq_num, kinematics::Stub const & moving_res_stub ){
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::fast_forward_to_end(){
		fast_forward( 6 );
	}

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::fast_forward_to_next_translation(){
		fast_forward( 3 ); // go to end of euler angles, so that next increment will update translation.
	}

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::fast_forward_to_next_euler_gamma(){
		fast_forward( 1 ); // go to end of gamma
	}
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::set_x_values( Real const centroid_x_min, Real const centroid_x_max, Real const centroid_x_bin ){
		value_range_.set_x_values( centroid_x_min, centroid_x_max, centroid_x_bin );
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::set_y_values( Real const centroid_y_min, Real const centroid_y_max, Real const centroid_y_bin ){
		value_range_.set_y_values( centroid_y_min, centroid_y_max, centroid_y_bin );
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::set_z_values( Real const centroid_z_min, Real const centroid_z_max, Real const centroid_z_bin ){
		value_range_.set_z_values( centroid_z_min, centroid_z_max, centroid_z_bin );
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::set_euler_alpha_values( Real const centroid_euler_alpha_min, Real const centroid_euler_alpha_max, Real const centroid_euler_alpha_bin ){
		value_range_.set_euler_alpha_values( centroid_euler_alpha_min, centroid_euler_alpha_max, centroid_euler_alpha_bin );
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::set_euler_z_values( Real const centroid_euler_z_min, Real const centroid_euler_z_max, Real const centroid_euler_z_bin ){
		value_range_.set_euler_z_values( centroid_euler_z_min, centroid_euler_z_max, centroid_euler_z_bin );
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	RigidBodyRotamerSampler::set_euler_gamma_values( Real const centroid_euler_gamma_min, Real const centroid_euler_gamma_max, Real const centroid_euler_gamma_bin ){
		value_range_.set_euler_gamma_values( centroid_euler_gamma_min, centroid_euler_gamma_max, centroid_euler_gamma_bin );
	}

	core::pose::PoseCOP
	RigidBodyRotamerSampler::pose_at_origin(){ return pose_at_origin_; }

	core::conformation::Residue const &
	RigidBodyRotamerSampler::get_residue_at_origin( Size const seqpos ){ return pose_at_origin_->residue( seqpos ) ; }
