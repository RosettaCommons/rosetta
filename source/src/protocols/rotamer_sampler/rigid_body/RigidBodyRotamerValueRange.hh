...
/// @file protocols/rotamer_sampler/rigid_body/RigidBodyRotamerValueRange.hh
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_rotamer_sampler_rigid_body_RigidBodyRotamerValueRange_HH
#define INCLUDED_protocols_rotamer_sampler_rigid_body_RigidBodyRotamerValueRange_HH

#include <utility/pointer/ReferenceCount.hh>
#include <protocols/rotamer_sampler/RotamerOneValue.hh>
#include <protocols/rotamer_sampler/rigid_body/RigidBodyRotamerValueRange.fwd.hh>
...
namespace rigid_body {
	...
	class RigidBodyRotamerValueRange: public utility::pointer::ReferenceCount {
