...
/// @file protocols/rotamer_sampler/RotamerAny.cc
/// @brief Aggregate multiple samplers for sampling from any one of them.
/// @author Fang-Chieh Chou

// Unit headers
#include <protocols/rotamer_sampler/RotamerAny.hh>
...
static basic::Tracer TR( "protocols.rotamer_sampler.RotamerAny" );
...
///////////////////////////////////////////////////////////////////////////
void RotamerAny::apply( Pose & pose ) {
	runtime_assert( is_init() );
	rotamer_list_[curr_rotamer_]->apply( pose );
}
///////////////////////////////////////////////////////////////////////////
void RotamerAny::set_random( bool const setting ) {
