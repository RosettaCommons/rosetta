...
/// @file protocols/rotamer_sampler/RotamerSamplerOneTorsion.hh
/// @brief Generate rotamer for one torsion angle.
/// @author Fang-Chieh Chou


#ifndef INCLUDED_protocols_rotamer_sampler_RotamerSamplerOneTorsion_HH
#define INCLUDED_protocols_rotamer_sampler_RotamerSamplerOneTorsion_HH

// Unit headers
#include <protocols/rotamer_sampler/RotamerSamplerOneTorsion.fwd.hh>
...
class RotamerSamplerOneTorsion : public RotamerSamplerOneValue {
public:
	using RotamerSamplerBase::TorsionList;

	RotamerSamplerOneTorsion();
	...
	virtual ~RotamerSamplerOneTorsion();
	...
	virtual std::string get_name() const { return "RotamerSamplerOneTorsion"; }

	/// @brief Type of class (see enum in RotamerSamplerTypes.hh)
	virtual RotamerSamplerType type() const { return ONE_TORSION; }
