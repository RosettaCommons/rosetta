...
/// @file protocols/rotamer_sampler/RotamerSamplerAny.hh
/// @brief Aggregate multiple samplers for sampling from any one of them.
/// @author Fang-Chieh Chou


#ifndef INCLUDED_protocols_rotamer_sampler_RotamerSamplerAny_HH
#define INCLUDED_protocols_rotamer_sampler_RotamerSamplerAny_HH

// Unit headers
#include <protocols/rotamer_sampler/RotamerSamplerAny.fwd.hh>
...
class RotamerSamplerAny : public RotamerSamplerBase {
public:
	RotamerSamplerAny();

	virtual ~RotamerSamplerAny();
	...
	virtual void add_external_loop_rotamer(
		RotamerSamplerBaseOP const & rotamer,
	...
	virtual std::string get_name() const { return "RotamerSamplerAny"; }

	/// @brief Type of class (see enum in RotamerSamplerTypes.hh)
	virtual RotamerSamplerType type() const { return ANY; }
