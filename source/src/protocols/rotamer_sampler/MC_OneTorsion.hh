...
/// @file protocols/rotamer_sampler/MC_OneTorsion.hh
/// @brief Markov chain sampler for one torsion.
/// @author Fang-Chieh Chou


#ifndef INCLUDED_protocols_rotamer_sampler_MC_OneTorsion_HH
#define INCLUDED_protocols_rotamer_sampler_MC_OneTorsion_HH
...
class MC_OneTorsion : public MC_RotamerSampler {
public:
	...
	virtual RotamerSamplerType type() const { return MC_ONE_TORSION; }
