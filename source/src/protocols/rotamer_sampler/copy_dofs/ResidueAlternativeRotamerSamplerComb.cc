...
/// @file protocols/rotamer_sampler/copy_dofs/ResidueAlternativeRotamerSamplerComb.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.rotamer_sampler.copy_dofs.ResidueAlternativeRotamerSamplerComb" );
...
namespace copy_dofs {
	...
	//Constructor
	ResidueAlternativeRotamerSamplerComb::ResidueAlternativeRotamerSamplerComb()
	{}
	...
	void
	ResidueAlternativeRotamerSamplerComb::add_residue_alternative_rotamer( ResidueAlternativeRotamerSamplerOP const & rotamer ) {
	...
	bool
	ResidueAlternativeRotamerSamplerComb::has_resnum( Size const seqpos ){
		return ( residue_alternative_rotamer_map_.find( seqpos ) != residue_alternative_rotamer_map_.end() );
	}

	Size
	ResidueAlternativeRotamerSamplerComb::find_resnum( Size const seqpos ){
	...
	Size
	ResidueAlternativeRotamerSamplerComb::id_for_resnum( Size const seqpos ){
	...
	Residue const &
	ResidueAlternativeRotamerSamplerComb::get_residue_at_origin( Size const seqpos ){
		return residue_alternative_rotamer_map_[ seqpos ]->get_residue_at_origin();
	}

	Residue const &
	ResidueAlternativeRotamerSamplerComb::get_residue_at_origin_with_matching_type( Size const seqpos, Residue const & rsd_in ){
	...
	void
	ResidueAlternativeRotamerSamplerComb::fast_forward_to_next_residue_pair( Size const i, Size const j){
	...
	// fast-forward inner loops so that we can get to the next residue pair.
	void
	ResidueAlternativeRotamerSamplerComb::fast_forward_to_next_residue( Size const i ){
