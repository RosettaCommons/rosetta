...
/// @file protocols/rotamer_sampler/copy_dofs/CopyDofRotamerSampler.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.rotamer_sampler.copy_dofs.CopyDofRotamerSampler" );
...
namespace copy_dofs {
	...
	//Constructor
	CopyDofRotamerSampler::CopyDofRotamerSampler(utility::vector1< core::pose::PoseOP > const & pose_list,
	...
	///////////////////////////////////////////////////
	void
	CopyDofRotamerSampler::apply( core::pose::Pose & pose, core::Size const i ){
