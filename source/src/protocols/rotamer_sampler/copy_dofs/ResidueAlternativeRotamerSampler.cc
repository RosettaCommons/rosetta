...
/// @file protocols/rotamer_sampler/copy_dofs/ResidueAlternativeRotamerSampler.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.rotamer_sampler.copy_dofs.ResidueAlternativeRotamerSampler" );
...
namespace copy_dofs {
	...
	//constructor
	ResidueAlternativeRotamerSampler::ResidueAlternativeRotamerSampler( ResidueAlternativeSet const & residue_alternative_set,
																												core::pose::Pose const & starting_pose ):
		CopyDofRotamerSampler( residue_alternative_set.pose_list(),
	...
	//Constructor
	ResidueAlternativeRotamerSampler::ResidueAlternativeRotamerSampler( utility::vector1< core::pose::PoseOP > const & pose_list,
																												std::map< Size, Size > const & res_map,
																												Size const representative_seqpos,
																												core::pose::Pose const & starting_pose ):
		CopyDofRotamerSampler( pose_list, res_map, starting_pose ),
	...
	//Constructor
	ResidueAlternativeRotamerSampler::ResidueAlternativeRotamerSampler( utility::vector1< pose::PoseOP > const & pose_list,
														 std::map< Size, Size > const & res_map,
														 Size const representative_seqpos ):
		CopyDofRotamerSampler( pose_list, res_map ),
		representative_seqpos_( representative_seqpos )
	{
		initialize_residues();
	}
	...
	ResidueAlternativeRotamerSampler::ResidueAlternativeRotamerSampler( utility::vector1< pose::PoseOP > const & pose_list,
																												Size const representative_seqpos ):
		CopyDofRotamerSampler( pose_list, simple_res_map( representative_seqpos ) ),
		representative_seqpos_( representative_seqpos )
	{
		initialize_residues();
	}
	...
	//Destructor
	ResidueAlternativeRotamerSampler::~ResidueAlternativeRotamerSampler()
	{}

	///////////////////////////////////////////////////////
	std::map< Size, Size >
	ResidueAlternativeRotamerSampler::simple_res_map( Size const i ){
	...
	///////////////////////////////////////////////////////
	void
	ResidueAlternativeRotamerSampler::initialize_residues(){
	...
	///////////////////////////////////////////////////////
	void
	ResidueAlternativeRotamerSampler::initialize_residues_for_type( Residue const & rsd_in ){
		utility::vector1< ResidueOP > residues;
		for ( Size n = 1; n <= pose_list_.size(); n++ ){
			pose::PoseOP pose = pose_list_[ n ];
	...
	///////////////////////////////////////////////////////
	Residue const &
	ResidueAlternativeRotamerSampler::get_residue_at_origin(){
		return *residues_for_each_type_[ original_type_ ][ id_ ];
	}

	///////////////////////////////////////////////////////
	Residue const &
	ResidueAlternativeRotamerSampler::get_residue_at_origin_with_matching_type( Residue const & rsd_in ){
		std::string type_in = rsd_in.name(); // could be a hash.
