...
/// @file protocols/rotamer_sampler/copy_dofs/ResidueAlternativeRotamerComb.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.rotamer_sampler.copy_dofs.ResidueAlternativeRotamerComb" );
...
namespace copy_dofs {
	...
	//Constructor
	ResidueAlternativeRotamerComb::ResidueAlternativeRotamerComb()
	{}
	...
	void
	ResidueAlternativeRotamerComb::add_residue_alternative_rotamer( ResidueAlternativeRotamerOP const & rotamer ) {
	...
	bool
	ResidueAlternativeRotamerComb::has_resnum( Size const seqpos ){
		return ( residue_alternative_rotamer_map_.find( seqpos ) != residue_alternative_rotamer_map_.end() );
	}

	Size
	ResidueAlternativeRotamerComb::find_resnum( Size const seqpos ){
	...
	Size
	ResidueAlternativeRotamerComb::id_for_resnum( Size const seqpos ){
	...
	Residue const &
	ResidueAlternativeRotamerComb::get_residue_at_origin( Size const seqpos ){
		return residue_alternative_rotamer_map_[ seqpos ]->get_residue_at_origin();
	}

	Residue const &
	ResidueAlternativeRotamerComb::get_residue_at_origin_with_matching_type( Size const seqpos, Residue const & rsd_in ){
	...
	// fast-forward inner loops so that we can get to the next residue pair.
	void
	ResidueAlternativeRotamerComb::fast_forward_to_next_residue( Size const i ){
