...
/// @file protocols/rotamer_sampler/input_streams/InputStreamRotamer.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.rotamer_sampler.input_streams.InputStreamRotamer" );
...
namespace input_streams {
		...
		size_( input_stream->compute_size() ) // slow...
  {
	...
	//Destructor
	InputStreamRotamer::~InputStreamRotamer()
	{}

  //////////////////////////////////////////////////////////////////////////
  void
  InputStreamRotamer::reset(){
		RotamerSized::reset(); // rewinds id_ to 1.
		input_stream_->reset();
  ...
  //////////////////////////////////////////////////////////////////////////
	void
	InputStreamRotamer::set_id( Size const setting ){
	...
	void
	InputStreamRotamer::apply( core::pose::Pose & pose, core::Size const id ){
