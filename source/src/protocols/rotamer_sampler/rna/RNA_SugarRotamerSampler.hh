...
/// @file protocols/rotamer_sampler/rna/RNA_SugarRotamerSampler.hh
/// @brief Generate sugar pucker rotamers for RNA.
/// @author Fang-Chieh Chou

#ifndef INCLUDED_protocols_rotamer_sampler_rna_RNA_SugarRotamerSampler_HH
#define INCLUDED_protocols_rotamer_sampler_rna_RNA_SugarRotamerSampler_HH
...
class RNA_SugarRotamerSampler : public RotamerSamplerSized {
public:
	RNA_SugarRotamerSampler(
	...
	std::string get_name() const { return "RNA_SugarRotamerSampler"; }

	/// @brief Type of class (see enum in RotamerSamplerTypes.hh)
	virtual RotamerSamplerType type() const { return RNA_SUGAR; }
