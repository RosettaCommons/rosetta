...
/// @file protocols/rotamer_sampler/rna/RNA_MC_Sugar.cc
...
static basic::Tracer TR( "protocols.rotamer_sampler.rna.RNA_MC_Sugar" );
...
RNA_MC_Sugar::RNA_MC_Sugar(
	...
	sugar_rotamer_( new RNA_SugarRotamerSampler( rsd_id, ANY_PUCKER ) )
{}
///////////////////////////////////////////////////////////////////////////
