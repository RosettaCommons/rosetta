...
/// @file protocols/rotamer_sampler/rna/RNA_McSuite.cc
...
static basic::Tracer TR( "protocols.rotamer_sampler.rna.RNA_McSuite" );
...
///////////////////////////////////////////////////////////////////////////
RNA_McSuite::RNA_McSuite( Size const rsd_id ):
	McComb(),
	rsd_id_( rsd_id ),
...
void RNA_McSuite::init() {
	...
	for ( Size i = 1; i <= 5; ++i ) {
		McOneTorsionOP sampler(
				new McOneTorsion( torsion_ids_[i], init_torsions_[i] ) );
	...
	for ( Size i = 1; i <= 2; ++i ) {
		McOneTorsionOP chi_sampler = new McOneTorsion(
		...
		RNA_McSugarOP sugar_sampler = new RNA_McSugar(
...
///////////////////////////////////////////////////////////////////////////
void RNA_McSuite::set_init_from_pose( pose::Pose const & pose ) {
...
///////////////////////////////////////////////////////////////////////////
void RNA_McSuite::set_pucker_flip_rate( Real const setting ) {
...
///////////////////////////////////////////////////////////////////////////
void RNA_McSuite::set_gaussian_stdev( Real const setting ) {
...
///////////////////////////////////////////////////////////////////////////
void  RNA_McSuite::clear_rotamer() {
	bb_samplers_.clear();
	chi_samplers_.clear();
