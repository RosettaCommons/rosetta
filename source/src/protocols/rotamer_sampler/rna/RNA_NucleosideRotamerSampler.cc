...
/// @file protocols/rotamer_sampler/rna/RNA_NucleosideRotamerSampler.cc
...
static basic::Tracer TR( "protocols.rotamer_sampler.rna.RNA_NucleosideRotamerSampler" );
...
////////////////////////////////////////////////////////////////////////////
// Constructor
RNA_NucleosideRotamerSampler::RNA_NucleosideRotamerSampler(
...
////////////////////////////////////////////////////////////////////////////
void RNA_NucleosideRotamerSampler::init() {
	clear_rotamer();
	...
	for ( Size i = 1; i <= pucker_states_.size(); ++i ) {
		...
		if ( base_state_ != NO_CHI ) {
			RNA_ChiRotamerSamplerOP chi_rotamer = new RNA_ChiRotamerSampler(
		...
		/////Pucker rotamers/////
		RNA_SugarRotamerSamplerOP pucker_rotamer = new RNA_SugarRotamerSampler(
