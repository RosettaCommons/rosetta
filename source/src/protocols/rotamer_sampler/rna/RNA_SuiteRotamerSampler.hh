...
/// @file protocols/rotamer_sampler/rna/RNA_SuiteRotamerSampler.hh
/// @brief Generate rotamers for one RNA suite (from residue i to i+1).
/// @author Fang-Chieh Chou

#ifndef INCLUDED_protocols_rotamer_sampler_rna_RNA_SuiteRotamerSampler_HH
#define INCLUDED_protocols_rotamer_sampler_rna_RNA_SuiteRotamerSampler_HH

// Unit headers
#include <protocols/rotamer_sampler/rna/RNA_SuiteRotamerSampler.fwd.hh>

// Package headers
#include <protocols/rotamer_sampler/RotamerSamplerSizedAny.hh>
...
class RNA_SuiteRotamerSampler : public RotamerSamplerSizedAny {
public:
	using RotamerSamplerBase::TorsionList;

	RNA_SuiteRotamerSampler(
	...
	std::string get_name() const { return "RNA_SuiteRotamerSampler"; }

	/// @brief Type of class (see enum in RotamerSamplerTypes.hh)
	virtual RotamerSamplerType type() const { return RNA_SUITE; }
