...
/// @file protocols/rotamer_sampler/rna/RNA_KIC_Sampler.cc
...
static basic::Tracer TR( "protocols.rotamer_sampler.rna.RNA_KIC_Sampler" );
...
void RNA_KIC_Sampler::init() {
	...
	////////// Backbone RotamerSampler //////////
	bb_rotamer_ = new RotamerSamplerSizedComb;
	...
	/////Alpha1 rotamers/////
	RotamerSamplerOneTorsionOP alpha1_rotamer = new RotamerSamplerOneTorsion(
			TorsionID( moving_suite_ + 1, BB, ALPHA ), full_torsions );
	bb_rotamer_->add_external_loop_rotamer( alpha1_rotamer );
	/////Alpha2 rotamers/////
	RotamerSamplerOneTorsionOP alpha2_rotamer = new RotamerSamplerOneTorsion(
	...
	if ( base_state_ != NO_CHI ){
		chi_rotamer_ = new RNA_ChiRotamerSampler(
