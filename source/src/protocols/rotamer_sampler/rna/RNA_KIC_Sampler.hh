...
#ifndef INCLUDED_protocols_rotamer_sampler_rna_RNA_KIC_Sampler_HH
#define INCLUDED_protocols_rotamer_sampler_rna_RNA_KIC_Sampler_HH

// Unit headers
#include <protocols/rotamer_sampler/rna/RNA_KIC_Sampler.fwd.hh>
...
#include <protocols/rotamer_sampler/rna/RNA_ChiRotamerSampler.fwd.hh>
...
class RNA_KIC_Sampler : public RotamerSamplerBase {
public:
	RNA_KIC_Sampler(
	...
	std::string get_name() const { return "RNA_KIC_Sampler"; }

	/// @brief Type of class (see enum in RotamerSamplerTypes.hh)
	virtual RotamerSamplerType type() const { return RNA_KIC; }
...
private:
  ...
  void operator=( const RNA_KIC_Sampler & );
	...
	RotamerSamplerSizedCombOP bb_rotamer_;
	RNA_KinematicCloserOP loop_closer_;
	RNA_ChiRotamerSamplerOP chi_rotamer_;
