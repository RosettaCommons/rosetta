...
/// @file protocols/rotamer_sampler/rna/RNA_MC_MultiSuite.cc
...
static basic::Tracer TR( "protocols.rotamer_sampler.rna.RNA_MC_MultiSuite" );
...
void  RNA_MC_MultiSuite::add_external_loop_rotamer(
	MC_RotamerSamplerOP const & rotamer
) {
