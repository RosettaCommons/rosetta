...
/// @file protocols/rotamer_sampler/rna/RNA_ChiRotamerSampler.hh
/// @brief Generate glycosidic chi rotamers for RNA.
/// @author Fang-Chieh Chou

#ifndef INCLUDED_protocols_rotamer_sampler_rna_RNA_ChiRotamerSampler_HH
#define INCLUDED_protocols_rotamer_sampler_rna_RNA_ChiRotamerSampler_HH
...
class RNA_ChiRotamerSampler : public RotamerSamplerOneTorsion {
public:
	RNA_ChiRotamerSampler(
  ...
  PuckerState pucker_state() { return pucker_state_; }
	...
	std::string get_name() const { return "RNA_ChiRotamerSampler"; }

	/// @brief Type of class (see enum in RotamerSamplerTypes.hh)
	virtual RotamerSamplerType type() const { return RNA_CHI; }
