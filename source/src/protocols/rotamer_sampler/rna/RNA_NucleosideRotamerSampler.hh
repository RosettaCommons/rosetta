...
/// @file protocols/rotamer_sampler/rna/RNA_NucleosideRotamerSampler.hh
/// @brief Generate rotamers for one RNA nucleoside (pucker + glycosidic chi).
/// @author Fang-Chieh Chou

#ifndef INCLUDED_protocols_rotamer_sampler_rna_RNA_NucleosideRotamerSampler_HH
#define INCLUDED_protocols_rotamer_sampler_rna_RNA_NucleosideRotamerSampler_HH

// Unit headers
#include <protocols/rotamer_sampler/rna/RNA_NucleosideRotamerSampler.fwd.hh>
...
class RNA_NucleosideRotamerSampler : public RotamerSamplerSizedAny {
public:
	RNA_NucleosideRotamerSampler(
	...
	std::string get_name() const { return "RNA_NucleosideRotamerSampler"; }

	/// @brief Type of class (see enum in RotamerSamplerTypes.hh)
	virtual RotamerSamplerType type() const { return RNA_NUCLEOSIDE; }
