...
/// @file protocols/rotamer_sampler/rna/RNA_SugarRotamerSampler.cc
...
static basic::Tracer TR( "protocols.rotamer_sampler.rna.RNA_SugarRotamerSampler" );
...
//////////////////////////////////////////////////////////////////////////////////////////
// Constructor
RNA_SugarRotamerSampler::RNA_SugarRotamerSampler(
	Size const rsd_id,
...
//////////////////////////////////////////////////////////////////////////
void RNA_SugarRotamerSampler::init() {
...
//////////////////////////////////////////////////////////////////
void RNA_SugarRotamerSampler::apply( pose::Pose & pose, core::Size const i ) {
	// Arvind - 10/06/2013
	...
	if (idealize_coord_) {
		if ( pucker_state == NORTH ) {
			if (  north_pucker_dofs_have_not_been_initialized_ ) {
				// Arvind - 10/06/2013
				// If it is the first time the RNA_SugarRotamerSampler object has encountered a NORTH pucker, then we need to go through the whole process of running copy_dofs() from the ideal pucker. But when we do this, we are caching all of the dofs we need to alter so that we don't have to do this again
