...
/// @file protocols/rotamer_sampler/rna/RNA_MC_Suite.hh
/// @brief Markov chain sampler for RNA suite.
/// @author Fang-Chieh Chou

#ifndef INCLUDED_protocols_rotamer_sampler_rna_RNA_MC_Suite_HH
#define INCLUDED_protocols_rotamer_sampler_rna_RNA_MC_Suite_HH
...
#include <protocols/rotamer_sampler/MC_OneTorsion.fwd.hh>
...
#include <core/id/TorsionID.hh>
	...
	#include <protocols/rotamer_sampler/rna/RNA_MC_Sugar.hh>
#endif
...
class RNA_MC_Suite : public MC_Comb {
public:
	...
	virtual RotamerSamplerType type() const { return RNA_MC_SUITE; }
