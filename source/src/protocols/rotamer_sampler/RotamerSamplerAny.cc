...
/// @file protocols/rotamer_sampler/RotamerSamplerAny.cc
/// @brief Aggregate multiple samplers for sampling from any one of them.
/// @author Fang-Chieh Chou

// Unit headers
#include <protocols/rotamer_sampler/RotamerSamplerAny.hh>
...
static basic::Tracer TR( "protocols.rotamer_sampler.RotamerSamplerAny" );
...
///////////////////////////////////////////////////////////////////////////
RotamerSamplerAny::RotamerSamplerAny():
	RotamerSamplerBase(),
	curr_rotamer_( 1 ),
	is_weighted_( false ),
	is_empty_( true ),
...
///////////////////////////////////////////////////////////////////////////
void RotamerSamplerAny::operator++() {
...
///////////////////////////////////////////////////////////////////////////
bool RotamerSamplerAny::not_end() const {
	runtime_assert( is_init() );
...
///////////////////////////////////////////////////////////////////////////
void RotamerSamplerAny::apply( Pose & pose ) {
	runtime_assert( is_init() );
	rotamer_list_[curr_rotamer_]->apply( pose );
}
///////////////////////////////////////////////////////////////////////////
void RotamerSamplerAny::set_random( bool const setting ) {
