...
MinMoverOP
AntibodyDesignMoverGenerator::generate_minimizer(Pose const & pose) {
...
void
AntibodyDesignMoverGenerator::setup_minimizer(const Pose& pose, MinMoverOP min_mover){
...
void
AntibodyDesignMoverGenerator::setup_relax(Pose const & pose, relax::FastRelaxOP rel){
...
MoveMapOP
AntibodyDesignMoverGenerator::get_cdrs_movemap_with_overhang(Pose const & pose, bool min_bb, bool min_sc, bool include_neighbor_sc, bool include_neighbor_bb) const {
