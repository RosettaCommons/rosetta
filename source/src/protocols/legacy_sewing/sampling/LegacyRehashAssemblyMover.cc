...
/// @file LegacyRehashAssemblyMover.cc
///
...
LegacyRehashAssemblyMoverCreator::create_mover() const
{
	return new LegacyRehashAssemblyMover;
}

std::string
LegacyRehashAssemblyMoverCreator::keyname() const
{
	return LegacyRehashAssemblyMoverCreator::mover_name();
}

std::string
LegacyRehashAssemblyMoverCreator::mover_name()
{
	return "LegacyRehashAssemblyMover";
}
...
std::string
LegacyRehashAssemblyMover::get_name() const {
	return "LegacyRehashAssemblyMover";
}

/////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////  LegacyRehashAssemblyMover functions   //////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////

LegacyRehashAssemblyMover::LegacyRehashAssemblyMover():
	AssemblyMover(),
	max_loop_distance_(14)
{}

bool
LegacyRehashAssemblyMover::generate_assembly(
	AssemblyOP & assembly
){
...
bool
LegacyRehashAssemblyMover::rearrange_assembly(
	AssemblyOP & assembly
) const {
