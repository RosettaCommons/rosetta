...
/// @file protocols/swa/rna/O2PrimePacker.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.swa.rna.O2PrimePacker" ) ;
...
O2PrimePacker::sample_o2prime_hydrogen(){
	...
	swa::rna::copy_all_o2prime_torsions( o2prime_pack_pose_, pose_with_original_HO2prime_torsion_ );
...
O2PrimePacker::copy_all_o2prime_torsions( core::pose::Pose & mod_pose ) const {
	swa::rna::copy_all_o2prime_torsions( mod_pose, o2prime_pack_pose_ );
}
