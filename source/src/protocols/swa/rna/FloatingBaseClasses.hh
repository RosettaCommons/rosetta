...
/// @file protocols/swa/rna/FloatingBaseClasses.hh
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_swa_rna_FloatingBaseClasses_HH
#define INCLUDED_protocols_swa_rna_FloatingBaseClasses_HH
