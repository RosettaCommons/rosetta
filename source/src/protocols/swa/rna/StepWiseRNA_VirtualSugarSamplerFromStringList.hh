...
/// @file protocols/swa/rna/StepWiseRNA_VirtualSugarSamplerFromStringList.hh
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_swa_rna_StepWiseRNA_VirtualSugarSamplerFromStringList_HH
#define INCLUDED_protocols_swa_rna_StepWiseRNA_VirtualSugarSamplerFromStringList_HH

#include <protocols/moves/Mover.hh>
#include <core/pose/Pose.fwd.hh>
#include <protocols/swa/rna/StepWiseRNA_JobParameters.fwd.hh>
#include <protocols/swa/rna/StepWiseRNA_VirtualSugarSamplerFromStringList.fwd.hh>
