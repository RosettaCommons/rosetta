...
/// @file protocols/swa/rna/screener/ChainClosableScreener.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.swa.rna.screener.ChainClosableScreener" );
...
namespace screener {
	...
	//Constructor
	ChainClosableScreener::ChainClosableScreener( Size const five_prime_chain_break_res, Size const gap_size ):
		five_prime_chain_break_res_( five_prime_chain_break_res ),
		three_prime_chain_break_res_( five_prime_chain_break_res + 1 ),
		gap_size_( gap_size )
	{}

	ChainClosableScreener::ChainClosableScreener( Size const five_prime_chain_break_res,
	...
	//Destructor
	ChainClosableScreener::~ChainClosableScreener()
	{}

	/////////////////////////////////////////////////////////////////////////////////////////////////
	bool
	ChainClosableScreener::check_screen( pose::Pose const & pose,
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////
	bool
	ChainClosableScreener::check_screen( pose::Pose const & moving_pose,
																			 pose::Pose const & reference_pose,
																			 bool const is_prepend,
																			 bool const strict /* = false */ ) const {
		if ( is_prepend ) return check_chain_closable( moving_pose, reference_pose, strict );
		return check_chain_closable( reference_pose, moving_pose, strict );
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////
	bool
	ChainClosableScreener::check_screen(  utility::vector1< core::pose::PoseOP > const & pose_data_list,
	...
	ChainClosableScreener::check_screen(  pose::Pose const & pose,
		...
		return check_chain_closable( reference_res, pose, rsd_at_origin_list, moving_res_base_stub, is_prepend );
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////
	bool
	ChainClosableScreener::check_chain_closable( pose::Pose const & five_prime_pose, pose::Pose const & three_prime_pose, bool const strict ) const {

		if ( strict ) return check_chain_closable_strict( five_prime_pose, three_prime_pose );
		return check_chain_closable( five_prime_pose, three_prime_pose );
	}


	//////////////////////////////////////////////////////////////////////////////////////////////////////
	bool
	ChainClosableScreener::check_chain_closable( pose::Pose const & five_prime_pose, pose::Pose const & three_prime_pose ) const {
		return check_chain_closable( three_prime_pose.residue( three_prime_chain_break_res_ ).xyz( " C5'" ),
																  five_prime_pose.residue( five_prime_chain_break_res_  ).xyz( " O3'" ) );
	}

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	bool
	ChainClosableScreener::check_chain_closable( core::Size const & reference_res,
		...
		for ( Size n = 1; n <= pose_data_list.size(); n++ ){
			pose::Pose const & pose = ( *pose_data_list[n] );
			if ( check_chain_closable( reference_res, pose, rsd_at_origin_list, moving_res_base_stub, is_prepend ) ) return true;
		}
		return false;
	}
	...
	ChainClosableScreener::check_chain_closable( core::Size const & reference_res,
		...
		for ( Size n = 1; n <= rsd_at_origin_list.size(); n++ ){
			...
			if ( check_chain_closable( atom_coordinate, pose.residue( reference_res ).xyz( reference_atom_name ) ) ) return true;
		}
	...
	void
	ChainClosableScreener::get_specific_atom_coordinate( std::string const & atom_name,
	...
	//
	bool
	ChainClosableScreener::check_chain_closable_strict( pose::Pose const & five_prime_pose, pose::Pose const & three_prime_pose ) const {
	...
	//
	void
	ChainClosableScreener::get_C4_C3_distance_range( conformation::Residue const & five_prime_rsd,
