...
/// @file protocols/stepwise/legacy/sampling/StepWiseLegacyMinimizer.hh
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_stepwise_sampling_StepWiseLegacyMinimizer_HH
#define INCLUDED_protocols_stepwise_sampling_StepWiseLegacyMinimizer_HH

#include <protocols/moves/Mover.hh>
#include <protocols/stepwise/legacy/sampling/StepWiseLegacyMinimizer.fwd.hh>
