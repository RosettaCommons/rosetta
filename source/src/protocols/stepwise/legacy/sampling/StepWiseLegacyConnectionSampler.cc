...
/// @file protocols/stepwise/legacy/sampling/StepWiseLegacyConnectionSampler.cc
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#include <protocols/stepwise/legacy/sampling/StepWiseLegacyConnectionSampler.hh>
...
static basic::Tracer TR( "protocols.stepwise.legacy.sampling.StepWiseLegacyConnectionSampler" );
