...
#include <protocols/stepwise/legacy/sampling/StepWiseLegacyMinimizer.hh>
...
static basic::Tracer TR( "protocols.stepwise.legacy.sampling.StepWiseLegacyMinimizer" );
...
namespace sampling {
	...
	StepWiseLegacyMinimizer::do_rna_minimizing( pose::Pose & pose ) {
		...
		modeler_options::StepWiseModelerOptionsOP minimizer_options = modeler_options_->clone();
