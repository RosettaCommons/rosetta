...
/// @file protocols/stepwise/legacy/sampling/StepWiseLegacyConnectionSampler.hh
/// @brief
/// @detailed
...
#include <protocols/stepwise/legacy/sampling/StepWiseLegacyConnectionSampler.fwd.hh>
