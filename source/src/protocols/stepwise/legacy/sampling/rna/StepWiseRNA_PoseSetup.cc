...
static basic::Tracer TR( "protocols.stepwise.legacy.sampling.rna.StepWiseRNA_PoseSetup" ) ;
...
//////////////////////////////////////////////////////////////////////////
//constructor!
StepWiseRNA_PoseSetup::StepWiseRNA_PoseSetup( stepwise::sampling::working_parameters::StepWiseWorkingParametersOP & working_parameters ):
...
StepWiseRNA_PoseSetup::setup_native_pose( core::pose::Pose & pose ){
	...
	utility::vector1< core::Size > const working_native_virtual_res_list_ = apply_full_to_sub_mapping( native_virtual_res_list_, stepwise::sampling::working_parameters::StepWiseWorkingParametersCOP( working_parameters_ ) );
...
StepWiseRNA_PoseSetup::read_input_pose_and_copy_dofs( pose::Pose & pose )
{
	...
	for ( Size i = 1; i <= input_tags_.size(); i++ ){
		...
		utility::vector1< Size > const & working_cutpoint_closed_list = apply_full_to_sub_mapping( cutpoint_closed_list, stepwise::sampling::working_parameters::StepWiseWorkingParametersCOP( working_parameters_ ) );
	...
	for ( Size seq_num = 1; seq_num <= pose.total_residue(); seq_num++ ){
		...
		if ( working_protonated_H1_adenosine_list.has_value( seq_num ) ){
			...
			if ( pose.residue( seq_num ).aa() != core::chemical::na_rad ){
				print_WorkingParameters_info( stepwise::sampling::working_parameters::StepWiseWorkingParametersCOP( working_parameters_ ), "DEBUG working_parameters", TR.Debug );
