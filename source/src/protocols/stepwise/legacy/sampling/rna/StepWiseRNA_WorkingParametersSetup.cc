...
static basic::Tracer TR( "protocols.stepwise.legacy.sampling.rna.StepWiseRNA_WorkingParametersSetup" );
...
namespace rna {
  ...
  //constructor!
	StepWiseWorkingParametersSetup::StepWiseWorkingParametersSetup( utility::vector1< core::Size > const & moving_res_list,
		...
		working_parameters_( new stepwise::sampling::working_parameters::StepWiseWorkingParameters ),
  ...
  {
		stepwise::sampling::rna::output_title_text( "Enter StepWiseWorkingParametersSetup::constructor", TR.Debug );
		...
		///////////////////////////////////////////////////////
		stepwise::sampling::rna::output_seq_num_list( "input_res = ", input_res, TR.Debug, 30 );
		stepwise::sampling::rna::output_seq_num_list( "input_res2 = ", input_res2, TR.Debug, 30 );
		stepwise::sampling::rna::output_seq_num_list( "moving_res_list = ", moving_res_list_, TR.Debug, 30 );
		...
		stepwise::sampling::rna::output_title_text( "Exit StepWiseWorkingParametersSetup::constructor", TR.Debug );
	}
  ...
  {}
	...
	StepWiseWorkingParametersSetup::apply() {
		...
		stepwise::sampling::rna::output_title_text( "Enter StepWiseRNA_JobParameter_Setup::apply", TR.Debug );
		...
		if ( !skip_complicated_stuff_ ){
			...
			stepwise::sampling::rna::InternalWorkingResidueParameter const internal_params = figure_out_partition_definition();
		...
		stepwise::sampling::rna::output_title_text( "Exit StepWiseRNA_JobParameter_Setup::apply", TR.Debug );
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	StepWiseWorkingParametersSetup::get_user_input_alignment_res_list( core::Size const root_res ){
		...
		stepwise::sampling::rna::output_title_text( "Enter get_user_input_alignment_res_list", TR.Debug );
		...
		stepwise::sampling::rna::output_seq_num_list( "fixed_res = ", fixed_res_, TR.Debug, 30 );
		...
		stepwise::sampling::rna::output_seq_num_list( "best_working_align = ", apply_sub_to_full_mapping( working_best_alignment, working_parameters_ ), TR.Debug, 30 );
...
//		}
		...
		stepwise::sampling::rna::output_title_text( "", TR.Debug );
		return working_best_alignment;
	...
	StepWiseWorkingParametersSetup::figure_out_best_working_alignment(){
		...
		stepwise::sampling::rna::output_title_text( "Enter StepWiseWorkingParametersSetup::figure_out_best_working_alignment. no user specified alignment, have to figure this out internally", TR.Debug );
		...
		stepwise::sampling::rna::output_seq_num_list( "working_fixed_res = ", working_fixed_res, TR.Debug, 30 );
		stepwise::sampling::rna::output_seq_num_list( "working_alignment = ", working_alignment, TR.Debug, 30 );
		stepwise::sampling::rna::output_seq_num_list( "working_alignment = ", working_alignment, TR.Debug, 30 );
	...
	StepWiseWorkingParametersSetup::figure_out_working_sequence_and_mapping(){ //working_sequence is now updated internally by WP.
		...
		stepwise::sampling::rna::output_title_text( "Enter StepWiseWorkingParametersSetup::figure_out_working_sequence_and_mapping", TR.Debug );
	...
	StepWiseWorkingParametersSetup::figure_out_is_residue_prepend( Size const seq_num ) const {
		...
		stepwise::sampling::rna::output_title_text("Enter StepWiseWorkingParametersSetup::figure_out_is_residue_prepend", TR.Debug );
...
//		stepwise::sampling::rna::output_title_text("", TR.Debug );
	...
	StepWiseWorkingParametersSetup::figure_out_is_prepend_map(){
		...
		stepwise::sampling::rna::output_title_text( "Enter StepWiseWorkingParametersSetup::figure_out_is_residue_prepend_map", TR.Debug );

		utility::vector1< core::Size > const & calc_rms_res = working_parameters_->calc_rms_res();
		stepwise::sampling::rna::output_seq_num_list( "calc_rms_res = ", calc_rms_res, TR.Debug, 30 );
	...
	StepWiseWorkingParametersSetup::get_previously_closed_cutpoint_from_imported_silent_file() const{
		...
		stepwise::sampling::rna::output_seq_num_list( "previously_closed_cutpoint_ = ", previously_closed_cutpoint, TR.Debug, 30 );
	...
	StepWiseWorkingParametersSetup::setup_additional_cutpoint_closed(){
		...
		stepwise::sampling::rna::output_title_text( "Enter StepWiseWorkingParametersSetup::setup_additional_cutpoint_closed", TR.Debug );
		utility::vector1< core::Size > const & is_working_res( working_parameters_->is_working_res() );
		...
		output_bool_list( "is_working_res = ", is_working_res, TR.Debug, 30 );
		stepwise::sampling::rna::output_seq_num_list( "fixed res = ", fixed_res_, TR.Debug, 30 );
		stepwise::sampling::rna::output_seq_num_list( "non_fixed res = ", non_fixed_res, TR.Debug, 30 );
		...
		stepwise::sampling::rna::output_seq_num_list( "cutpoint_closed_ = ", new_cutpoint_closed_list, TR.Debug, 30 );
		stepwise::sampling::rna::output_title_text( "", TR.Debug );
	...
	StepWiseWorkingParametersSetup::figure_out_chain_boundaries(){
		...
		stepwise::sampling::rna::output_title_text( "Enter StepWiseWorkingParametersSetup::figure_out_chain_boundaries", TR.Debug );
	...
	StepWiseWorkingParametersSetup::figure_out_jump_partners() {
		...
		stepwise::sampling::rna::output_title_text( "StepWiseWorkingParametersSetup::figure_out_jump_partners", TR.Debug );
	...
	StepWiseWorkingParametersSetup::setup_fold_tree(){
		...
		stepwise::sampling::rna::output_title_text( "Enter StepWiseWorkingParametersSetup::setup_fold_tree", TR.Debug );
	...
	///////////////////////////////////////////////////////////////////////////////////
	stepwise::sampling::rna::InternalWorkingResidueParameter
...
//		Size const & moving_suite( working_parameters_->working_moving_suite() );
		...
		stepwise::sampling::rna::InternalWorkingResidueParameter internal_working_res_params;
		...
		if ( ( working_moving_res == 1 || fold_tree.is_cutpoint( working_moving_res - 1 ) ) && !force_internal_ ) { //prepend
			...
			if ( !can_prepend && !can_append ){
				stepwise::sampling::rna::output_seq_num_list( "working_moving_res_list:", working_moving_res_list, TR.Debug );
	...
	StepWiseWorkingParametersSetup::reroot_fold_tree( core::Size const fake_working_moving_suite ){
		...
		stepwise::sampling::rna::output_title_text( "Enter StepWiseWorkingParametersSetup::reroot_fold_tree", TR.Debug );
	...
	/////////////////////////////////////////////////////////////////
	void
	StepWiseWorkingParametersSetup::figure_out_prepend_internal( core::Size const root_res, stepwise::sampling::rna::InternalWorkingResidueParameter const & internal_params ){

		stepwise::sampling::rna::output_title_text( "Enter StepWiseWorkingParametersSetup::figure_out_prepend_internal", TR.Debug );
		std::map< core::Size, core::Size > & sub_to_full( working_parameters_->sub_to_full() );
				...
				if ( working_moving_res_list.size() == 1 ){
					...
					if ( can_prepend ){
						...
						if ( check_can_prepend( actual_working_moving_res_list ) == false ){
							stepwise::sampling::rna::output_seq_num_list( "actual_working_moving_res_list = ", actual_working_moving_res_list, TR.Debug );
...
//////////////////////////////////////////////////////////////
			...
			stepwise::sampling::rna::output_seq_num_list( "actual_working_moving_res_list = ", actual_working_moving_res_list, TR.Debug );
			stepwise::sampling::rna::output_seq_num_list( "user_input_working_moving_res_list = ", working_moving_res_list, TR.Debug );
  ...
  //////////////////////////////////////////////////////////////////////////
	...
	StepWiseWorkingParametersSetup::set_fixed_res( utility::vector1 < core::Size > const & fixed_res ){
		...
		stepwise::sampling::rna::output_title_text( "Enter StepWiseWorkingParametersSetup::set_fixed_res", TR.Debug );
...
//		stepwise::sampling::rna::output_seq_num_list("working_terminal_res= ", working_parameters_->working_terminal_res(), TR.Debug, 30 );
	}
  ...
  //////////////////////////////////////////////////////////////////////////
	...
	StepWiseWorkingParametersSetup::set_native_alignment_res( utility::vector1< Size > const & setting ){
		...
		working_parameters_->set_working_native_alignment(  apply_full_to_sub_mapping( native_alignment, stepwise::sampling::working_parameters::StepWiseWorkingParametersCOP( working_parameters_ ) ) );

		stepwise::sampling::rna::output_title_text( "StepWiseWorkingParametersSetup::set_native_alignment_res", TR.Debug );
		stepwise::sampling::rna::output_seq_num_list( "native_alignment = ", working_parameters_->native_alignment(), TR.Debug );
		stepwise::sampling::rna::output_seq_num_list( "working_native_alignment = ", working_parameters_->working_native_alignment(), TR.Debug );
		stepwise::sampling::rna::output_title_text( "", TR.Debug );
