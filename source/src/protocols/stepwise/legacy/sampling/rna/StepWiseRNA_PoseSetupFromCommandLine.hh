...
/// @file protocols/stepwise/legacy/sampling/rna/StepWiseRNA_PoseSetupFromCommandLine.hh
/// @brief
/// @detailed
...
namespace rna {
	...
	stepwise::sampling::working_parameters::StepWiseWorkingParametersOP setup_simple_full_length_rna_working_parameters();

	stepwise::sampling::working_parameters::StepWiseWorkingParametersOP setup_rna_working_parameters( bool check_for_previously_closed_cutpoint_with_input_pose = false );

	void setup_copy_DOF_input( StepWiseRNA_PoseSetupOP & stepwise_rna_pose_setup );

	StepWiseRNA_PoseSetupOP setup_pose_setup_class( stepwise::sampling::working_parameters::StepWiseWorkingParametersOP & working_parameters, bool const copy_DOF = true );
