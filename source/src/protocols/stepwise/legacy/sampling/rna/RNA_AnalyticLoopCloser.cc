...
// Unit headers
#include <protocols/stepwise/legacy/sampling/rna/RNA_AnalyticLoopCloser.hh>
...
static basic::Tracer TR( "protocols.stepwise.legacy.sampling.rna.RNA_AnalyticLoopCloser" );
