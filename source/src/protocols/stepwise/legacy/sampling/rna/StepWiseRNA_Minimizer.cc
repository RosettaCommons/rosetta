...
#include <protocols/stepwise/sampling/modeler_options/StepWiseModelerOptions.hh> //Sept 26, 2011
...
static basic::Tracer TR( "protocols.stepwise.legacy.sampling.rna.StepWiseRNA_Minimizer" ) ;
...
StepWiseRNA_Minimizer::StepWiseRNA_Minimizer(
		...
		stepwise::sampling::working_parameters::StepWiseWorkingParametersCOP & working_parameters ) :
...
StepWiseRNA_Minimizer::apply( core::pose::Pose & pose ) {
	...
	stepwise::sampling::rna::output_title_text( "Enter StepWiseRNA_Minimizer::apply", TR.Debug );
	output_parameters();
	...
	stepwise::sampling::rna::output_title_text( "Exit StepWiseRNA_Minimizer::apply", TR.Debug );
...
StepWiseRNA_Minimizer::pass_all_pose_screens( core::pose::Pose & pose, std::string const in_tag, core::io::silent::SilentFileData & silent_file_data ) const{
	...
	//In Both standard and floating base sampling, user_input_VDW_bin_checker_ is not used for gap_size==0 or internal case.
...
StepWiseRNA_Minimizer::get_working_moving_res( Size const & nres ) const {
	...
	//	stepwise::sampling::rna::output_seq_num_list( "working_moving_res", working_moving_res );
...
StepWiseRNA_Minimizer::output_parameters(){
	...
	stepwise::sampling::rna::output_seq_num_list( " working_global_sample_res_list = ", working_parameters_->working_global_sample_res_list(), TR.Debug );
...
//////////////////////////////////////////////////////////////////
void
StepWiseRNA_Minimizer::set_options( modeler_options::StepWiseModelerOptionsOP options ){
	options_ = options;
}
