...
namespace connection {
	...
	public:
		...
		//constructor
		StepWiseRNA_ConnectionSampler( stepwise::sampling::working_parameters::StepWiseWorkingParametersCOP & working_parameters_ );
	...
	private:
		...
		stepwise::sampling::working_parameters::StepWiseWorkingParametersCOP working_parameters_; //need to use the full_to_sub map...should convert to const style.. Parin Feb 28, 2010
	};
