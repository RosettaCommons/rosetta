...
#include <protocols/stepwise/legacy/sampling/rna/StepWiseRNA_Minimizer.fwd.hh>
...
namespace rna {
  ...
  public:
    ...
    void
		...
		void
		set_options( modeler_options::StepWiseModelerOptionsOP options );
  ...
  private:
	...
	private:
		...
		modeler_options::StepWiseModelerOptionsOP options_;
