...
/// @file protocols/stepwise/screener/ChainClosureScreener.hh
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_stepwise_screener_ChainClosureScreener_HH
#define INCLUDED_protocols_stepwise_screener_ChainClosureScreener_HH

#include <protocols/stepwise/screener/SampleApplier.hh>
#include <protocols/stepwise/screener/ChainClosureScreener.fwd.hh>
...
namespace screener {
	...
	class ChainClosureScreener: public SampleApplier {
	...
	public:
		...
		std::string
		name() const { return "ChainClosureScreener"; }

		StepWiseScreenerType
		type() const { return CHAIN_CLOSURE; }
