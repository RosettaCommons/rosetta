...
/// @file protocols/stepwise/screener/legacy/SimpleRMSD_Screener.hh
/// @brief
/// @detailed
...
#include <protocols/stepwise/screener/legacy/SimpleRMSD_Screener.fwd.hh>
...
namespace screener {
	...
	class SimpleRMSD_Screener: public StepWiseScreener {
