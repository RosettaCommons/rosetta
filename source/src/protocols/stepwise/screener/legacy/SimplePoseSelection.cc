...
/// @file protocols/stepwise/screener/legacy/SimplePoseSelection.cc
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#include <protocols/stepwise/screener/legacy/SimplePoseSelection.hh>
#include <protocols/stepwise/sampling/align/StepWiseLegacyClusterer.hh>
#include <core/pose/Pose.hh>

#include <basic/Tracer.hh>

static basic::Tracer TR( "protocols.stepwise.screener.SimplePoseSelection" );
...
namespace screener {
	...
	SimplePoseSelection::SimplePoseSelection( pose::Pose const & pose,
																						...
																						sampling::StepWiseModelerOptionsCOP options,
