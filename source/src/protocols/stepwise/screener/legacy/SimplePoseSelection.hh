...
/// @file protocols/stepwise/screener/legacy/SimplePoseSelection.hh
/// @brief
/// @detailed
...
#include <protocols/stepwise/screener/legacy/SimplePoseSelection.fwd.hh>
...
namespace screener {
	...
	private:
		...
		sampling::StepWiseModelerOptionsCOP options_;
