...
/// @file protocols/stepwise/screener/legacy/RNA_AtrRepScreener.hh
/// @brief
/// @detailed
...
#include <protocols/stepwise/screener/legacy/RNA_AtrRepScreener.fwd.hh>
...
namespace screener {
	...
	class RNA_AtrRepScreener: public StepWiseScreener {
