...
#ifndef INCLUDED_protocols_stepwise_screener_ChainClosableGeometryStubBasedScreener_HH
#define INCLUDED_protocols_stepwise_screener_ChainClosableGeometryStubBasedScreener_HH

#include <protocols/stepwise/screener/StepWiseResiduePairScreener.hh>
#include <protocols/stepwise/screener/ChainClosableGeometryStubBasedScreener.fwd.hh>
...
namespace screener {
	...
	class ChainClosableGeometryStubBasedScreener: public StepWiseResiduePairScreener {

	public:

		//constructor
		ChainClosableGeometryStubBasedScreener( sampling::rna::checker::ChainClosableGeometryCheckerOP chain_closable_geometry_checker,
	...
	public:
		...
		std::string
		name() const { return "ChainClosableGeometryStubBasedScreener"; }

		StepWiseScreenerType
		type() const { return CHAIN_CLOSABLE_GEOMETRY_STUB_BASED; }
