...
namespace screener {
	...
	public:
		...
		//constructor
		ProteinCCD_ClosureScreener( sampling::protein::loop_close::StepWiseProteinCCD_CloserOP ccd_closer,
	...
	private:
		...
		sampling::protein::loop_close::StepWiseProteinCCD_CloserOP ccd_closer_;
