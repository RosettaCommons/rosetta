...
namespace polar_hydrogens {
	...
	typedef utility::pointer::owning_ptr< PolarHydrogenPacker > PolarHydrogenPackerOP;
	typedef utility::pointer::owning_ptr< PolarHydrogenPacker const > PolarHydrogenPackerCOP;
