...
StepWiseRNA_VirtualSugarSampler::bulge_chain_closure_legacy( utility::vector1< PoseOP > & pose_list,
	...
	using namespace rotamer_sampler::rna;
	using namespace protocols::stepwise::enumerate::rna::screener;
	...
	TR.Debug << "Total time in bulge_chain_closure SAMPLING: " << static_cast< Real > ( clock() - time_start_sampling ) / CLOCKS_PER_SEC << std::endl;
