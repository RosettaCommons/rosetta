...
/// @file protocols/stepwise/enumerate/rna/phosphate/MultiPhosphateSampler.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.stepwise.enumerate.rna.phosphate.MultiPhosphateSampler" );
