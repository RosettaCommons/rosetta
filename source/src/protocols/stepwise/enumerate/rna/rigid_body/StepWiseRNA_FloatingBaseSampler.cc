...
/// @file protocols/stepwise/enumerate/rna/rigid_body/StepWiseRNA_FloatingBaseSampler.cc
/// @brief
/// @detailed
...
//
// As with StepWiseRNA_ClassicResidueSampler, this Sampler uses several poses and screeners to reduce the number of variant changes &
