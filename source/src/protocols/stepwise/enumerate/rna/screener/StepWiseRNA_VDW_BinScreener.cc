...
static basic::Tracer TR( "protocols.stepwise.rna.screener.StepWiseRNA_VDW_BinScreener" );
...
namespace screener {
  ...
  //constructor!
	StepWiseRNA_VDW_BinScreener::StepWiseRNA_VDW_BinScreener():
//		max_distance_(40.0),
...
//		max_distance_(60.0), //Oct 26, Change from 40.0 to 60.0. In rare instances, minimization will move moving_res and reference res very far from initial pos of reference res.
		...
		output_pdb_( false )
	{
		...
		//Crap...THIS CODE ASSUMES that residue next to the sampling res (on both 3' and 5' end) need to either be virtualized or not be part of the VDW_rep_screener in the first place.
...
//////////////////////////////////////////////////////
  ...
  {}
	...
	void
	StepWiseRNA_VDW_BinScreener::setup_using_working_pose( core::pose::Pose const & const_working_pose, StepWiseRNA_JobParametersCOP const & job_parameters ){

		output_title_text( "Enter StepWiseRNA_VDW_BinScreener::setup_using_working_pose", TR.Debug );
		...
		output_title_text( "Exit StepWiseRNA_VDW_BinScreener::setup_using_working_pose", TR.Debug );
	...
	StepWiseRNA_VDW_BinScreener::get_matching_res_in_VDW_rep_screen_pose( core::pose::Pose const & VDW_rep_screen_pose,
		...
		output_title_text( "Enter StepWiseRNA_VDW_BinScreener::get_matching_res_in_VDW_rep_screen_pose", TR.Debug );
		...
		if ( VDW_rep_ignore_matching_res_.size() == 1 ){
			if ( VDW_rep_ignore_matching_res_[1] == "false" ){
				...
				empty_list.clear();
				output_title_text( "Exit StepWiseRNA_VDW_BinScreener::delete_matching_res_in_VDW_rep_screen_pose", TR );
				return empty_list;
			}
		}
		...
		*/
		...
		output_title_text( "Exit StepWiseRNA_VDW_BinScreener::delete_matching_res_in_VDW_rep_screen_pose", TR.Debug );
	...
	void
	StepWiseRNA_VDW_BinScreener::align_VDW_rep_screen_pose( core::pose::Pose & VDW_rep_screen_pose,
																				 							 core::pose::Pose const & working_pose,
																				 							 utility::vector1< core::Size > const & VDW_rep_screen_align_res,
																				 							 utility::vector1< core::Size > const & working_align_res,
		...
		if ( verbose ) output_title_text( "Enter StepWiseRNA_VDW_BinScreener::align_VDW_rep_screen_pose()", TR );
		...
		if ( verbose ) output_title_text( "Exit StepWiseRNA_VDW_BinScreener::align_VDW_rep_screen_pose()", TR );
	...
	/*
	void
	StepWiseRNA_VDW_BinScreener::align_to_first_working_pose( core::pose::Pose & pose, std::string const & tag ) const {
	...
	*/
	...
	void
	StepWiseRNA_VDW_BinScreener::create_VDW_rep_screen_pose( VDW_RepScreeninfo & VDW_rep_screen_info, //This function update this class!
																				 								core::pose::Pose const & working_pose,
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	StepWiseRNA_VDW_BinScreener::FARFAR_setup_using_user_input_VDW_pose( utility::vector1< std::string > const & All_VDW_rep_screen_pose_info,
		...
		output_title_text( "Enter StepWiseRNA_VDW_BinScreener::FARFAR_setup_using_user_input_VDW_pose", TR.Debug );
		...
		if ( verbose ) output_title_text( "Exit StepWiseRNA_VDW_BinScreener::FARFAR_setup_using_user_input_VDW_pose", TR );
	...
	void
	StepWiseRNA_VDW_BinScreener::setup_using_user_input_VDW_pose( utility::vector1< std::string > const & All_VDW_rep_screen_pose_info,
                                                                core::pose::Pose const & const_working_pose,
	  ...
	  using namespace core::chemical;
		...
		output_title_text( "Enter StepWiseRNA_VDW_BinScreener::setup_using_user_input_VDW_pose", TR.Debug );
		...
		if ( num_rep_screen_pose_info_in_root_partition == 0 ){
			...
			if ( working_fixed_res_in_root_partition.size() == 0 ) {
				TR.Debug << "No VDW_screener_pose since working_fixed_res_in_root_partition.size() == 0, probably build inward " << std::endl;
				user_inputted_VDW_screen_pose_ = false;
				return;
			} else{
		...
		if ( verbose ) output_title_text( "Exit StepWiseRNA_VDW_BinScreener::setup_using_user_input_VDW_pose", TR.Debug );

	}

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	StepWiseRNA_VDW_BinScreener::update_VDW_screen_bin( core::pose::Pose const & pose,
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	StepWiseRNA_VDW_BinScreener::create_VDW_screen_bin( core::pose::Pose const & pose,
																											utility::vector1< core::Size > const & ignore_res_list,
																											bool const is_prepend,  //associated with ignore_res_list
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	StepWiseRNA_VDW_BinScreener::create_VDW_screen_bin( utility::vector1< VDW_RepScreeninfo > const & VDW_rep_screen_info_list,
																											numeric::xyzVector< core::Real > const & reference_xyz,
																											bool const verbose ){
	...
	void
	StepWiseRNA_VDW_BinScreener::create_VDW_screen_bin( utility::vector1< core::pose::Pose > const & pose_list,
	...
	//fast version
	bool
	StepWiseRNA_VDW_BinScreener::VDW_rep_screen( core::pose::Pose const & screening_pose, //Warning..this pose coordinate is not update...use here for VIRTUAL atom screening.
	...
	bool
	StepWiseRNA_VDW_BinScreener::user_inputted_VDW_screen_pose() const {
	...
	void
	StepWiseRNA_VDW_BinScreener::reference_xyz_consistency_check( numeric::xyzVector< core::Real > const & inputted_reference_xyz ) const {
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void
	StepWiseRNA_VDW_BinScreener::check_VDW_screen_bin_is_setup() const {
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	bool
	StepWiseRNA_VDW_BinScreener::is_atom_bin_in_range( Atom_Bin const & atom_pos_bin ) const {
	...
	bool
 	StepWiseRNA_VDW_BinScreener::check_atom_bin_in_range( Atom_Bin const & atom_pos_bin ){
	...
	void
	StepWiseRNA_VDW_BinScreener::set_reference_xyz( numeric::xyzVector< core::Real > const & reference_xyz ){
	...
	Atom_Bin
	StepWiseRNA_VDW_BinScreener::get_atom_bin( numeric::xyzVector< core::Real > const & atom_pos ) const{
	...
	StepWiseRNA_VDW_BinScreener::get_atom_pos( Atom_Bin const & atom_bin ) const {
	...
	void
	StepWiseRNA_VDW_BinScreener::output_atom_bin( std::string const filename ) const{
