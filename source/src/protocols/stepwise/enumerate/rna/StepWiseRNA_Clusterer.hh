...
namespace rna {
	...
	class SlicedPoseJobParameters: public utility::pointer::ReferenceCount{
		...
		public:
			...
			void 
			setup( protocols::stepwise::enumerate::rna::StepWiseRNA_JobParametersCOP & job_parameters );
  ...
  public:
    ...
    /// @brief Filter a list of poses by score.
		...
		void set_job_parameters( protocols::stepwise::enumerate::rna::StepWiseRNA_JobParametersCOP & job_parameters );
		...
		void
		set_user_input_VDW_bin_screener( protocols::stepwise::enumerate::rna::screener::StepWiseRNA_VDW_BinScreenerOP const & user_input_VDW_bin_screener ){ user_input_VDW_bin_screener_ = user_input_VDW_bin_screener; }
  ...
  private:
		...
		bool rename_tags_;
		protocols::stepwise::enumerate::rna::StepWiseRNA_JobParametersCOP job_parameters_;
		...
		protocols::stepwise::enumerate::rna::screener::StepWiseRNA_VDW_BinScreenerOP user_input_VDW_bin_screener_;
