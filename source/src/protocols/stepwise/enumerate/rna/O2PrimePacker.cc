...
O2PrimePacker::sample_o2prime_hydrogen(){
	...
	stepwise::enumerate::rna::copy_all_o2prime_torsions( o2prime_pack_pose_, pose_with_original_HO2prime_torsion_ );
...
O2PrimePacker::copy_all_o2prime_torsions( core::pose::Pose & mod_pose ) const {
	stepwise::enumerate::rna::copy_all_o2prime_torsions( mod_pose, o2prime_pack_pose_ );
}
