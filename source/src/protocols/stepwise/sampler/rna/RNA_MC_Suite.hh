...
/// @file protocols/stepwise/sampler/rna/RNA_MC_Suite.hh
/// @brief Markov chain sampler for RNA suite.
/// @author Fang-Chieh Chou

#ifndef INCLUDED_protocols_sampler_rna_RNA_MC_Suite_HH
#define INCLUDED_protocols_sampler_rna_RNA_MC_Suite_HH
...
public:
	...
	virtual StepWiseSamplerType type() const { return RNA_MC_SUITE; }
