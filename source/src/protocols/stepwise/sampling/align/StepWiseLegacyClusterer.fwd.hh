...
namespace align {
	...
	typedef utility::pointer::owning_ptr< StepWiseLegacyClusterer > StepWiseLegacyClustererOP;
	typedef utility::pointer::owning_ptr< StepWiseLegacyClusterer const > StepWiseLegacyClustererCOP;
