...
/// @file StepWiseClustererSilentBased.hh
/// @brief
/// @detailed
///
/// @author Rhiju Das
...
#ifndef INCLUDED_protocols_stepwise_StepWiseClustererSilentBased_HH
#define INCLUDED_protocols_stepwise_StepWiseClustererSilentBased_HH

#include <protocols/stepwise/sampling/general/StepWiseClustererSilentBased.fwd.hh>
...
namespace general {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////////////////////////////////////
  class StepWiseClustererSilentBased: public utility::pointer::ReferenceCount {
  public:

    //constructor!
		StepWiseClustererSilentBased( utility::vector1< std::string > const & silent_files_in );

		StepWiseClustererSilentBased( std::string const & silent_file_in );

		StepWiseClustererSilentBased(  core::io::silent::SilentFileDataOP & sfd );

		// convenience constructor, used in StepWiseProteinModeler
		StepWiseClustererSilentBased( core::io::silent::SilentFileDataOP silent_file_data,
											 utility::vector1< Size > const & moving_res_list,
											 protein::StepWiseProteinModelerOptionsCOP options,
											 bool const force_align );

    //destructor -- necessary?
    virtual ~StepWiseClustererSilentBased();
