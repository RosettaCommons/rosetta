...
/// @file protocols/stepwise/sampling/working_parameters/StepWiseBasicWorkingParameters.cc
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#include <protocols/stepwise/sampling/working_parameters/StepWiseBasicWorkingParameters.hh>
#include <core/pose/Pose.hh>
#include <utility/exit.hh>
#include <basic/Tracer.hh>

static basic::Tracer TR( "protocols.stepwise.sampling.working_parameters.StepWiseBasicWorkingParameters" );
