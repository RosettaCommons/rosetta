...
#ifndef INCLUDED_protocols_stepwise_sampling_rna_StepWiseRNA_WorkingParametersUtil_HH
#define INCLUDED_protocols_stepwise_sampling_rna_StepWiseRNA_WorkingParametersUtil_HH
