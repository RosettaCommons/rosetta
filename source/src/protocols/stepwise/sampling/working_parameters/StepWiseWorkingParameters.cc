...
/// @file protocols/stepwise/sampling/working_parameters/StepWiseWorkingParameters.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.stepwise.sampling.working_parameters.StepWiseWorkingParameters" );
...
namespace working_parameters {
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	Size
	StepWiseWorkingParameters::working_reference_res() const{ //the last static_residues that this attach to the moving residues
