...
#include <protocols/stepwise/sampling/rna/legacy/StepWiseRNA_Minimizer.fwd.hh>
...
namespace rna {
  ...
  public:
    ...
    void
		...
		void
		set_options( StepWiseModelerOptionsOP options );
  ...
  private:
	...
	private:
		...
		StepWiseModelerOptionsOP options_;
