...
#ifndef INCLUDED_protocols_stepwise_rna_StepWiseRNA_RigidBodyConnectionSampler_HH
#define INCLUDED_protocols_stepwise_rna_StepWiseRNA_RigidBodyConnectionSampler_HH
...
namespace rigid_body {
	...
	public:
		...
		//constructor
		StepWiseRNA_RigidBodyConnectionSampler( StepWiseRNA_JobParametersCOP & job_parameters_ );

		//destructor
		~StepWiseRNA_RigidBodyConnectionSampler();
