...
static basic::Tracer TR( "protocols.stepwise.rna.StepWiseRNA_Minimizer" ) ;
...
StepWiseRNA_Minimizer::output_parameters(){
	...
	output_seq_num_list( " working_global_sample_res_list = ", working_parameters_->working_global_sample_res_list(), TR.Debug );
...
//////////////////////////////////////////////////////////////////
void
StepWiseRNA_Minimizer::set_options( StepWiseModelerOptionsOP options ){
	options_ = options;
}
