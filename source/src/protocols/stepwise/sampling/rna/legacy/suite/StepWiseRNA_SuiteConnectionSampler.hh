...
/// @file protocols/stepwise/sampling/rna/legacy/suite/StepWiseRNA_SuiteConnectionSampler.hh
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_stepwise_rna_StepWiseRNA_SuiteConnectionSampler_HH
#define INCLUDED_protocols_stepwise_rna_StepWiseRNA_SuiteConnectionSampler_HH

#include <protocols/stepwise/sampling/rna/legacy/suite/StepWiseRNA_SuiteConnectionSampler.fwd.hh>
...
namespace suite {
	...
	class StepWiseRNA_SuiteConnectionSampler: public protocols::moves::MoverForPoseList {

	public:

		//constructor
		StepWiseRNA_SuiteConnectionSampler( StepWiseRNA_JobParametersCOP & job_parameters_ );

		//destructor
		~StepWiseRNA_SuiteConnectionSampler();
