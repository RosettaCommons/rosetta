...
static basic::Tracer TR( "protocols.stepwise.sampling.rna.connection.StepWiseRNA_ConnectionSampler" ) ;
...
//Constructor
StepWiseRNA_ConnectionSampler::StepWiseRNA_ConnectionSampler( working_parameters::StepWiseWorkingParametersCOP & working_parameters ):
...
//////////////////////////////////////////////////////////////////
void
StepWiseRNA_ConnectionSampler::set_options( StepWiseModelerOptionsCOP options ){
	options_ = options;
}
