...
static basic::Tracer TR( "protocols.stepwise.rna.StepWiseWorkingParametersSetup" );
...
namespace legacy {
  ...
  //constructor!
	StepWiseWorkingParametersSetup::StepWiseWorkingParametersSetup( utility::vector1< core::Size > const & moving_res_list,
		...
		working_parameters_( new working_parameters::StepWiseWorkingParameters ),
  ...
  {
		output_title_text( "Enter StepWiseWorkingParametersSetup::constructor", TR.Debug );
		...
		output_title_text( "Exit StepWiseWorkingParametersSetup::constructor", TR.Debug );
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	StepWiseWorkingParametersSetup::get_user_input_alignment_res_list( core::Size const root_res ){
		...
		output_seq_num_list( "best_working_align = ", apply_sub_to_full_mapping( working_best_alignment, working_parameters_ ), TR.Debug, 30 );
...
//		}
	...
	StepWiseWorkingParametersSetup::figure_out_best_working_alignment(){
		...
		output_title_text( "Enter StepWiseWorkingParametersSetup::figure_out_best_working_alignment. no user specified alignment, have to figure this out internally", TR.Debug );
	...
	StepWiseWorkingParametersSetup::figure_out_working_sequence_and_mapping(){ //working_sequence is now updated internally by WP.
		...
		output_title_text( "Enter StepWiseWorkingParametersSetup::figure_out_working_sequence_and_mapping", TR.Debug );
	...
	StepWiseWorkingParametersSetup::figure_out_is_residue_prepend( Size const seq_num ) const {
		...
		output_title_text("Enter StepWiseWorkingParametersSetup::figure_out_is_residue_prepend", TR.Debug );
...
//		output_title_text("", TR.Debug );
	...
	StepWiseWorkingParametersSetup::figure_out_is_prepend_map(){
		...
		output_title_text( "Enter StepWiseWorkingParametersSetup::figure_out_is_residue_prepend_map", TR.Debug );
	...
	StepWiseWorkingParametersSetup::setup_additional_cutpoint_closed(){
		...
		output_title_text( "Enter StepWiseWorkingParametersSetup::setup_additional_cutpoint_closed", TR.Debug );
		utility::vector1< core::Size > const & is_working_res( working_parameters_->is_working_res() );
	...
	StepWiseWorkingParametersSetup::figure_out_chain_boundaries(){
		...
		output_title_text( "Enter StepWiseWorkingParametersSetup::figure_out_chain_boundaries", TR.Debug );
	...
	StepWiseWorkingParametersSetup::figure_out_jump_partners() {
		...
		output_title_text( "StepWiseWorkingParametersSetup::figure_out_jump_partners", TR.Debug );
	...
	StepWiseWorkingParametersSetup::setup_fold_tree(){
		...
		output_title_text( "Enter StepWiseWorkingParametersSetup::setup_fold_tree", TR.Debug );
...
//		Size const & moving_suite( working_parameters_->working_moving_suite() );
	...
	StepWiseWorkingParametersSetup::reroot_fold_tree( core::Size const fake_working_moving_suite ){
		...
		output_title_text( "Enter StepWiseWorkingParametersSetup::reroot_fold_tree", TR.Debug );
	...
	/////////////////////////////////////////////////////////////////
	void
	StepWiseWorkingParametersSetup::figure_out_prepend_internal( core::Size const root_res, InternalWorkingResidueParameter const & internal_params ){

		output_title_text( "Enter StepWiseWorkingParametersSetup::figure_out_prepend_internal", TR.Debug );
		std::map< core::Size, core::Size > & sub_to_full( working_parameters_->sub_to_full() );
...
//////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////////////
	...
	StepWiseWorkingParametersSetup::set_fixed_res( utility::vector1 < core::Size > const & fixed_res ){
		...
		output_title_text( "Enter StepWiseWorkingParametersSetup::set_fixed_res", TR.Debug );
...
//		output_seq_num_list("working_terminal_res= ", working_parameters_->working_terminal_res(), TR.Debug, 30 );
	}
  ...
  //////////////////////////////////////////////////////////////////////////
	...
	StepWiseWorkingParametersSetup::set_native_alignment_res( utility::vector1< Size > const & setting ){
		...
		working_parameters_->set_working_native_alignment(  apply_full_to_sub_mapping( native_alignment, working_parameters::StepWiseWorkingParametersCOP( working_parameters_ ) ) );

		output_title_text( "StepWiseWorkingParametersSetup::set_native_alignment_res", TR.Debug );
		output_seq_num_list( "native_alignment = ", working_parameters_->native_alignment(), TR.Debug );
		output_seq_num_list( "working_native_alignment = ", working_parameters_->working_native_alignment(), TR.Debug );
		output_title_text( "", TR.Debug );
