...
/// @file protocols/stepwise/sampling/rna/checker/ChainClosureChecker.hh
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_stepwise_rna_checker_ChainClosureChecker_HH
#define INCLUDED_protocols_stepwise_rna_checker_ChainClosureChecker_HH
...
namespace checker {
	...
	class ChainClosureChecker: public protocols::moves::Mover {

	public:

		//constructor
		ChainClosureChecker( pose::Pose const & pose, Size const five_prime_res );
	...
	public:
		...
		std::string get_name() const{ return "ChainClosureChecker"; }
