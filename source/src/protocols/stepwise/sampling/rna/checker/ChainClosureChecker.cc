...
/// @file protocols/stepwise/sampling/rna/checker/ChainClosureChecker.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.stepwise.rna.checker.ChainClosureChecker" ) ;
...
namespace checker {
	...
	//Constructor
	ChainClosureChecker::ChainClosureChecker( pose::Pose const & pose, Size const five_prime_res ):
	...
	//Destructor
	ChainClosureChecker::~ChainClosureChecker()
	{}


	////////////////////////////////////////////////////////////////////////////////////////
	void
	ChainClosureChecker::copy_CCD_torsions( pose::Pose & pose ) const {
	...
	////////////////////////////////////////////////////////////////////////////////////////
	void
	ChainClosureChecker::copy_CCD_torsions_general( pose::Pose & pose, Size const five_prime_res, Size const three_prime_res ) const {
	...
	////////////////////////////////////////////////////////////////////////////////////////
	bool
	ChainClosureChecker::check_loop_closed( pose::Pose const & pose ){
	...
	////////////////////////////////////////////////////////////////////////////////////////
	bool
	ChainClosureChecker::chain_break_screening_general( pose::Pose & chain_break_screening_pose,
