...
/// @file protocols/stepwise/sampling/rna/checker/ChainClosableGeometryChecker.hh
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_stepwise_rna_checker_ChainClosableGeometryChecker_HH
#define INCLUDED_protocols_stepwise_rna_checker_ChainClosableGeometryChecker_HH
...
namespace checker {
	...
	class ChainClosableGeometryChecker: public utility::pointer::ReferenceCount {
