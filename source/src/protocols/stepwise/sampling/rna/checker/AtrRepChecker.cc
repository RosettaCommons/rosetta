...
/// @file protocols/stepwise/sampling/rna/checker/AtrRepChecker.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.stepwise.rna.checker.AtrRepChecker" ) ;
...
namespace checker {
	...
	//Destructor
	AtrRepChecker::~AtrRepChecker()
	{}

	///////////////////////////////////////////
	void
	AtrRepChecker::initialize_scorefxn(){
	...
	///////////////////////////////////////////
	void
	AtrRepChecker::initialize_parameters(){
	...
	///////////////////////////////////////////
	void
	AtrRepChecker::get_base_atr_rep_score( core::pose::Pose const & pose ){
	...
	///////////////////////////////////////////////////////////////////////////////
	bool
	AtrRepChecker::check_screen( pose::Pose & current_pose_screen ){
