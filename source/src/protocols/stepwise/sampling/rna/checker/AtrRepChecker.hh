...
/// @file protocols/stepwise/sampling/rna/checker/AtrRepChecker.hh
/// @brief
/// @detailed
/// @author Rhiju Das, rhiju@stanford.edu


#ifndef INCLUDED_protocols_stepwise_rna_checker_AtrRepChecker_HH
#define INCLUDED_protocols_stepwise_rna_checker_AtrRepChecker_HH
...
namespace checker {
	...
	class AtrRepChecker: public utility::pointer::ReferenceCount {
