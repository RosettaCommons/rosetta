...
/// @file protocols/stepwise/sampling/rna/StepWiseRNA_ModelerOptions.hh
/// @brief
/// @detailed
...
namespace rna {
	...
	public:
		...
		void
		setup_options_for_VDW_bin_checker( checker::RNA_VDW_BinCheckerOP user_input_VDW_bin_checker ) const;
