...
/// @file protocols/stepwise/sampling/rna/sugar/StepWiseRNA_VirtualSugarUtil.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.stepwise.sampling.rna.sugar.util" );
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
sampling_starting_pose_data_list( utility::vector1< PoseOP > & starting_pose_data_list,
...
copy_bulge_res_and_sugar_torsion( SugarModeling const & sugar_modeling, core::pose::Pose & pose, core::pose::Pose const & template_pose,
	...
	rotamer_sampler::copy_dofs::ResidueAlternativeSetOP
	convert_sugar_modeling_to_residue_alternative_set( SugarModeling const & sugar_modeling ){
		return new rotamer_sampler::copy_dofs::ResidueAlternativeSet( sugar_modeling.pose_list,
