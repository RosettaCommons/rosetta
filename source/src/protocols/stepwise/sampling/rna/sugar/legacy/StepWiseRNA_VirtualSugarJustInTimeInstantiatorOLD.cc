...
/// @file protocols/stepwise/sampling/rna/sugar/StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD.cc
/// @brief
/// @detailed
...
static basic::Tracer TR( "protocols.stepwise.rna.StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD" );
...
//Constructor
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD( StepWiseRNA_JobParametersCOP & job_parameters ):
...
//Destructor
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::~StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD()
{}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::apply( core::pose::Pose & pose ){
	success_ = do_the_sampling( pose );
}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::do_the_sampling( core::pose::Pose & pose ){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::do_sugar_sampling( pose::Pose & viewer_pose, SugarModeling & sugar_modeling, std::string const name ){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::setup_sugar_modeling( pose::Pose const & pose, Size const moving_res, SugarModeling & sugar_modeling ){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::is_anchor_sugar_virtual( core::pose::Pose const & pose ) {
...
////New June 12, 2011/////
bool
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::is_current_sugar_virtual( core::pose::Pose const & pose ) {
...
bool
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::is_five_prime_chain_break_sugar_virtual( core::pose::Pose const & pose ) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::is_three_prime_chain_break_sugar_virtual( core::pose::Pose const & pose ) {
	if ( gap_size_ != 0 ) return false;
	// Make sure to not over count number of virtual_sugar-virtual_bulge
	// pairs to be build!
...
////////////////////////////////////////////////////////////////////////////////////
bool
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::sampling_sugar() const{
...
////////////////////////////////////////////////////////////////////////////////////
bool
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::sampling_sugar_at_chain_break() const{
...
////////////////////////////////////////////////////////////////////////////////////
void
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::prepare_from_prior_sampled_sugar_jobs( pose::Pose const & pose,
	...
	runtime_assert( pose_explosion_legacy ); // better scheme in new VirtualSugarJustInTimeInstantiator
...
////////////////////////////////////////////////////////////////////////////////////
void
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::prepare_from_prior_sampled_sugar_jobs_for_chain_break( pose::Pose const & pose,
																																																					utility::vector1< PoseOP > & pose_data_list ){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::instantiate_sugar( pose::Pose & pose,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::initialize_parameters( pose::Pose const & pose ){
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::do_consistency_checks(){
...
/////////////////////
SugarModeling const &
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::anchor_sugar_modeling(){ return anchor_sugar_modeling_; }

/////////////////////
void
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::set_scorefxn( core::scoring::ScoreFunctionOP const & scorefxn ){ scorefxn_ = scorefxn; }

/////////////////////
std::string
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::get_name() const {
	return "StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD";
}

//////////////////////////////////////////////////////////////////
void
StepWiseRNA_VirtualSugarJustInTimeInstantiatorOLD::set_options( StepWiseRNA_ModelerOptionsCOP options ){
	options_ = options;
}
