...
/// @file protocols/stepwise/sampling/rna/sugar/util.hh
/// @brief
/// @detailed
...
namespace sugar {
	...
	minimize_all_sampled_floating_bases( core::pose::Pose & viewer_pose,
																			 ...
																			 core::scoring::ScoreFunctionCOP const & sampling_scorefxn,
	...
	rotamer_sampler::copy_dofs::ResidueAlternativeSetOP convert_sugar_modeling_to_residue_alternative_set( SugarModeling const & sugar_modeling );
