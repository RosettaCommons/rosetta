...
/// @file protocols/stepwise/sampling/rna/StepWiseRNA_ModelerOptions.cc
/// @brief
/// @detailed
...
namespace rna {
	...
	////////////////////////////////////////////////////////////////
	void
	StepWiseRNA_ModelerOptions::setup_options_for_VDW_bin_checker( checker::RNA_VDW_BinCheckerOP user_input_VDW_bin_checker ) const {
		user_input_VDW_bin_checker->set_VDW_rep_alignment_RMSD_CUTOFF ( VDW_rep_alignment_RMSD_CUTOFF_ );
		user_input_VDW_bin_checker->set_VDW_rep_delete_matching_res( VDW_rep_delete_matching_res_ );
		user_input_VDW_bin_checker->set_physical_pose_clash_dist_cutoff( VDW_rep_screen_physical_pose_clash_dist_cutoff_ );
		user_input_VDW_bin_checker->set_output_pdb( output_pdb_ );
	}
