...
void
print_WorkingParameters_info( working_parameters::StepWiseWorkingParametersOP const & WP, std::string const WP_name, std::ostream & outstream = std::cout, bool const is_simple_full_length_WP = false );

void
print_WorkingParameters_info( working_parameters::StepWiseWorkingParametersCOP const & const_WP, std::string const WP_name, std::ostream & outstream = std::cout, bool const is_simple_full_length_WP = false );
