...
GridBaseOP LigandPropertyScoreCreator::create_grid(utility::tag::TagPtr const tag) const
{
...
void LigandPropertyScore::parse_my_tag(utility::tag::TagPtr const tag)
{
