...
//////////////////////////
// default constructor
SymRotamerTrialsMover::SymRotamerTrialsMover() : protocols::minimization_packing::RotamerTrialsMover()
{
...
SymRotamerTrialsMover::SymRotamerTrialsMover(
	...
	PackerTask & task_in
) : protocols::minimization_packing::RotamerTrialsMover(scorefxn_in, task_in )
{
	protocols::moves::Mover::type( "SymRotamerTrials" );
}
...
) : protocols::minimization_packing::RotamerTrialsMover(scorefxn_in, factory_in )
{
	protocols::moves::Mover::type( "SymRotamerTrials" );
}
