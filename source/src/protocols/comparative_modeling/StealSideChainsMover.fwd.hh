...
typedef utility::pointer::owning_ptr< StealSideChainsMover > StealSideChainsMoverOP;
typedef utility::pointer::owning_ptr< StealSideChainsMover const > StealSideChainsMoverCOP;
