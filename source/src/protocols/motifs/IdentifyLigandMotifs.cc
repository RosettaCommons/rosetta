...
utility::vector1< core::Real > IdentifyLigandMotifs::evaluate_motifs_of_pose(core::pose::PoseOP & working_pose, std::map<protocols::motifs::motif_atoms,protocols::motifs::MotifCOPs> mymap, const & std::string pdb_name)
{
