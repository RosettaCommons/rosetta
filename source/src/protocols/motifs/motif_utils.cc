...
numeric::xyzMatrix<core::Real> orthonormalize_rotation(const numeric::xyzMatrix<core::Real> & R)
{
	...
	numeric::xyzVector<core::Real> col1 = R.get_column(1);
	numeric::xyzVector<core::Real> col2 = R.get_column(2);
	numeric::xyzVector<core::Real> col3 = R.get_column(3);
	...
	numeric::xyzMatrix<core::Real> R_orthonormalized;
