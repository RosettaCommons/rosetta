...
public:
	...
	utility::vector1< core::Real > evaluate_motifs_of_pose(core::pose::Pose & working_pose, std::map<protocols::motifs::motif_atoms,protocols::motifs::MotifCOPs> mymap, std::string const & pdb_name);
