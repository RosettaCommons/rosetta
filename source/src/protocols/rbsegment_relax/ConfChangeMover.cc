...
void ConfChangeMover::provide_xml_schema(utility::tag::XMLSchemaDefinition &xsd) {
	...
	top_attlist + utility::tag::XMLSchemaAttribute::attribute_w_default("template_pose", utility::tag::xs_string, "Template pose for restraints generation (optional)", "NONE") +
		...
		"10000") +
		utility::tag::XMLSchemaAttribute::attribute_w_default("stage1_move_restoring_segs (optional)", utility::tag::xsct_non_negative_integer,
		...
		+ utility::tag::XMLSchemaAttribute("modify_segments", utility::tag::xs_string, "comma separated list of SSEs to modify in the format segIndex-firstRes-lastRes. The list of DSSP calculated SSEs is printed as 'Segment <Index>' (optional)")
	...
	std::string description = "The mover sample new protein conformations in two steps: 1) Rigid-body perturbation of SSEs with optional dihedrals change through fragments insertion, 2) Fragments-based loops closure and modeling";
