...
typedef utility::pointer::owning_ptr< RRProtocolPackRotamers > RRProtocolPackRotamersOP;
typedef utility::pointer::owning_ptr< RRProtocolPackRotamers const > RRProtocolPackRotamersCOP;
