...
void
HBondAcceptorFilter::parse_my_tag( utility::tag::TagPtr const tag, protocols::moves::DataMap &, protocols::filters::Filters_map const &, protocols::moves::Movers_map const &, core::pose::Pose const & )
{
...
HBondAcceptorFilterCreator::create_filter() const { return new HBondAcceptorFilter; }
