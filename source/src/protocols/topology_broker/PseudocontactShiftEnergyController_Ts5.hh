...
#ifndef INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts5_hh
#define INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts5_hh

// Unit Headers
#include <protocols/topology_broker/PseudocontactShiftEnergyController_Ts5.fwd.hh>
...
class PseudocontactShiftEnergyController_Ts5 : public TopologyClaimer {

	typedef TopologyClaimer Parent;
public:
                 	PseudocontactShiftEnergyController_Ts5(); //for factory

	virtual TopologyClaimerOP clone() const {
		return new PseudocontactShiftEnergyController_Ts5( *this );
	}
	...
	static std::string _static_type_name() {
		return "PseudocontactShiftEnergyController_Ts5";
	}
