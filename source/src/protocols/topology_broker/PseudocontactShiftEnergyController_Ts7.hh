...
#ifndef INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts7_hh
#define INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts7_hh

// Unit Headers
#include <protocols/topology_broker/PseudocontactShiftEnergyController_Ts7.fwd.hh>
...
class PseudocontactShiftEnergyController_Ts7 : public TopologyClaimer {

	typedef TopologyClaimer Parent;
public:
                 	PseudocontactShiftEnergyController_Ts7(); //for factory

	virtual TopologyClaimerOP clone() const {
		return new PseudocontactShiftEnergyController_Ts7( *this );
	}
	...
	static std::string _static_type_name() {
		return "PseudocontactShiftEnergyController_Ts7";
	}
