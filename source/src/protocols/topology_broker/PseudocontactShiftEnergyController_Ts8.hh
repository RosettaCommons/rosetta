...
#ifndef INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts8_hh
#define INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts8_hh

// Unit Headers
#include <protocols/topology_broker/PseudocontactShiftEnergyController_Ts8.fwd.hh>
...
class PseudocontactShiftEnergyController_Ts8 : public TopologyClaimer {

	typedef TopologyClaimer Parent;
public:
                 	PseudocontactShiftEnergyController_Ts8(); //for factory

	virtual TopologyClaimerOP clone() const {
		return new PseudocontactShiftEnergyController_Ts8( *this );
	}
	...
	static std::string _static_type_name() {
		return "PseudocontactShiftEnergyController_Ts8";
	}
...
}; //class PseudocontactShiftEnergyController_Ts8
