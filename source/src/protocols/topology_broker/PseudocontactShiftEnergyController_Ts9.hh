...
#ifndef INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts9_hh
#define INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts9_hh

// Unit Headers
#include <protocols/topology_broker/PseudocontactShiftEnergyController_Ts9.fwd.hh>
...
class PseudocontactShiftEnergyController_Ts9 : public TopologyClaimer {

	typedef TopologyClaimer Parent;
public:
                 	PseudocontactShiftEnergyController_Ts9(); //for factory

	virtual TopologyClaimerOP clone() const {
		return new PseudocontactShiftEnergyController_Ts9( *this );
	}
	...
	static std::string _static_type_name() {
		return "PseudocontactShiftEnergyController_Ts9";
	}
