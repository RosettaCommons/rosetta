...
#ifndef INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts6_hh
#define INCLUDED_protocols_topology_broker_PseudocontactShiftEnergyController_Ts6_hh

// Unit Headers
#include <protocols/topology_broker/PseudocontactShiftEnergyController_Ts6.fwd.hh>
...
class PseudocontactShiftEnergyController_Ts6 : public TopologyClaimer {

	typedef TopologyClaimer Parent;
public:
                 	PseudocontactShiftEnergyController_Ts6(); //for factory

	virtual TopologyClaimerOP clone() const {
		return new PseudocontactShiftEnergyController_Ts6( *this );
	}
	...
	static std::string _static_type_name() {
		return "PseudocontactShiftEnergyController_Ts6";
	}
...
}; //class PseudocontactShiftEnergyController_Ts6
