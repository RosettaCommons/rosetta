...
static basic::Tracer TR("WorkUnit_Sampler.RelaxType");
...
WorkUnit_bbGauss::run()
{
  ...
  using namespace basic::options::OptionKeys;
	...
	TR << " with report_step " << nstep_store;
	TR << " at kT = " << get_kT() << std::endl;
...
WorkUnit_MD::run()
{
  ...
  using namespace basic::options::OptionKeys;
	...
	TR << ", scoretype " << get_scoretype();
	TR << ", nsteps " << get_nstruct()*nstep_store << std::endl;
	core::Size starttime = time(NULL);
...
WorkUnit_Relax::run()
{
  ...
  using namespace basic::options::OptionKeys;
	...
	TR << ", relaxtype " << get_relaxtype();
	TR << ", scoretype " << get_scoretype();
	TR << ", cstweight " << get_cstweight() << std::endl;
