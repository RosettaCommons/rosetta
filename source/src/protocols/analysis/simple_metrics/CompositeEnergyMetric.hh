...
#ifndef INCLUDED_protocols_analysis_simple_metrics_CompositeEnergyMetric_HH
#define INCLUDED_protocols_analysis_simple_metrics_CompositeEnergyMetric_HH

#include <protocols/analysis/simple_metrics/CompositeEnergyMetric.fwd.hh>
