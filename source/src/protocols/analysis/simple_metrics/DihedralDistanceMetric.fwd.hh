...
#ifndef INCLUDED_protocols_analysis_simple_metrics_DihedralDistanceMetric_fwd_hh
#define INCLUDED_protocols_analysis_simple_metrics_DihedralDistanceMetric_fwd_hh
