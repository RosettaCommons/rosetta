...
/// @file       protocols/membrane/MembraneUnitTestMover.hh
///
...
#ifndef INCLUDED_protocols_membrane_MembraneUnitTestMover_hh
#define INCLUDED_protocols_membrane_MembraneUnitTestMover_hh
...
namespace membrane {
    ...
    /// @brief Membrane Unit Test Mover Class
    /// @details Helper Mover class for testing the membrane protein factory
    class MembraneUnitTestMover : public protocols::moves::Mover {
        
    public: // constructors
        
        /// @brief Standard Constructor
        MembraneUnitTestMover();
        
        /// @brief Copy Constructor
        MembraneUnitTestMover( MembraneUnitTestMover const & src );
...
#endif // INCLUDED_protocols_membrane_MembraneUnitTestMover_hh
