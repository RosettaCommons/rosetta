...
#ifndef INCLUDED_protocols_canonical_sampling_DbTrajectoryReader_hh
#define INCLUDED_protocols_canonical_sampling_DbTrajectoryReader_hh

// Unit Headers
#include <protocols/canonical_sampling/DbTrajectoryReader.fwd.hh>
