...
/// @file   devel/matdes/OligomericAverageDegreeFilterCreator.hh
/// @brief  FilterCreator for the OligomericAverageDegreeFilter
/// @author Neil King (neilking@u.washington.edu)

#ifndef INCLUDED_devel_matdes_OligomericAverageDegreeFilterCreator_hh
#define INCLUDED_devel_matdes_OligomericAverageDegreeFilterCreator_hh
