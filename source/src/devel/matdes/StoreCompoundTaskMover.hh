...
#ifndef INCLUDED_devel_matdes_StoreCompoundTaskMover_hh
#define INCLUDED_devel_matdes_StoreCompoundTaskMover_hh

//unit headers
#include <devel/matdes/StoreCompoundTaskMover.fwd.hh>
...
public:
	...
	void CompoundPackableTask( core::Size & total_residue, core::pack::task::PackerTaskOP & task );
	void CompoundDesignableTask( core::Size & total_residue, core::pack::task::PackerTaskOP & task );
