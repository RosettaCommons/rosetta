...
void
PoseToStructFileRepConverter::generate_default_title_section()
{
	using namespace io;
	...
	default_title_section->store_experimental_technique( HeaderInformation::THEORETICAL_MODEL );
...
/// @author   Labonte <JWLabonte@jhu.edu>
void
PoseToStructFileRepConverter::generate_default_remarks()
{
