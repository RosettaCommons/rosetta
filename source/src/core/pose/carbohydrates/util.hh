...
core::uint get_linkage_position_of_saccharide_residue( Pose const & pose, uint const seqpos );
...
/// carbon.
bool has_exocyclic_glycosidic_linkage( Pose const & pose, uint const seqpos );
...
Size get_n_glycosidic_torsions_in_res( Pose & pose, uint const sequence_position );
...
std::pair< utility::vector1< core::Size >, utility::vector1< core::Size > > get_carbohydrate_residues_upstream(
	Pose const & pose,
...
///  See Also: get_carbohydrate_residues_upstream
///            trim_carbohydrate_branch_from_X
void fill_upstream_children_res_and_tips(
	Pose const & pose,
	Size res,
	Size parent_residue,
	utility::vector1< Size > & children_residues,
...
utility::vector1< core::Size > get_resnums_in_leaf( Pose const & pose, Size tip_residue, Size stop_at_residue );
...
void delete_leaf( Pose & pose, utility::vector1< Size > leaf, std::string ref_pose_name = "temp_ref_pose" );
