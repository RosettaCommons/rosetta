...
/// @file src/core/energy_methods/CCS_IMMS_with_CryoEMEnergyCreator.cc
/// @brief Implementation for the class that connects CCS_IMMS_with_CryoEMEnergy with the ScoringManager
...
/// @details This must return a fresh instance of the CCS_IMMS_with_CryoEMEnergy class,
