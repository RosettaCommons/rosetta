...
#ifndef INCLUDED_core_membrane_geometry_Embedding_fwd_hh
#define INCLUDED_core_membrane_geometry_Embedding_fwd_hh
...
#endif // INCLUDED_core_membrane_geometry_Embedding_fwd_hh
