...
#ifndef INCLUDED_core_membrane_io_SpanFileIO_fwd_hh
#define INCLUDED_core_membrane_io_SpanFileIO_fwd_hh
...
class SpanFileIO;
typedef utility::pointer::owning_ptr< SpanFileIO > SpanFileIOOP;
typedef utility::pointer::owning_ptr< SpanFileIO const > SpanFileIOCOP;

} // io
} // membrane
} // core

#endif // INCLUDED_core_membrane_io_SpanFileIO_fwd_hh
