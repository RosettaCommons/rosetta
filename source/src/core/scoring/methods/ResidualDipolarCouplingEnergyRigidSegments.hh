...
///
class ResidualDipolarCouplingEnergyRigidSegments : public WholeStructureEnergy  {
public:
...
public:
 ...
 private:
	...
	ResidualDipolarCouplingRigidSegments& rdc_from_pose(
		pose::Pose & pose
	) const;
...
//used by Energy Method during scoring... should this become part of ResidualDipolarCoupling and thus cached in the pose
	...
	mutable id::AtomID_Map< Size > atom2rdc_map_;
};
