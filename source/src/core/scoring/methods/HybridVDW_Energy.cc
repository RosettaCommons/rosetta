...
) const
{
	...
	debug_assert( rsd1.residue_type_set()->category() == chemical::HYBRID_FA_STANDARD_CENTROID_t );
	debug_assert( rsd2.residue_type_set()->category() == chemical::HYBRID_FA_STANDARD_CENTROID_t );
