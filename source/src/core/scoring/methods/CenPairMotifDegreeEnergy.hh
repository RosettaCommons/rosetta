...
#ifndef INCLUDED_core_scoring_methods_CenPairMotifDegreeEnergy_hh
#define INCLUDED_core_scoring_methods_CenPairMotifDegreeEnergy_hh
...
class CenPairMotifDegreeEnergy : public WholeStructureEnergy  {
public:
