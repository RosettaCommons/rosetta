...
#ifndef INCLUDED_core_scoring_methods_ResidualDipolarCouplingEnergyCreator_hh
#define INCLUDED_core_scoring_methods_ResidualDipolarCouplingEnergyCreator_hh
...
class ResidualDipolarCouplingEnergyCreator : public EnergyMethodCreator
{
public:
