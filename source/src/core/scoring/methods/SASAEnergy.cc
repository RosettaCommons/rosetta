...
static THREAD_LOCAL basic::Tracer TR( "core.scoring.methods.SASAEnergy" );
...
SASAEnergy::setup_for_scoring( pose::Pose & pose, ScoreFunction const & ) const
{
	...
	if ( create_new_lre_container ) {
		LREnergyContainerOP new_dec = LREnergyContainerOP( new DenseEnergyContainer( pose.total_residue(), fa_sasa ) );
