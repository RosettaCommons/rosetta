...
//car of this function
							dimer_pairs.push_back( utility::pointer::shared_ptr<class core::scoring::DimerPairing>( new DimerPairing( ss1, ss2, sign1, sign2, dimer_pair_score ) ) );
							...
							if (symmetric) {  // multiply with score factors for the edge
									...
									for ( it = it_begin; it != it_end ; ++it ) {
										...
										dimer_pairs.push_back( utility::pointer::shared_ptr<class core::scoring::DimerPairing>( new DimerPairing( symm_ss1_clone, symm_ss2_clone, sign1, sign2, dimer_pair_score ) ) );
								}
							}
