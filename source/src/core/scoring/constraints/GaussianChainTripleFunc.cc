...
/// @file src/core/scoring/constraints/GaussianChainTripleFunc.hh
/// @brief Definition for functions used in loop closure terms.
/// @author Rhiju Das


#include <core/scoring/constraints/GaussianChainTripleFunc.hh>
...
{
	return new GaussianChainTripleFunc( gaussian_variance_, D2_, D3_ );
}
