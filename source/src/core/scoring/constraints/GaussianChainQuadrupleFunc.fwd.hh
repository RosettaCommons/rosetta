...
/// @file src/core/scoring/constraints/GaussianChainQuadrupleFunc.fwd.hh
/// @brief forward declaration for Mixture functions
/// @author Rhiju Das


#ifndef INCLUDED_core_scoring_constraints_GaussianChainQuadrupleFunc_fwd_hh
#define INCLUDED_core_scoring_constraints_GaussianChainQuadrupleFunc_fwd_hh
