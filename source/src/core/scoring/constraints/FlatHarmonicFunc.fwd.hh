...
/// @file src/core/scoring/constraints/FlatHarmonicFunc.fwd.hh
/// @brief forward declaration for Mixture functions
/// @author Chris King modified from James Thompson


#ifndef INCLUDED_core_scoring_constraints_FlatHarmonicFunc_fwd_hh
#define INCLUDED_core_scoring_constraints_FlatHarmonicFunc_fwd_hh
