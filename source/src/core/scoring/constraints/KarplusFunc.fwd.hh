...
/// @file src/core/scoring/constraints/CircularHarmonicFunc.fwd.hh
/// @brief forward declaration for CircularHarmonicFunc class
/// @author Nikolas Sgourakis


#ifndef INCLUDED_core_scoring_constraints_KarplusFunc_fwd_hh
#define INCLUDED_core_scoring_constraints_KarplusFunc_fwd_hh
