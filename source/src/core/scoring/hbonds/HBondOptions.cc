...
HBondOptions::append_schema_attributes( utility::tag::AttributeList & attributes )
{
	...
	attributes
		+ XMLSchemaAttribute( "exclude_DNA_DNA_hbond", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "use_hb_env_dep_DNA", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "use_hb_env_dep", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "smooth_hb_env_dep", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "decompose_bb_hb_into_pair_energies", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__exclude_DNA_DNA_hbond", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__use_hb_env_dep_DNA", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__put_intra_into_total", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__exclude_self_hbonds", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__use_hb_env_dep", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__smooth_hb_env_dep", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__decompose_bb_hb_into_pair_energies", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__exclude_intra_res_protein", xsct_rosetta_bool , "XRW TO DO" )
		+ XMLSchemaAttribute( "hbonds__exclude_intra_res_RNA", xsct_rosetta_bool , "XRW TO DO" )
		//+ XMLSchemaAttribute( "hbonds__put_intra_into_total", xsct_rosetta_bool , "XRW TO DO" )
