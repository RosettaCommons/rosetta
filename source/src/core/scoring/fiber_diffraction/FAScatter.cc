...
{
	assert( pose.data().has( core::pose::datacache::CacheableDataType::FIBER_DIFFRACTION_FA_SCATTERING ) );
	assert( dynamic_cast< FAScatter *>( &( pose.data().get( core::pose::datacache::CacheableDataType::FIBER_DIFFRACTION_FA_SCATTERING ))));
