...
typedef utility::pointer::shared_ptr< ElectronDensityOptions > ElectronDensityOptionsOP;
typedef utility::pointer::shared_ptr< ElectronDensityOptions const > ElectronDensityOptionsCOP;
