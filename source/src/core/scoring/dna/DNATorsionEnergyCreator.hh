...
/// @file   src/core/scoring/dna/DNATorsionEnergyCreator.hh
/// @brief  Declaration for the class that connects DNATorsionEnergy with the ScoringManager
/// @author Andrew Leaver-Fay (aleaverfay@gmail.com)

#ifndef INCLUDED_core_scoring_dna_DNATorsionEnergyCreator_HH
#define INCLUDED_core_scoring_dna_DNATorsionEnergyCreator_HH
