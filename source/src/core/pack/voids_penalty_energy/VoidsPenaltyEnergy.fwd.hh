...
/// @file core/pack/voids_penalty_energy/VoidsPenaltyEnergy.fwd.hh
...
#ifndef INCLUDED_core_pack_voids_penalty_energy_VoidsPenaltyEnergy_fwd_hh
#define INCLUDED_core_pack_voids_penalty_energy_VoidsPenaltyEnergy_fwd_hh
