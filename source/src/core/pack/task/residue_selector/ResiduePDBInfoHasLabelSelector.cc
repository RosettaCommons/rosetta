...
/// @file   core/pack/task/residue_selector/ResiduePDBInfoHasLabelSelector.cc
...
static THREAD_LOCAL basic::Tracer TR( "core.pack.task.residue_selector.ResiduePDBInfoHasLabelSelector" );
