...
/// @file   core/pack/task/residue_selector/NeighborhoodResidueSelector.fwd.hh
/// @brief  Forward declaration of a class that selects residues from the neighborhood of a set of focus residues
/// @author Andrew Leaver-Fay (leaverfa@email.unc.edu)

#ifndef INCLUDED_core_pack_task_residue_selector_NeighborhoodResidueSelector_FWD_HH
#define INCLUDED_core_pack_task_residue_selector_NeighborhoodResidueSelector_FWD_HH
