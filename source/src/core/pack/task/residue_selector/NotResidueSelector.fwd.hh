...
/// @file   core/pack/task/residue_selector/OrResidueSelector.fwd.hh
/// @brief  Forward declaration of a class that negates ResidueSelector logic
/// @author Robert Lindner (rlindner@mpimf-heidelberg.mpg.de)

#ifndef INCLUDED_core_pack_task_residue_selector_NotResidueSelector_FWD_HH
#define INCLUDED_core_pack_task_residue_selector_NotResidueSelector_FWD_HH
