...
/// @file   core/pack/task/residue_selector/ResidueSelector.fwd.hh
/// @brief  Forward declaration of a class that identifies a subset of residues from a Pose
/// @author Andrew Leaver-Fay (leaverfa@email.unc.edu)

#ifndef INCLUDED_core_pack_task_residue_selector_ResidueSelector_FWD_HH
#define INCLUDED_core_pack_task_residue_selector_ResidueSelector_FWD_HH
