...
/// @file   core/pack/task/residue_selector/SecondaryStructureSelector.fwd.hh
/// @brief  Forward declaration of a class to select residues based on their secondary structure
/// @author Tom Linsky (tlinsky at uw dot edu)

#ifndef INCLUDED_core_pack_task_residue_selector_SecondaryStructureSelector_FWD_HH
#define INCLUDED_core_pack_task_residue_selector_SecondaryStructureSelector_FWD_HH
