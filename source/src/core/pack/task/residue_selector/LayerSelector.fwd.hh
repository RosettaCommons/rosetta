...
/// @file   core/pack/task/residue_selector/LayerSelector.fwd.hh
...
#ifndef INCLUDED_core_pack_task_residue_selector_LayerSelector_FWD_HH
#define INCLUDED_core_pack_task_residue_selector_LayerSelector_FWD_HH
