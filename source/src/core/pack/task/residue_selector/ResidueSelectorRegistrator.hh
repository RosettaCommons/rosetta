...
/// @file   core/pack/task/residue_selector/ResidueSelectorRegistrator.hh
...
#ifndef INCLUDED_core_pack_task_residue_selector_ResidueSelectorRegistrator_hh
#define INCLUDED_core_pack_task_residue_selector_ResidueSelectorRegistrator_hh
