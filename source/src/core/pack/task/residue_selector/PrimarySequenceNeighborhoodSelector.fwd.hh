...
/// @file   core/pack/task/residue_selector/PrimarySequenceNeighborhoodSelector.fwd.hh
/// @brief  Forward declaration of a class that selects residues using their names
/// @author Tom Linsky (tlinsky@uw.edu)

#ifndef INCLUDED_core_pack_task_residue_selector_PrimarySequenceNeighborhoodSelector_FWD_HH
#define INCLUDED_core_pack_task_residue_selector_PrimarySequenceNeighborhoodSelector_FWD_HH
