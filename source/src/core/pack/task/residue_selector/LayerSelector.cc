...
static THREAD_LOCAL basic::Tracer TR( "core.pack.task.residue_selector.LayerSelector" );
...
LayerSelector::LayerSelector() :
	srbl_( new core::util::SelectResiduesByLayer )
...
/// @details See the core::util::SelectResiduesByLayer class for details of the math.
void
