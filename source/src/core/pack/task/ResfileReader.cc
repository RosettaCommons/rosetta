...
create_command_map()
{
	...
	command_map[ NATRO::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new NATRO );
	command_map[ NATAA::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new NATAA );
	command_map[ ALLAA::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new ALLAA );
	command_map[ ALLAAxc::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new ALLAAxc );
	command_map[ ALLAAwc::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new ALLAAwc );
	command_map[ PIKAA::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new PIKAA );
	command_map[ PIKNA::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new PIKNA );
	command_map[ PIKRNA::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new PIKRNA );
	command_map[ NOTAA::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new NOTAA );
	command_map[ EMPTY::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new EMPTY );
	command_map[ RESET::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new RESET );
	command_map[ POLAR::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new POLAR );
	command_map[ APOLAR::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new APOLAR );
	command_map[ APOLA::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new APOLA );
	command_map[ EX::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new EX );
	command_map[ EX_CUTOFF::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new EX_CUTOFF );
	command_map[ NC::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new NC );
	command_map[ USE_INPUT_SC::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new USE_INPUT_SC );
	command_map[ AUTO::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new AUTO );
	command_map[ SCAN::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new SCAN );
	command_map[ TARGET::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new TARGET );
	command_map[ NO_ADDUCTS::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new NO_ADDUCTS );
	command_map[ FIX_HIS_TAUTOMER::name() ] = utility::pointer::shared_ptr<class core::pack::task::ResfileCommand>( new FIX_HIS_TAUTOMER );
