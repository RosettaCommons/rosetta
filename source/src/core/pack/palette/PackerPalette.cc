...
bool
PackerPalette::packer_palette_provides_citation_info() const {
	return false;
}
...
PackerPalette::provide_citation_info() const {
...
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org)
bool
PackerPalette::packer_palette_is_unpublished() const {
	return false;
}
...
PackerPalette::provide_authorship_info_for_unpublished() const {
