...
/// @file   core/simple_metrics/CompositeIntegerMetric.hh
///
/// @brief  Base class for core::Real CompositeIntegerMetrics
/// @author Jared Adolf-Bryfogle (jadolfbr@gmail.com)

#ifndef INCLUDED_core_simple_metrics_CompositeIntegerMetric_hh
#define INCLUDED_core_simple_metrics_CompositeIntegerMetric_hh

// Unit headers
#include <core/simple_metrics/SimpleMetric.hh>
#include <core/simple_metrics/CompositeIntegerMetric.fwd.hh>
...
/// @brief A class that is derived to calculate a set of integer values.
///  Apply(pose) method calculates this metric and adds it to the pose score for output.
///
/// @details
///  Calculate(pose) calculates multiple int values and returns them as a map<string, int>
///   Name:Value
///
///
class CompositeIntegerMetric : public core::simple_metrics::SimpleMetric {

public: // constructors / destructors

	CompositeIntegerMetric();

	~CompositeIntegerMetric() override;

	CompositeIntegerMetric( CompositeIntegerMetric const & other );
