...
SecondaryStructureMetric::provide_citation_info() const {
...
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org)
bool
SecondaryStructureMetric::simple_metric_is_unpublished() const {
	return true;
}
...
SecondaryStructureMetric::provide_authorship_info_for_unpublished() const {
