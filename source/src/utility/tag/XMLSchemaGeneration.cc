...
XMLSchemaDefinition::human_readable_summary(
	...
	std::string const fulldef( full_definition() );
	...
	xmlDoc* doc( xmlReadMemory( fulldef.c_str(), fulldef.length()+1, nullptr, nullptr, 0 ) );
...
/// @author Vikram K. Mulligan (vmullig@uw.edu)
void
XMLSchemaDefinition::generate_human_readable_recursive(
	xmlNode* rootnode,
...
/// @author Vikram K. Mulligan (vmullig@uw.edu)
std::string
XMLSchemaDefinition::get_node_option(
	xmlNode* node,
...
/// @author Vikram K. Mulligan (vmullig@uw.edu)
std::string
XMLSchemaDefinition::get_tag_name(
	xmlNode* node
) const {
...
void
XMLSchemaDefinition::generate_human_readable_documentation(
	xmlNode* parent_node,
...
/// @author Vikram K. Mulligan (vmullig@uw.edu)
void
XMLSchemaDefinition::output_all_tag_options(
	xmlNode* node,
	...
	options << (level > 1 ? "\n" : "" ) << "\"" << tagname << "\" ";
	for ( Size i=1; i<level; ++i ) options << "sub-";
	options << "tag:";
...
/// @author Vikram K. Mulligan (vmullig@uw.edu)
std::string
XMLSchemaDefinition::get_type_name(
