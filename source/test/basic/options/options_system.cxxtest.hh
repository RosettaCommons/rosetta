...
public:
	...
	void test_initialize_local_option_collection_from_global() {
		...
		std::tuple< utility::vector1<int>, utility::vector1<std::string>, utility::vector1< std::string > > rcv1_resnum_and_chain = local_options[ rcv1 ].resnum_and_chain();
		utility::vector1< std::string > rcv1_expected_chain( 1, "A" );
		...
		std::tuple< utility::vector1<int>, utility::vector1<std::string>, utility::vector1< std::string > > rcv2_resnum_and_chain = local_options[ rcv2 ].resnum_and_chain();
		utility::vector1< std::string > rcv2_expected_chain( 10 );
