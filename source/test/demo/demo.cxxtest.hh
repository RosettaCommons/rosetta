...
/// @file   demo/demo.cxxtest.hh
/// @brief  demo.cxxtest: placeholder for main() function when creating unit test executable
/// @author Ron Jacak (ron.jacak@gmail.com)


#ifndef INCLUDED_demo_demo_cxxtest_HH
#define INCLUDED_demo_demo_cxxtest_HH
...
// generated .cpp file.  This is that file for the demo project.


#endif INCLUDED_demo_cxxtest_HH
