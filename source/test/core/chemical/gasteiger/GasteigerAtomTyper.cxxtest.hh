...
class GasteigerAtomTyperTests : public CxxTest::TestSuite {
    ...
    restype = new core::chemical::ResidueType( residue_set->name_map( "GLN" ) );
    core::chemical::gasteiger::assign_gasteiger_atom_types( *restype, atom_type_set_, /*keep_existing=*/ false );
    ...
    restype = new core::chemical::ResidueType( residue_set->name_map( "TYR" ) );
    core::chemical::gasteiger::assign_gasteiger_atom_types( *restype, atom_type_set_, /*keep_existing=*/ false );
    ...
    restype = new core::chemical::ResidueType( residue_set->name_map( "HIS" ) );
    core::chemical::gasteiger::assign_gasteiger_atom_types( *restype, atom_type_set_, /*keep_existing=*/ false );
    ...
    restype = new core::chemical::ResidueType( residue_set->name_map( "HIS_D" ) );
    core::chemical::gasteiger::assign_gasteiger_atom_types( *restype, atom_type_set_, /*keep_existing=*/ false );
    ...
    restype = new core::chemical::ResidueType( residue_set->name_map( "TRP" ) );
    core::chemical::gasteiger::assign_gasteiger_atom_types( *restype, atom_type_set_, /*keep_existing=*/ false );
    ...
    restype = new core::chemical::ResidueType( residue_set->name_map( "ARG" ) );
    core::chemical::gasteiger::assign_gasteiger_atom_types( *restype, atom_type_set_, /*keep_existing=*/ false );
    ...
    restype = new core::chemical::ResidueType( residue_set->name_map( "LYS" ) );
    core::chemical::gasteiger::assign_gasteiger_atom_types( *restype, atom_type_set_, /*keep_existing=*/ false );

		TS_ASSERT_EQUALS( restype->atom("NZ").gasteiger_atom_type()->get_name(), "N_TeTeTeTe" );

    restype = new core::chemical::ResidueType( residue_set->name_map( "MET" ) );
    core::chemical::gasteiger::assign_gasteiger_atom_types( *restype, atom_type_set_, /*keep_existing=*/ false );
    ...
    restype = new core::chemical::ResidueType( residue_set->name_map( "CYS" ) );
    core::chemical::gasteiger::assign_gasteiger_atom_types( *restype, atom_type_set_, /*keep_existing=*/ false );

		TS_ASSERT_EQUALS( restype->atom("CB").gasteiger_atom_type()->get_name(), "C_TeTeTeTe" );
		TS_ASSERT_EQUALS( restype->atom("SG").gasteiger_atom_type()->get_name(), "S_Te2Te2TeTe" );

    restype = new core::chemical::ResidueType( residue_set->name_map( "GUA" ) );
    core::chemical::gasteiger::assign_gasteiger_atom_types( *restype, atom_type_set_, /*keep_existing=*/ false );
	...
	void test_virtuals() {
		...
		restype = new core::chemical::ResidueType( residue_set->name_map( "FE" ) ); // Formal charge of 3, transition metal
		core::chemical::gasteiger::assign_gasteiger_atom_types( *restype, atom_type_set_, /*keep_existing=*/ false );

		TS_ASSERT_EQUALS( restype->atom("FE").gasteiger_atom_type()->get_name(), "Fe_" );

		restype = new core::chemical::ResidueType( residue_set->name_map( "PRO" ) );
		core::chemical::gasteiger::assign_gasteiger_atom_types( *restype, atom_type_set_, /*keep_existing=*/ false );
