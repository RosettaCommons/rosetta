...
public:  // Test //////////////////////////////////////////////////////////////
	...
	void test_is_atom_axial_or_equatorial_to_ring()
	{
		...
		{
			TS_TRACE( " Testing E5 envelope conformation of 5-membered ring at position 5, a clearly defined case." );
		...
		{
			TS_TRACE( " Testing 3-membered ring, a clearly defined case." );
