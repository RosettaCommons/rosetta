...
/// @author Steven Combs - modified to test if random pdb can be loaded steven.combs1@gmail.com
...
class PoseFromFileTests : public CxxTest::TestSuite {
...
public:
	...
	void test_PoseFromPDBLoader() {
		...
		core::import_pose::pose_from_file( reference_pose, test_pdb_filename);
