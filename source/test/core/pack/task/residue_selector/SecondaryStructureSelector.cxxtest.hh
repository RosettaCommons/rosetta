...
/// @file core/pack/task/residue_selector/SecondaryStructureSelector.cxxtest.hh
/// @brief test suite for core::pack::task::residue_selector::SecondaryStructureSelector
