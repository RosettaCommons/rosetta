...
/// @file core/pack/task/residue_selector/ResiduePDBInfoHasLabelSelector.cxxtest.hh
/// @brief test suite for core::pack::task::residue_selector::ResiduePDBInfoHasLabelSelector
...
// Package headers
#include <core/pack/task/residue_selector/ResiduePDBInfoHasLabelSelector.hh>
