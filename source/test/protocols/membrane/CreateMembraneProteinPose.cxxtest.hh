...
/// @file 	 protocols/membrane/CreateMembraneProteinPose.cxxtest.hh
///
/// @brief 	 CreateMembraneProteinPose Test
/// @details Testing the RosettaScripts hook for CreateMembraneProteinPose
/// @author  JKLeman (3/13/14)
