...
public:
	...
	void note_job_completed( protocols::jd3::LarvalJobCOP /*job*/, protocols::jd3::JobStatus /*status*/ ) override {}

	void completed_job_result( protocols::jd3::LarvalJobCOP /*job*/, protocols::jd3::JobResultOP /*result*/ ) override {}
