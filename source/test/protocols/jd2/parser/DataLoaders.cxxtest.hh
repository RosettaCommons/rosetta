...
#include <protocols/jd2/parser/MoveMapFactoryLoader.hh>
...
#include <protocols/jd2/parser/ConstraintGeneratorLoader.hh>
...
public:
	...
	void test_ConstraintGeneratorLoader(){
		...
		protocols::jd2::parser::ConstraintGeneratorLoader loader;
	...
	void test_ResidueSelectorLoader(){
		...
		protocols::jd2::parser::ResidueSelectorLoader loader;
		//Check that the loader can load the tag
		TS_ASSERT_THROWS_NOTHING( loader.load_data( *pose_, tag, data ) );
		//Check that the tag's contents are found in the DataMap
	...
	void test_ScoreFunctionLoader(){
		...
		protocols::jd2::parser::ScoreFunctionLoader loader;
		//Check that the loader can load the tag
		TS_ASSERT_THROWS_NOTHING( loader.load_data( *pose_, tag, data ) );
		//Check that the tag's contents are found in the DataMap
	...
	void test_TaskOperationLoader(){
		...
		protocols::jd2::parser::TaskOperationLoader loader;
		//Check that the loader can load the tag
		TS_ASSERT_THROWS_NOTHING( loader.load_data( *pose_, tag, data ) );
		//Check that the tag's contents are found in the DataMap
	...
	void test_JumpSelectorLoader(){
		...
		protocols::jd2::parser::JumpSelectorLoader loader;
		//Check that the loader can load the tag
		TS_ASSERT_THROWS_NOTHING( loader.load_data( *pose_, tag, data ) );
		//Check that the tag's contents are found in the DataMap
	...
	void test_MonteCarloLoader(){
		...
		protocols::jd2::parser::MonteCarloLoader loader;
		//Check that the loader can load the tag
		TS_ASSERT_THROWS_NOTHING( loader.load_data( *pose_, tag, data ) );
		//Check that the tag's contents are found in the DataMap
	...
	void test_MoveMapFactoryLoader(){
		...
		protocols::jd2::parser::MoveMapFactoryLoader loader;
		//Check that the loader can load the tag
		TS_ASSERT_THROWS_NOTHING( loader.load_data( *pose_, tag, data ) );
		//Check that the tag's contents are found in the DataMap
