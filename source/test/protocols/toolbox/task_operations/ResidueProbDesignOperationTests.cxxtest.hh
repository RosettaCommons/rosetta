...
public:
	...
	void test_task_op() {
		...
		output_or_test(tf, pose, first_run, "protocols/toolbox/task_operations/ResidueProbDesignOperation_defaults.u");

		//Test Replacing without natives.
		prob_design->set_include_native_restype(false);
		tf =all_but_prob->clone();
		tf->push_back(prob_design);
		output_or_test(tf, pose, first_run, "protocols/toolbox/task_operations/ResidueProbDesignOperation_no_native.u");
		...
		output_or_test(tf, pose, first_run, "protocols/toolbox/task_operations/ResidueProbDesignOperation_zero_at_.05.u");
		...
		output_or_test(tf, pose, first_run, "protocols/toolbox/task_operations/ResidueProbDesignOperation_picks_5.u");
		...
		tf =all_but_prob->clone();
		tf->push_back(prob_design);
		output_or_test(tf, pose, first_run, "protocols/toolbox/task_operations/ResidueProbDesignOperation_set_position.u");
		...
		tf =all_but_prob->clone();
		tf->push_back(prob_design);
		output_or_test(tf, pose, first_run, "protocols/toolbox/task_operations/ResidueProbDesignOperation_set_all_aa_probs.u");
	}
