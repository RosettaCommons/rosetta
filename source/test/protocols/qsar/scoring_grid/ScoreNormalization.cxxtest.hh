...
public:
	...
	void test_heavy_atom_normalization(){
		...
		residue_list.push_back(core::conformation::ResidueCOP( new core::conformation::Residue(ser_type,false) ));
		residue_list.push_back(core::conformation::ResidueCOP( new core::conformation::Residue(gly_type,false) ));
