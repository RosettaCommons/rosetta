...
public:
	...
	void test_heavy_atom_normalization(){
		...
		residue_list.push_back(utility::pointer::shared_ptr<const class core::conformation::Residue>( new core::conformation::Residue(ser_type,false) ));
		residue_list.push_back(utility::pointer::shared_ptr<const class core::conformation::Residue>( new core::conformation::Residue(gly_type,false) ));
