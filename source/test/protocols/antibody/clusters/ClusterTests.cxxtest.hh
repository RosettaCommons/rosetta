...
public:
	...
	void test_features(){
		...
		StructureID parent_id = structure_reporter->report_features(0, db_session);
		TS_ASSERT_THROWS_NOTHING(ab_cluster_reporter->report_features(ab_pose, parent_id, db_session));
