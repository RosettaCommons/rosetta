...
docker build $ROOT/source/conda/linux-anvil -f $ROOT/source/conda/linux-anvil/xenial/Dockerfile 

DOCKER_IMAGE=$(docker build $ROOT/source/conda/linux-anvil -f $ROOT/source/conda/linux-anvil/xenial/Dockerfile -q)
