...
./integration.py ligand_dock_7cpa    # only run the "ligand_dock_7cpa" test
    ...
    print( "Using Rosetta source dir at %s" % options.mini_home )
    ...
    def work(self):
        ...
        try:
            while True:
                ...
                #print( "Thread %i aquired test %s" % (self.index,test) )
            ...
            #print( "thread", self.index,"completed" )
...
class Queue:
    ...
    def get(self, block=True, timeout=None, message=None):
