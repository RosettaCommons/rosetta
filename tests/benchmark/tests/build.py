...
tests = dict(
    ...
    header    = NT(command='./update_submodules.sh && ./scons.py unit_test_platform_only ; cd src && python3 ./../../tools/python_cc_reader/test_all_headers_compile_w_fork.py -n {jobs}', incremental=False),
