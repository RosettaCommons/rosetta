...
<html>
<head>
    <title>FARFAR2 scientific benchamrk test results</title>
...
<body>
<p>
    The FARFAR2 benchmark, run on the classic RNA benchmark set 'favorites.txt', evaluates the stability in scientific performance of
    the Das lab's fragment assembly protocol. Specifically, we run twelve 'motif-scale' structure prediction targets of varying difficulty
